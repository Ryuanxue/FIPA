...
namespace pdg
{
  struct ProgramDependencyPrinter : public llvm::DOTGraphTraitsModulePrinter<ProgramDependencyGraph, false>
  {
    static char ID;
    ProgramDependencyPrinter() : llvm::DOTGraphTraitsModulePrinter<ProgramDependencyGraph, false>("pdgragh", ID) {}
  };
