...
@key = dso_local global i8* null, align 8, !dbg !14
@i = internal global i32 0, align 4, !dbg !18
@ciphertext = dso_local global i8* null, align 8, !dbg !16
...
@llvm.global.annotations = appending global [2 x { i8*, i8*, i8*, i32, i8* }] [{ i8*, i8*, i8*, i32, i8* } { i8* bitcast (i32 (i8*, i32)* @encrypt to i8*), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.3, i32 0, i32 0), i32 23, i8* null }, { i8*, i8*, i8*, i32, i8* } { i8* bitcast (i8** @key to i8*), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.12, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.3, i32 0, i32 0), i32 5, i8* null }], section "llvm.metadata"

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @greeter(i8* %str, i32* %s) #0 !dbg !2 {
entry:
  ...
  call void @llvm.dbg.declare(metadata i32** %s.addr, metadata !27, metadata !DIExpression()), !dbg !28
  call void @llvm.dbg.declare(metadata i8** %p, metadata !29, metadata !DIExpression()), !dbg !30
  %0 = load i8*, i8** %str.addr, align 8, !dbg !31
  store i8* %0, i8** %p, align 8, !dbg !30
  %1 = load i8*, i8** %p, align 8, !dbg !32
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i8* %1), !dbg !33
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0)), !dbg !34
  %2 = load i32*, i32** %s.addr, align 8, !dbg !35
  store i32 15, i32* %2, align 4, !dbg !36
  ret void, !dbg !37
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @initkey(i32 %sz) #0 !dbg !38 {
entry:
  %sz.addr = alloca i32, align 4
  store i32 %sz, i32* %sz.addr, align 4
  call void @llvm.dbg.declare(metadata i32* %sz.addr, metadata !41, metadata !DIExpression()), !dbg !42
  %0 = load i32, i32* %sz.addr, align 4, !dbg !43
  %conv = sext i32 %0 to i64, !dbg !43
  %call = call noalias i8* @malloc(i64 %conv) #6, !dbg !44
  store i8* %call, i8** @key, align 8, !dbg !45
  store i32 0, i32* @i, align 4, !dbg !46
  br label %for.cond, !dbg !48

for.cond:                                         ; preds = %for.inc, %entry
  %1 = load i32, i32* @i, align 4, !dbg !49
  %2 = load i32, i32* %sz.addr, align 4, !dbg !51
  %cmp = icmp ult i32 %1, %2, !dbg !52
  br i1 %cmp, label %for.body, label %for.end, !dbg !53

for.body:                                         ; preds = %for.cond
  %3 = load i8*, i8** @key, align 8, !dbg !54
  %4 = load i32, i32* @i, align 4, !dbg !55
  %idxprom = zext i32 %4 to i64, !dbg !54
  %arrayidx = getelementptr inbounds i8, i8* %3, i64 %idxprom, !dbg !54
  store i8 1, i8* %arrayidx, align 1, !dbg !56
  br label %for.inc, !dbg !54

for.inc:                                          ; preds = %for.body
  %5 = load i32, i32* @i, align 4, !dbg !57
  %inc = add i32 %5, 1, !dbg !57
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @encrypt(i8* %plaintext, i32 %sz) #0 !dbg !63 {
entry:
  ...
  %call = call noalias i8* @malloc(i64 %conv) #6, !dbg !71
...
entry:
  ...
  call void @llvm.var.annotation(i8* %username1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.3, i32 0, i32 0), i32 32, i8* null), !dbg !105
  ...
  %call2 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.6, i64 0, i64 0), i8* %arraydecay), !dbg !113
  ...
  %call6 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.8, i64 0, i64 0), i8* %arraydecay5), !dbg !118
  %arraydecay7 = getelementptr inbounds [1024 x i8], [1024 x i8]* %text, i64 0, i64 0, !dbg !119
  %call8 = call i64 @strlen(i8* %arraydecay7) #7, !dbg !120
  ...
  %call11 = call i64 @strlen(i8* %arraydecay10) #7, !dbg !126
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %call17 = call i64 @strlen(i8* %arraydecay16) #7, !dbg !135
...
!3 = !DIFile(filename: "example.c", directory: "/home/raoxue/Desktop/IF-driver-partition/program-dependence-graph-main/Edge_Specification")
...
!10 = distinct !DICompileUnit(language: DW_LANG_C99, file: !3, producer: "Ubuntu clang version 12.0.0-3ubuntu1~20.04.5", isOptimized: false, runtimeVersion: 0, emissionKind: FullDebug, enums: !11, retainedTypes: !12, globals: !13, splitDebugInlining: false, nameTableKind: None)
!11 = !{}
!12 = !{!6}
!13 = !{!0, !14, !16, !18}
...
!24 = !{!"Ubuntu clang version 12.0.0-3ubuntu1~20.04.5"}
...
!62 = !DILocation(line: 21, column: 1, scope: !38)
