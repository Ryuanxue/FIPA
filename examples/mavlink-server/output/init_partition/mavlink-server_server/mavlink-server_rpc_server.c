...
receive_heartbeat_sense_1_ret_ *receive_heartbeat_sense_1_rpc_1_svc(int arg2,struct svc_req *rqstp)
{
	static receive_heartbeat_sense_1_ret_ result;
int recsize=arg2;
receive_heartbeat_sense_1(buf,recsize);
return &result;
}
