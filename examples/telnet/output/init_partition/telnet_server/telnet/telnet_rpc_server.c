...
tn_sense_1_ret_ *tn_sense_1_rpc_1_svc(int_ptr arg1,int_ptr arg2,char_ptr arg3,char_ptr arg4,struct svc_req *rqstp)
{
...
int *err=NULL;
if(arg2.int_ptr_val!=NULL) {
err=malloc(arg2.int_ptr_len*sizeof(int));
if(err==NULL) {
perror("malloc failed");
exit(1);
}
for(int i0=0;i0<arg2.int_ptr_len;i0++) {
err[i0]=arg2.int_ptr_val[i0];
	}
}
char *hostp=NULL;
if(arg3.charptr.charptr_val!=NULL) {
hostp=arg3.charptr.charptr_val;
}
char *user=NULL;
if(arg4.charptr.charptr_val!=NULL) {
user=arg4.charptr.charptr_val;
}
int sensefun_ret;
sensefun_ret=tn_sense_1(tn_sense_1_ret,err,hostp,user);
...
int *gsetter_connected_postfix_1_svc( struct svc_req *rqstp)
{
   static int result;
 result= connected++;
    return &result;
