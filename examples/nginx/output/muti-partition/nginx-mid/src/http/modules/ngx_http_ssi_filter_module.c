...
ngx_int_t ngx_http_postpone_filter(ngx_http_request_t *r, ngx_chain_t *in);
ngx_int_t ngx_http_gzip_header_filter(ngx_http_request_t *r);
...
ngx_http_ssi_header_filter(ngx_http_request_t *r)
{
    ...
    { ngx_http_next_header_filter = ngx_http_gzip_header_filter;
...
ngx_http_ssi_body_filter(ngx_http_request_t *r, ngx_chain_t *in)
{
    ...
    if (ctx == NULL
        || (in == NULL
            ...
            && ctx->in == NULL
            && ctx->busy == NULL))
    {ngx_http_next_body_filter=ngx_http_postpone_filter;    
