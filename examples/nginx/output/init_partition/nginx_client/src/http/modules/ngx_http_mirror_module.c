...
static ngx_int_t ngx_http_mirror_handler(ngx_http_request_t *r)
{
  ...
  {
    int ngx_http_mirror_handler_sense_1_ret = 0;
    ngx_int_t ngx_http_mirror_handler_sense_1_return = ngx_http_mirror_handler_sense_1_wrapper(&ngx_http_mirror_handler_sense_1_ret, &rc, ctx, mlcf, r);
    if (ngx_http_mirror_handler_sense_1_ret)
      return ngx_http_mirror_handler_sense_1_return;
  }
  ;
}
