...
static ngx_int_t ngx_http_send_error_page(ngx_http_request_t *r, ngx_http_err_page_t *err_page)
{
  ...
  if (((((overwrite != 301) && (overwrite != 302)) && (overwrite != 303)) && (overwrite != 307)) && (overwrite != 308))
  {
    r->err_status = 302;
  }
  location->hash = 1;
  ...
  return ngx_http_send_special_response(r, clcf, (r->err_status - 301) + (202 - 201));
}
...
static ngx_int_t ngx_http_send_refresh(ngx_http_request_t *r)
{
  ...
  size = (((((sizeof(get_ngx_http_msie_refresh_head_wrapper())) - 1) + escape) + len) + (sizeof(get_ngx_http_msie_refresh_tail_wrapper()))) - 1;
  r->err_status = 200;
  r->headers_out.content_type_len = (sizeof("text/html")) - 1;
  ...
  p = ((u_char *) memcpy(b->pos, get_ngx_http_msie_refresh_head_wrapper(), (sizeof(get_ngx_http_msie_refresh_head_wrapper())) - 1)) + ((sizeof(get_ngx_http_msie_refresh_head_wrapper())) - 1);
  if (escape == 0)
  {
  ...
  b->last = ((u_char *) memcpy(p, get_ngx_http_msie_refresh_tail_wrapper(), (sizeof(get_ngx_http_msie_refresh_tail_wrapper())) - 1)) + ((sizeof(get_ngx_http_msie_refresh_tail_wrapper())) - 1);
