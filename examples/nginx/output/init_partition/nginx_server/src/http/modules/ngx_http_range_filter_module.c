...
ngx_int_t ngx_http_range_body_filter_sense_1(int *ngx_http_range_body_filter_sense_1_ret, ngx_http_request_t *r, ngx_chain_t *in)
{
  ngx_http_range_filter_ctx_t *ctx;
  if (in == 0)
  {
    {
      *ngx_http_range_body_filter_sense_1_ret = 1;
