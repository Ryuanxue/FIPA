...
u_char *ngx_http_log_body_bytes_sent_sense_1(int *ngx_http_log_body_bytes_sent_sense_1_ret, ngx_http_request_t *r, u_char *buf)
{
  off_t length;
  ...
  {
    {
      *ngx_http_log_body_bytes_sent_sense_1_ret = 1;
