...
static char *btoe(char *store, const unsigned char *c)
{
  ...
  *store = '\0';
  ...
  cp[8] = ((char) p) << 6;
  memcpy(store, &get_Wp_wrapper()[extract(cp, 0, 11)][0], 4);
  store += (!store[1]) ? (1) : ((!store[2]) ? (2) : ((!store[3]) ? (3) : (4)));
  *(store++) = ' ';
  memcpy(store, &get_Wp_wrapper()[extract(cp, 11, 11)][0], 4);
  store += (!store[1]) ? (1) : ((!store[2]) ? (2) : ((!store[3]) ? (3) : (4)));
  *(store++) = ' ';
  memcpy(store, &get_Wp_wrapper()[extract(cp, 22, 11)][0], 4);
  store += (!store[1]) ? (1) : ((!store[2]) ? (2) : ((!store[3]) ? (3) : (4)));
  *(store++) = ' ';
  memcpy(store, &get_Wp_wrapper()[extract(cp, 33, 11)][0], 4);
  store += (!store[1]) ? (1) : ((!store[2]) ? (2) : ((!store[3]) ? (3) : (4)));
  *(store++) = ' ';
  memcpy(store, &get_Wp_wrapper()[extract(cp, 44, 11)][0], 4);
  store += (!store[1]) ? (1) : ((!store[2]) ? (2) : ((!store[3]) ? (3) : (4)));
  *(store++) = ' ';
  memcpy(store, &get_Wp_wrapper()[extract(cp, 55, 11)][0], 4);
  store[4] = '\0';
  do
  {
