# 1 "src/http/modules/ngx_http_browser_module.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 9 "src/http/modules/ngx_http_browser_module.c" 2
...
# 10 "src/http/modules/ngx_http_browser_module.c" 2
...
# 11 "src/http/modules/ngx_http_browser_module.c" 2
# 24 "src/http/modules/ngx_http_browser_module.c"
typedef struct {
    u_char browser[12];
    size_t skip;
    size_t add;
...
static char *ngx_http_browser_merge_conf(ngx_conf_t *cf, void *parent,
    void *child);
static int ngx_http_modern_browser_sort(const void *one,
    const void *two);
...
static ngx_command_t ngx_http_browser_commands[] = {
    ...
    { { sizeof("modern_browser") - 1, (u_char *) "modern_browser" },
      0x02000000|0x04000000|0x08000000|(0x00000002|0x00000004),
      ngx_http_modern_browser,
      
# 80 "src/http/modules/ngx_http_browser_module.c" 3 4
     0
# 80 "src/http/modules/ngx_http_browser_module.c"
                             ,
      0,
      0 },

    { { sizeof("ancient_browser") - 1, (u_char *) "ancient_browser" },
      0x02000000|0x04000000|0x08000000|0x00000800,
      ngx_http_ancient_browser,
      
# 87 "src/http/modules/ngx_http_browser_module.c" 3 4
     0
# 87 "src/http/modules/ngx_http_browser_module.c"
                             ,
      0,
      0 },

    { { sizeof("modern_browser_value") - 1, (u_char *) "modern_browser_value" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_http_modern_browser_value,
      
# 94 "src/http/modules/ngx_http_browser_module.c" 3 4
     0
# 94 "src/http/modules/ngx_http_browser_module.c"
                             ,
      0,
      0 },

    { { sizeof("ancient_browser_value") - 1, (u_char *) "ancient_browser_value" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_http_ancient_browser_value,
      
# 101 "src/http/modules/ngx_http_browser_module.c" 3 4
     0
# 101 "src/http/modules/ngx_http_browser_module.c"
                             ,
      0,
      0 },
...
# 153 "src/http/modules/ngx_http_browser_module.c"
    { "opera",
      0,
      sizeof("Opera ") - 1,
      "Opera"},
    ...
    { "msie",
      ...
      sizeof("MSIE ") - 1,
      "MSIE "},
# 176 "src/http/modules/ngx_http_browser_module.c"
    { "gecko",
      sizeof("Mozilla/5.0 (") - 1,
      sizeof("rv:") - 1,
      "rv:"},
# 192 "src/http/modules/ngx_http_browser_module.c"
    { "safari",
      sizeof("Mozilla/5.0 (") - 1,
      sizeof("Safari/") - 1,
      "Safari/"},
# 204 "src/http/modules/ngx_http_browser_module.c"
    { "konqueror",
...
static ngx_http_variable_t ngx_http_browser_vars[] = {
    ...
    { { sizeof("msie") - 1, (u_char *) "msie" }, 0, ngx_http_msie_variable,
      0, 1, 0 },

    { { sizeof("modern_browser") - 1, (u_char *) "modern_browser" }, 0, ngx_http_browser_variable,
      0, 1, 0 },

    { { sizeof("ancient_browser") - 1, (u_char *) "ancient_browser" }, 0, ngx_http_browser_variable,
      1, 1, 0 },
    ...
    uintptr_t data)
{
    ...
    cf = (r)->loc_conf[ngx_http_browser_module.ctx_index];
...
ngx_http_browser(ngx_http_request_t *r, ngx_http_browser_conf_t *cf)
{
    ...
    if (cf->modern_browsers) {
        ...
        for (i = 0; i < cf->modern_browsers->nelts; i++) {
            ...
            name = (u_char *) strstr((const char *) name, (const char *) modern[i].name);
    ...
    if (cf->netscape4) {
        if (len > sizeof("Mozilla/4.72 ") - 1
            && strncmp((const char *) ua, (const char *) "Mozilla/", sizeof("Mozilla/") - 1) == 0
            && ua[8] > '0' && ua[8] < '5')
        {
            return 1;
        }
    ...
    if (cf->ancient_browsers) {
        ...
        for (i = 0; i < cf->ancient_browsers->nelts; i++) {
            if (len >= ancient[i].len
                && strstr((const char *) ua, (const char *) ancient[i].data) != 0)
            {
                return 1;
            }
        }
...
# 439 "src/http/modules/ngx_http_browser_module.c"
    return conf;
}
...
found:
        ...
        qsort(browsers, (size_t) conf->modern_browsers->nelts,
    ...
    if (conf->ancient_browsers == 0 && conf->netscape4 == 0) {
        conf->ancient_browsers = prev->ancient_browsers;
        conf->netscape4 = prev->netscape4;
    }

    if (conf->modern_browser_value == 0) {
    ...
    if (conf->ancient_browser_value == 0) {
...
ngx_http_modern_browser(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (cf->args->nelts == 2) {
        if (strcmp((const char *) value[1].data, (const char *) "unlisted") == 0) {
...
ngx_http_ancient_browser(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    for (i = 1; i < cf->args->nelts; i++) {
        if (strcmp((const char *) value[i].data, (const char *) "netscape4") == 0) {
            bcf->netscape4 = 1;
            continue;
        }

        if (bcf->ancient_browsers == 0) {
...
ngx_http_ancient_browser_value(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    bcf->ancient_browser_value = ngx_palloc(cf->pool,
                                            sizeof(ngx_http_variable_value_t));
    if (bcf->ancient_browser_value == 0) {
        return (void *) -1;
    }
