# 1 "src/http/modules/ngx_http_userid_filter_module.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 9 "src/http/modules/ngx_http_userid_filter_module.c" 2
...
# 10 "src/http/modules/ngx_http_userid_filter_module.c" 2
...
# 11 "src/http/modules/ngx_http_userid_filter_module.c" 2
# 22 "src/http/modules/ngx_http_userid_filter_module.c"
typedef struct {
    ngx_uint_t enable;
...
static ngx_conf_enum_t ngx_http_userid_state[] = {
    ...
    { { sizeof("log") - 1, (u_char *) "log" }, 1 },
    { { sizeof("v1") - 1, (u_char *) "v1" }, 2 },
    { { sizeof("on") - 1, (u_char *) "on" }, 3 },
    { { 0, 0 }, 0 }
};
...
static ngx_command_t ngx_http_userid_commands[] = {
    ...
    { { sizeof("userid") - 1, (u_char *) "userid" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_enum_slot,
      
# 102 "src/http/modules/ngx_http_userid_filter_module.c" 3 4
     0
# 102 "src/http/modules/ngx_http_userid_filter_module.c"
                             ,
      
# 103 "src/http/modules/ngx_http_userid_filter_module.c" 3 4
     0
# 103 "src/http/modules/ngx_http_userid_filter_module.c"
                                             ,
      ngx_http_userid_state },

    { { sizeof("userid_service") - 1, (u_char *) "userid_service" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_num_slot,
      
# 109 "src/http/modules/ngx_http_userid_filter_module.c" 3 4
     0
# 109 "src/http/modules/ngx_http_userid_filter_module.c"
                             ,
      
# 110 "src/http/modules/ngx_http_userid_filter_module.c" 3 4
     0
# 110 "src/http/modules/ngx_http_userid_filter_module.c"
                                              ,
      0 },

    { { sizeof("userid_name") - 1, (u_char *) "userid_name" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_str_slot,
      
# 116 "src/http/modules/ngx_http_userid_filter_module.c" 3 4
     0
# 116 "src/http/modules/ngx_http_userid_filter_module.c"
                             ,
      
# 117 "src/http/modules/ngx_http_userid_filter_module.c" 3 4
     0
# 117 "src/http/modules/ngx_http_userid_filter_module.c"
                                           ,
      0 },

    { { sizeof("userid_domain") - 1, (u_char *) "userid_domain" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_str_slot,
      
# 123 "src/http/modules/ngx_http_userid_filter_module.c" 3 4
     0
# 123 "src/http/modules/ngx_http_userid_filter_module.c"
                             ,
      
# 124 "src/http/modules/ngx_http_userid_filter_module.c" 3 4
     0
# 124 "src/http/modules/ngx_http_userid_filter_module.c"
                                             ,
      &ngx_http_userid_domain_p },

    { { sizeof("userid_path") - 1, (u_char *) "userid_path" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_str_slot,
      
# 130 "src/http/modules/ngx_http_userid_filter_module.c" 3 4
     0
# 130 "src/http/modules/ngx_http_userid_filter_module.c"
                             ,
      
# 131 "src/http/modules/ngx_http_userid_filter_module.c" 3 4
     0
# 131 "src/http/modules/ngx_http_userid_filter_module.c"
                                           ,
      &ngx_http_userid_path_p },

    { { sizeof("userid_expires") - 1, (u_char *) "userid_expires" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_http_userid_expires,
      
# 137 "src/http/modules/ngx_http_userid_filter_module.c" 3 4
     0
# 137 "src/http/modules/ngx_http_userid_filter_module.c"
                             ,
      0,
      0 },

    { { sizeof("userid_p3p") - 1, (u_char *) "userid_p3p" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_str_slot,
      
# 144 "src/http/modules/ngx_http_userid_filter_module.c" 3 4
     0
# 144 "src/http/modules/ngx_http_userid_filter_module.c"
                             ,
      
# 145 "src/http/modules/ngx_http_userid_filter_module.c" 3 4
     0
# 145 "src/http/modules/ngx_http_userid_filter_module.c"
                                          ,
      &ngx_http_userid_p3p_p },

    { { sizeof("userid_mark") - 1, (u_char *) "userid_mark" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_http_userid_mark,
      
# 151 "src/http/modules/ngx_http_userid_filter_module.c" 3 4
     0
# 151 "src/http/modules/ngx_http_userid_filter_module.c"
                             ,
      0,
      0 },
...
static ngx_str_t ngx_http_userid_got = { sizeof("uid_got") - 1, (u_char *) "uid_got" };
static ngx_str_t ngx_http_userid_set = { sizeof("uid_set") - 1, (u_char *) "uid_set" };
static ngx_str_t ngx_http_userid_reset = { sizeof("uid_reset") - 1, (u_char *) "uid_reset" };
    ...
    ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    conf = (r->main)->loc_conf[ngx_http_userid_filter_module.ctx_index];
    ...
    ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    if (ngx_http_userid_create_uid(r->main, ctx, conf) != 0) {
        return -1;
    }
...
ngx_http_userid_get_uid(ngx_http_request_t *r, ngx_http_userid_conf_t *conf)
{
    ...
    ctx = (r)->ctx[ngx_http_userid_filter_module.ctx_index];
    ...
    if (ctx == 0) {
        ...
        r->ctx[ngx_http_userid_filter_module.ctx_index] = ctx;;
    }
    ...
    if (ctx->cookie.len < 22) {
        ...
        if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "client sent too short userid cookie \"%V\"", &cookies[n]->value)
    ...
    src = ctx->cookie;
# 338 "src/http/modules/ngx_http_userid_filter_module.c"
    src.len = 22;
    ...
    if (ngx_decode_base64(&dst, &src) == -1) {
        cookies = r->headers_in.cookies.elts;
        if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "client sent invalid userid cookie \"%V\"", &cookies[n]->value)
    ...
    ngx_http_userid_conf_t *conf)
{
    ...
    if (ngx_http_userid_create_uid(r, ctx, conf) != 0) {
        return -1;
    }
    ...
    len = conf->name.len + 1 + (((16 + 2) / 3) * 4) + conf->path.len;
    ...
    p = (((u_char *) memcpy(cookie, conf->name.data, conf->name.len)) + (conf->name.len));
    *p++ = '=';
    ...
    if (ctx->uid_got[3] == 0 || ctx->reset) {
        ...
        p = (((u_char *) memcpy(p, ctx->cookie.data, 22)) + (22));
        *p++ = conf->mark;
        *p++ = '=';
    }

    if (conf->expires == 2145916555) {
        p = (((u_char *) memcpy(p, expires, sizeof(expires) - 1)) + (sizeof(expires) - 1));

    } else if (conf->expires) {
        p = (((u_char *) memcpy(p, expires, sizeof("; expires=") - 1)) + (sizeof("; expires=") - 1));
        p = ngx_http_cookie_time(p, ngx_cached_time->sec + conf->expires);
    }

    p = (((u_char *) memcpy(p, conf->domain.data, conf->domain.len)) + (conf->domain.len));

    p = (((u_char *) memcpy(p, conf->path.data, conf->path.len)) + (conf->path.len));
    ...
    set_cookie->hash = 1;
    (&set_cookie->key)->len = sizeof("Set-Cookie") - 1; (&set_cookie->key)->data = (u_char *) "Set-Cookie";
    ...
    p3p->hash = 1;
    (&p3p->key)->len = sizeof("P3P") - 1; (&p3p->key)->data = (u_char *) "P3P";
    p3p->value = conf->p3p;
    ...
    ngx_http_userid_conf_t *conf)
{
    ...
    if (ctx->uid_got[3] != 0) {
        ...
        if (vv->len == 0 || (vv->len == 1 && vv->data[0] == '0')) {
            ...
            if (vv->len == 3 && strncmp((const char *) vv->data, (const char *) "log", 3) == 0) {
                if ((r->connection->log)->log_level >= 6) ngx_log_error_core(6, r->connection->log, 0, "userid cookie \"%V=%08XD%08XD%08XD%08XD\" was reset", &conf->name, ctx->uid_got[0], ctx->uid_got[1], ctx->uid_got[2], ctx->uid_got[3])
    ...
    if (conf->enable == 2) {
        ...
        if (conf->service == -1) {
            ...
            if (ngx_connection_local_sockaddr(c, 0, 0) != 0) {
                return -1;
            }
...
# 660 "src/http/modules/ngx_http_userid_filter_module.c"
...
ngx_http_userid_merge_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    if (conf->enable == (ngx_uint_t) -1) { conf->enable = (prev->enable == (ngx_uint_t) -1) ? 0 : prev->enable; }
                                                  ;

    if (conf->name.data == 0) { if (prev->name.data) { conf->name.len = prev->name.len; conf->name.data = prev->name.data; } else { conf->name.len = sizeof("uid") - 1; conf->name.data = (u_char *) "uid"; } };
    if (conf->domain.data == 0) { if (prev->domain.data) { conf->domain.len = prev->domain.len; conf->domain.data = prev->domain.data; } else { conf->domain.len = sizeof("") - 1; conf->domain.data = (u_char *) ""; } };
    if (conf->path.data == 0) { if (prev->path.data) { conf->path.len = prev->path.len; conf->path.data = prev->path.data; } else { conf->path.len = sizeof("; path=/") - 1; conf->path.data = (u_char *) "; path=/"; } };
    if (conf->p3p.data == 0) { if (prev->p3p.data) { conf->p3p.len = prev->p3p.len; conf->p3p.data = prev->p3p.data; } else { conf->p3p.len = sizeof("") - 1; conf->p3p.data = (u_char *) ""; } };

    if (conf->service == -1) { conf->service = (prev->service == -1) ? -1 : prev->service; };
    if (conf->expires == -1) { conf->expires = (prev->expires == -1) ? 0 : prev->expires; };
...
ngx_http_userid_domain(ngx_conf_t *cf, void *post, void *data)
{
    ...
    if (strcmp((const char *) domain->data, (const char *) "none") == 0) {
        (domain)->len = sizeof("") - 1; (domain)->data = (u_char *) "";
        return 0;
    }
    ...
    p = (((u_char *) memcpy(new, "; domain=", sizeof("; domain=") - 1)) + (sizeof("; domain=") - 1));
    (void) memcpy(p, domain->data, domain->len);
...
ngx_http_userid_path(ngx_conf_t *cf, void *post, void *data)
{
    ...
    p = (((u_char *) memcpy(new, "; path=", sizeof("; path=") - 1)) + (sizeof("; path=") - 1));
...
ngx_http_userid_expires(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (strcmp((const char *) value[1].data, (const char *) "max") == 0) {
...
ngx_http_userid_p3p(ngx_conf_t *cf, void *post, void *data)
{
    ...
    if (strcmp((const char *) p3p->data, (const char *) "none") == 0) {
        (p3p)->len = sizeof("") - 1; (p3p)->data = (u_char *) "";
    }
