# 1 "src/http/modules/ngx_http_try_files_module.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 9 "src/http/modules/ngx_http_try_files_module.c" 2
...
# 10 "src/http/modules/ngx_http_try_files_module.c" 2
...
# 11 "src/http/modules/ngx_http_try_files_module.c" 2
...
static ngx_command_t ngx_http_try_files_commands[] = {
    ...
    { { sizeof("try_files") - 1, (u_char *) "try_files" },
      0x04000000|0x08000000|0x00001000,
      ngx_http_try_files,
      
# 39 "src/http/modules/ngx_http_try_files_module.c" 3 4
     0
# 39 "src/http/modules/ngx_http_try_files_module.c"
                             ,
      0,
      0 },
...
ngx_http_try_files_handler(ngx_http_request_t *r)
{
    ...
    for ( ;; ) {
        ...
        } else if (alias == 9223372036854775807LL) {
            reserve = len;
        ...
        if (tf->values == 0) {
            ...
            *e.pos = '\0';
            ...
            if (alias && alias != 9223372036854775807LL
                && strncmp((const char *) name, (const char *) r->uri.data, alias) == 0)
            {
