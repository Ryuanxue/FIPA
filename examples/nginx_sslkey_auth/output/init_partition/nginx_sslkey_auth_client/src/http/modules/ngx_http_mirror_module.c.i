# 1 "src/http/modules/ngx_http_mirror_module.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 9 "src/http/modules/ngx_http_mirror_module.c" 2
...
# 10 "src/http/modules/ngx_http_mirror_module.c" 2
...
# 11 "src/http/modules/ngx_http_mirror_module.c" 2
...
static ngx_command_t ngx_http_mirror_commands[] = {
    ...
    { { sizeof("mirror") - 1, (u_char *) "mirror" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_http_mirror,
      
# 39 "src/http/modules/ngx_http_mirror_module.c" 3 4
     0
# 39 "src/http/modules/ngx_http_mirror_module.c"
                             ,
      0,
      0 },

    { { sizeof("mirror_request_body") - 1, (u_char *) "mirror_request_body" },
      0x02000000|0x04000000|0x08000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 46 "src/http/modules/ngx_http_mirror_module.c" 3 4
     0
# 46 "src/http/modules/ngx_http_mirror_module.c"
                             ,
      
# 47 "src/http/modules/ngx_http_mirror_module.c" 3 4
     0
# 47 "src/http/modules/ngx_http_mirror_module.c"
                                                       ,
      0 },
...
ngx_http_mirror_handler_internal(ngx_http_request_t *r)
{
    ...
    for (i = 0; i < mlcf->mirror->nelts; i++) {
        if (ngx_http_subrequest(r, &name[i], &r->args, &sr, 0,
                                16)
            != 0)
        {
            return 500;
...
ngx_http_mirror_merge_loc_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    if (conf->mirror == (void *) -1) { conf->mirror = (prev->mirror == (void *) -1) ? 0 : prev->mirror; };
    if (conf->request_body == -1) { conf->request_body = (prev->request_body == -1) ? 1 : prev->request_body; };
