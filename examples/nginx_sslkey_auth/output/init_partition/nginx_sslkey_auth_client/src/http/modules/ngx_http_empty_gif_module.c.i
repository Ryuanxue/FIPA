# 1 "src/http/modules/ngx_http_empty_gif_module.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 8 "src/http/modules/ngx_http_empty_gif_module.c" 2
...
# 9 "src/http/modules/ngx_http_empty_gif_module.c" 2
...
# 10 "src/http/modules/ngx_http_empty_gif_module.c" 2
...
static ngx_command_t ngx_http_empty_gif_commands[] = {
    ...
    { { sizeof("empty_gif") - 1, (u_char *) "empty_gif" },
...
static ngx_str_t ngx_http_gif_type = { sizeof("image/gif") - 1, (u_char *) "image/gif" };
...
ngx_http_empty_gif_handler(ngx_http_request_t *r)
{
    ...
    (void) memset(&cv, 0, sizeof(ngx_http_complex_value_t));

    cv.value.len = sizeof(ngx_empty_gif);
    cv.value.data = ngx_empty_gif;
    r->headers_out.last_modified_time = 23349600;

    return ngx_http_send_response(r, 200, &ngx_http_gif_type, &cv);
}
