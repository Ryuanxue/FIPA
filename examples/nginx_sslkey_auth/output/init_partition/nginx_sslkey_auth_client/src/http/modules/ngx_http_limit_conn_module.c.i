# 1 "src/http/modules/ngx_http_limit_conn_module.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 9 "src/http/modules/ngx_http_limit_conn_module.c" 2
...
# 10 "src/http/modules/ngx_http_limit_conn_module.c" 2
...
# 11 "src/http/modules/ngx_http_limit_conn_module.c" 2
...
static inline void ngx_http_limit_conn_cleanup_all(ngx_pool_t *pool);
...
static ngx_command_t ngx_http_limit_conn_commands[] = {
    ...
    { { sizeof("limit_conn_zone") - 1, (u_char *) "limit_conn_zone" },
    ...
    { { sizeof("limit_conn") - 1, (u_char *) "limit_conn" },
      0x02000000|0x04000000|0x08000000|0x00000004,
      ngx_http_limit_conn,
      
# 87 "src/http/modules/ngx_http_limit_conn_module.c" 3 4
     0
# 87 "src/http/modules/ngx_http_limit_conn_module.c"
                             ,
      0,
      0 },

    { { sizeof("limit_conn_log_level") - 1, (u_char *) "limit_conn_log_level" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_enum_slot,
      
# 94 "src/http/modules/ngx_http_limit_conn_module.c" 3 4
     0
# 94 "src/http/modules/ngx_http_limit_conn_module.c"
                             ,
      
# 95 "src/http/modules/ngx_http_limit_conn_module.c" 3 4
     0
# 95 "src/http/modules/ngx_http_limit_conn_module.c"
                                                    ,
      &ngx_http_limit_conn_log_levels },

    { { sizeof("limit_conn_status") - 1, (u_char *) "limit_conn_status" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_num_slot,
      
# 101 "src/http/modules/ngx_http_limit_conn_module.c" 3 4
     0
# 101 "src/http/modules/ngx_http_limit_conn_module.c"
                             ,
      
# 102 "src/http/modules/ngx_http_limit_conn_module.c" 3 4
     0
# 102 "src/http/modules/ngx_http_limit_conn_module.c"
                                                      ,
...
ngx_http_limit_conn_handler(ngx_http_request_t *r)
{
    ...
    for (i = 0; i < lccf->limits.nelts; i++) {
        ...
        if (key.len > 255) {
            if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "the value of the \"%V\" key " "is more than 255 bytes: \"%V\"", &ctx->key.value, &key)
        ...
        if (node == 0) {
            ...
            n = 
# 194 "src/http/modules/ngx_http_limit_conn_module.c" 3 4
               0
                
# 195 "src/http/modules/ngx_http_limit_conn_module.c"
               + 
# 195 "src/http/modules/ngx_http_limit_conn_module.c" 3 4
                 0
                
# 196 "src/http/modules/ngx_http_limit_conn_module.c"
               + key.len;
            ...
            if ((ngx_uint_t) lc->conn >= limits[i].conn) {
                ...
                if ((r->connection->log)->log_level >= lccf->log_level) ngx_log_error_core(lccf->log_level, r->connection->log, 0, "limiting connections by zone \"%V\"", &limits[i].shm_zone->shm.name)
...
ngx_http_limit_conn_init_zone(ngx_shm_zone_t *shm_zone, void *data)
{
    ...
    if (octx) {
        if (ctx->key.value.len != octx->key.value.len
            || strncmp((const char *) ctx->key.value.data, (const char *) octx->key.value.data, ctx->key.value.len)
               ...
               != 0)
        {
            if ((shm_zone->shm.log)->log_level >= 1) ngx_log_error_core(1, shm_zone->shm.log, 0, "limit_conn_zone \"%V\" uses the \"%V\" key " "while previously it used the \"%V\" key", &shm_zone->shm.name, &ctx->key.value, &octx->key.value)
    ...
    ((sentinel)->color = 0); (ctx->rbtree)->root = sentinel; (ctx->rbtree)->sentinel = sentinel; (ctx->rbtree)->insert = ngx_http_limit_conn_rbtree_insert_value
                                                            ;
...
ngx_http_limit_conn_merge_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    if (conf->log_level == (ngx_uint_t) -1) { conf->log_level = (prev->log_level == (ngx_uint_t) -1) ? 4 : prev->log_level; };
