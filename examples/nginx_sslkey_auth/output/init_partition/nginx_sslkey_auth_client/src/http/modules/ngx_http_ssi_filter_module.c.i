# 1 "src/http/modules/ngx_http_ssi_filter_module.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 9 "src/http/modules/ngx_http_ssi_filter_module.c" 2
...
# 10 "src/http/modules/ngx_http_ssi_filter_module.c" 2
...
# 11 "src/http/modules/ngx_http_ssi_filter_module.c" 2
...
# 12 "src/http/modules/ngx_http_ssi_filter_module.c" 2
# 20 "src/http/modules/ngx_http_ssi_filter_module.c"
typedef struct {
    ngx_flag_t enable;
...
static ngx_command_t ngx_http_ssi_filter_commands[] = {
    ...
    { { sizeof("ssi") - 1, (u_char *) "ssi" },
      0x02000000|0x04000000|0x08000000|0x40000000
                        |0x00000200,
      ngx_conf_set_flag_slot,
      
# 127 "src/http/modules/ngx_http_ssi_filter_module.c" 3 4
     0
# 127 "src/http/modules/ngx_http_ssi_filter_module.c"
                             ,
      
# 128 "src/http/modules/ngx_http_ssi_filter_module.c" 3 4
     0
# 128 "src/http/modules/ngx_http_ssi_filter_module.c"
                                              ,
      0 },

    { { sizeof("ssi_silent_errors") - 1, (u_char *) "ssi_silent_errors" },
      0x02000000|0x04000000|0x08000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 134 "src/http/modules/ngx_http_ssi_filter_module.c" 3 4
     0
# 134 "src/http/modules/ngx_http_ssi_filter_module.c"
                             ,
      
# 135 "src/http/modules/ngx_http_ssi_filter_module.c" 3 4
     0
# 135 "src/http/modules/ngx_http_ssi_filter_module.c"
                                                     ,
      0 },

    { { sizeof("ssi_ignore_recycled_buffers") - 1, (u_char *) "ssi_ignore_recycled_buffers" },
      0x02000000|0x04000000|0x08000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 141 "src/http/modules/ngx_http_ssi_filter_module.c" 3 4
     0
# 141 "src/http/modules/ngx_http_ssi_filter_module.c"
                             ,
      
# 142 "src/http/modules/ngx_http_ssi_filter_module.c" 3 4
     0
# 142 "src/http/modules/ngx_http_ssi_filter_module.c"
                                                               ,
      0 },

    { { sizeof("ssi_min_file_chunk") - 1, (u_char *) "ssi_min_file_chunk" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_size_slot,
      
# 148 "src/http/modules/ngx_http_ssi_filter_module.c" 3 4
     0
# 148 "src/http/modules/ngx_http_ssi_filter_module.c"
                             ,
      
# 149 "src/http/modules/ngx_http_ssi_filter_module.c" 3 4
     0
# 149 "src/http/modules/ngx_http_ssi_filter_module.c"
                                                      ,
      0 },

    { { sizeof("ssi_value_length") - 1, (u_char *) "ssi_value_length" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_size_slot,
      
# 155 "src/http/modules/ngx_http_ssi_filter_module.c" 3 4
     0
# 155 "src/http/modules/ngx_http_ssi_filter_module.c"
                             ,
      
# 156 "src/http/modules/ngx_http_ssi_filter_module.c" 3 4
     0
# 156 "src/http/modules/ngx_http_ssi_filter_module.c"
                                                 ,
      0 },

    { { sizeof("ssi_types") - 1, (u_char *) "ssi_types" },
      0x02000000|0x04000000|0x08000000|0x00000800,
      ngx_http_types_slot,
      
# 162 "src/http/modules/ngx_http_ssi_filter_module.c" 3 4
     0
# 162 "src/http/modules/ngx_http_ssi_filter_module.c"
                             ,
      
# 163 "src/http/modules/ngx_http_ssi_filter_module.c" 3 4
     0
# 163 "src/http/modules/ngx_http_ssi_filter_module.c"
                                                  ,
      &ngx_http_html_default_types[0] },

    { { sizeof("ssi_last_modified") - 1, (u_char *) "ssi_last_modified" },
      0x02000000|0x04000000|0x08000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 169 "src/http/modules/ngx_http_ssi_filter_module.c" 3 4
     0
# 169 "src/http/modules/ngx_http_ssi_filter_module.c"
                             ,
      
# 170 "src/http/modules/ngx_http_ssi_filter_module.c" 3 4
     0
# 170 "src/http/modules/ngx_http_ssi_filter_module.c"
                                                     ,
      0 },
...
static ngx_str_t ngx_http_ssi_none = { sizeof("(none)") - 1, (u_char *) "(none)" };
static ngx_str_t ngx_http_ssi_timefmt = { sizeof("%A, %d-%b-%Y %H:%M:%S %Z") - 1, (u_char *) "%A, %d-%b-%Y %H:%M:%S %Z" };
static ngx_str_t ngx_http_ssi_null_string = { 0, 0 };
# 241 "src/http/modules/ngx_http_ssi_filter_module.c"
static ngx_http_ssi_param_t ngx_http_ssi_include_params[] = {
    { { sizeof("virtual") - 1, (u_char *) "virtual" }, 0, 0, 0 },
    { { sizeof("file") - 1, (u_char *) "file" }, 1, 0, 0 },
    { { sizeof("wait") - 1, (u_char *) "wait" }, 2, 0, 0 },
    { { sizeof("set") - 1, (u_char *) "set" }, 3, 0, 0 },
    { { sizeof("stub") - 1, (u_char *) "stub" }, 4, 0, 0 },
    { { 0, 0 }, 0, 0, 0 }
};


static ngx_http_ssi_param_t ngx_http_ssi_echo_params[] = {
    { { sizeof("var") - 1, (u_char *) "var" }, 0, 1, 0 },
    { { sizeof("default") - 1, (u_char *) "default" }, 1, 0, 0 },
    { { sizeof("encoding") - 1, (u_char *) "encoding" }, 2, 0, 0 },
    { { 0, 0 }, 0, 0, 0 }
};


static ngx_http_ssi_param_t ngx_http_ssi_config_params[] = {
    { { sizeof("errmsg") - 1, (u_char *) "errmsg" }, 0, 0, 0 },
    { { sizeof("timefmt") - 1, (u_char *) "timefmt" }, 1, 0, 0 },
    { { 0, 0 }, 0, 0, 0 }
};
...
static ngx_http_ssi_command_t ngx_http_ssi_commands[] = {
    { { sizeof("include") - 1, (u_char *) "include" }, ngx_http_ssi_include,
                       ngx_http_ssi_include_params, 0, 0, 1 },
    { { sizeof("echo") - 1, (u_char *) "echo" }, ngx_http_ssi_echo,
                       ngx_http_ssi_echo_params, 0, 0, 0 },
    { { sizeof("config") - 1, (u_char *) "config" }, ngx_http_ssi_config,
                       ngx_http_ssi_config_params, 0, 0, 0 },
    { { sizeof("set") - 1, (u_char *) "set" }, ngx_http_ssi_set, ngx_http_ssi_set_params, 0, 0, 0 },

    { { sizeof("if") - 1, (u_char *) "if" }, ngx_http_ssi_if, ngx_http_ssi_if_params, 0, 0, 0 },
    { { sizeof("elif") - 1, (u_char *) "elif" }, ngx_http_ssi_if, ngx_http_ssi_if_params,
                       1, 0, 0 },
    { { sizeof("else") - 1, (u_char *) "else" }, ngx_http_ssi_else, ngx_http_ssi_no_params,
                       1, 0, 0 },
    { { sizeof("endif") - 1, (u_char *) "endif" }, ngx_http_ssi_endif, ngx_http_ssi_no_params,
                       2, 0, 0 },

    { { sizeof("block") - 1, (u_char *) "block" }, ngx_http_ssi_block,
                       ngx_http_ssi_block_params, 0, 0, 0 },
    { { sizeof("endblock") - 1, (u_char *) "endblock" }, ngx_http_ssi_endblock,
...
static ngx_http_variable_t ngx_http_ssi_vars[] = {
    ...
    { { sizeof("date_local") - 1, (u_char *) "date_local" }, 0, ngx_http_ssi_date_gmt_local_variable, 0,
      2, 0 },

    { { sizeof("date_gmt") - 1, (u_char *) "date_gmt" }, 0, ngx_http_ssi_date_gmt_local_variable, 1,
      2, 0 },
...
ngx_http_ssi_header_filter(ngx_http_request_t *r)
{
    ...
    if (!slcf->enable
        ...
        || ngx_http_test_content_type(r, &slcf->types) == 0)
    {
    ...
    (&ctx->errmsg)->len = sizeof("[an error occurred while processing the directive]") - 1; (&ctx->errmsg)->data = (u_char *) "[an error occurred while processing the directive]"
                                                                     ;

    r->filter_need_in_memory = 1;

    if (r == r->main) {
        r->headers_out.content_length_n = -1; if (r->headers_out.content_length) { r->headers_out.content_length->hash = 0; r->headers_out.content_length = 0; };
        r->allow_ranges = 0; if (r->headers_out.accept_ranges) { r->headers_out.accept_ranges->hash = 0; r->headers_out.accept_ranges = 0; };

        r->preserve_body = 1;

        if (!slcf->last_modified) {
            r->headers_out.last_modified_time = -1; if (r->headers_out.last_modified) { r->headers_out.last_modified->hash = 0; r->headers_out.last_modified = 0; };
            if (r->headers_out.etag) { r->headers_out.etag->hash = 0; r->headers_out.etag = 0; };
...
ngx_http_ssi_body_filter(ngx_http_request_t *r, ngx_chain_t *in)
{
    ...
    ngx_str_t *params[16 + 1];

    ctx = (r)->ctx[ngx_http_ssi_filter_module.ctx_index];
    ...
    if (in) {
        if (ngx_chain_add_copy(r->pool, &ctx->in, in) != 0) {
            return -1;
        }
    }
    ...
    if (ctx->wait) {
        ...
        if (ctx->wait->done) {
            ...
            return ngx_http_next_body_filter(r, 0);
        }
    }
        ...
        while (ctx->pos < ctx->buf->last) {
            ...
            if (ctx->copy_start != ctx->copy_end) {
                ...
                if (ctx->output) {
                    ...
                    (void) memcpy(b, ctx->buf, sizeof(ngx_buf_t));
                    ...
                    *ctx->last_out = cl;
                        ...
                        && ctx->saved + (ctx->copy_end - ctx->copy_start))
                    {
                        ...
                        if (ctx->saved) {
                            b->last = (((u_char *) memcpy(b->pos, ngx_http_ssi_string, ctx->saved)) + (ctx->saved))
                                                            ;
                        }

                        b->last = (((u_char *) memcpy(b->last, ctx->copy_start, ctx->copy_end - ctx->copy_start)) + (ctx->copy_end - ctx->copy_start))
                                                                             ;
                        ...
                        mctx = (r->main)->ctx[ngx_http_ssi_filter_module.ctx_index]
                                                                              ;
                        bl = mctx->blocks->elts;
            ...
            if (rc == 0) {
                ...
                smcf = (r)->main_conf[ngx_http_ssi_filter_module.ctx_index]
                                                                              ;
                ...
                if (cmd == 0) {
                    if (ctx->output) {
                        if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "invalid SSI command: \"%V\"", &ctx->command)
                ...
                if (!ctx->output && !cmd->block) {
                    ...
                    if (ctx->block) {
                        ...
                        *b->last++ = '#';
                        ...
                        b->last = (((u_char *) memcpy(b->last, ctx->command.data, ctx->command.len)) + (ctx->command.len))
                                                              ;

                        for (i = 0; i < ctx->params.nelts; i++) {
                            *b->last++ = ' ';
                            b->last = (((u_char *) memcpy(b->last, param[i].key.data, param[i].key.len)) + (param[i].key.len))
                                                                  ;
                            *b->last++ = '=';
                            *b->last++ = '"';
                            b->last = (((u_char *) memcpy(b->last, param[i].value.data, param[i].value.len)) + (param[i].value.len))
                                                                    ;
                            *b->last++ = '"';
                        }
                ...
                {
                    if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "invalid context of SSI command: \"%V\"", &ctx->command)

                                                ;
                    goto ssi_error;
                }

                if (ctx->params.nelts > 16) {
                    if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "too many SSI command parameters: \"%V\"", &ctx->command)

                                                ;
                    goto ssi_error;
                }

                (void) memset(params, 0, (16 + 1) * sizeof(ngx_str_t *))
                                                                               ;
                ...
                for (i = 0; i < ctx->params.nelts; i++) {
                    ...
                    for (prm = cmd->params; prm->name.len; prm++) {
                        ...
                        if (param[i].key.len != prm->name.len
                            || strncmp((const char *) param[i].key.data, (const char *) prm->name.data, prm->name.len)
                                                          != 0)
                        {
                            continue;
                        }
                        ...
                        if (!prm->multiple) {
                            if (params[prm->index]) {
                                if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "duplicate \"%V\" parameter " "in \"%V\" SSI command", &param[i].key, &ctx->command)
                    ...
                    if (prm->name.len == 0) {
                        if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "invalid parameter name: \"%V\" " "in \"%V\" SSI command", &param[i].key, &ctx->command)
                ...
                for (prm = cmd->params; prm->name.len; prm++) {
                    if (prm->mandatory && params[prm->index] == 0) {
                        if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "mandatory \"%V\" parameter is absent " "in \"%V\" SSI command", &prm->name, &ctx->command)
                ...
                if (cmd->flush && ctx->out) {
                    ...
                    if (ngx_http_ssi_output(r, ctx) == -1) {
                        return -1;
                    }
                }
    ...
    ssi_error:
        ...
        if (ctx->buf->last_buf || (ctx->buf->temporary || ctx->buf->memory || ctx->buf->mmap)) {
            if (b == 0) {
                if (ctx->free) {
                    cl = ctx->free;
                    ctx->free = ctx->free->next;
...
ngx_http_ssi_output(ngx_http_request_t *r, ngx_http_ssi_ctx_t *ctx)
{
    ...
    for (cl = ctx->out; cl; cl = cl->next) {
                                                               ...
                                                               ;
        if (cl->buf == b) {
            if ((r->connection->log)->log_level >= 2) ngx_log_error_core(2, r->connection->log, 0, "the same buf was used in ssi")
                                                         ;
            ngx_debug_point();
            return -1;
        }
    ...
    while (ctx->busy) {
        ...
        if (((b->temporary || b->memory || b->mmap) ? (off_t) (b->last - b->pos): (b->file_last - b->file_pos)) != 0) {
            break;
        }
        ...
        if ((b->temporary || b->memory || b->mmap) || b->in_file) {
...
ngx_http_ssi_parse(ngx_http_request_t *r, ngx_http_ssi_ctx_t *ctx)
{
    ...
    for (p = ctx->pos; p < last; p++) {
        ...
        case ssi_precommand_state:
            ...
            default:
                ...
                ctx->key = 0;
                ctx->key = ((ngx_uint_t) ctx->key * 31 + ch);
        ...
        case ssi_command_state:
            ...
            default:
                if (ctx->command.len == 32) {
                    if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "the \"%V%c...\" SSI command is too long", &ctx->command, ch)
        ...
        case ssi_param_state:
            ...
            case '-':
                ...
                if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "invalid \"%V\" parameter in \"%V\" SSI command", &ctx->param->key, &ctx->command)

                                                              ;
                break;

            default:
                if (ctx->param->key.len == 32) {
                    state = ssi_error_state;
                    if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "too long \"%V%c...\" parameter in " "\"%V\" SSI command", &ctx->param->key, ch, &ctx->command)
        ...
        case ssi_preequal_state:
            ...
            default:
                ...
                if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "unexpected \"%c\" symbol after \"%V\" " "parameter in \"%V\" SSI command", ch, &ctx->param->key, &ctx->command)
        ...
        case ssi_prevalue_state:
            ...
            default:
                ...
                if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "unexpected \"%c\" symbol before value of " "\"%V\" parameter in \"%V\" SSI command", ch, &ctx->param->key, &ctx->command)
        ...
        case ssi_double_quoted_value_state:
            ...
            default:
                if (ctx->param->value.len == ctx->value_len) {
                    if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "too long \"%V%c...\" value of \"%V\" " "parameter in \"%V\" SSI command", &ctx->param->value, ch, &ctx->param->key, &ctx->command)
        ...
        case ssi_postparam_state:
            ...
            if (ctx->param->value.len + 1 < ctx->value_len / 2) {
                ...
                (void) memcpy(value, ctx->param->value.data, ctx->param->value.len)
                                                 ;
            ...
            default:
                if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "unexpected \"%c\" symbol after \"%V\" value " "of \"%V\" parameter in \"%V\" SSI command", ch, &ctx->param->value, &ctx->param->key, &ctx->command)
        ...
        case ssi_comment_end0_state:
            ...
            default:
                if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "unexpected \"%c\" symbol in \"%V\" SSI command", ch, &ctx->command)
    ...
    if (ctx->copy_start == 0 && ctx->copy_end) {
        ctx->copy_start = ctx->buf->pos;
    }
    ...
    ngx_uint_t key)
{
    ...
    ctx = (r->main)->ctx[ngx_http_ssi_filter_module.ctx_index];
# 1590 "src/http/modules/ngx_http_ssi_filter_module.c"
    if (ctx->variables == 0) {
        return 0;
    }
    ...
    for (i = 0; ; i++) {
        ...
        if (strncmp((const char *) name->data, (const char *) var[i].name.data, name->len) == 0) {
            return &var[i].value;
        }
    }
    ...
    ngx_str_t *text, ngx_uint_t flags)
{
    ...
    if (n == 0) {
        ...
        if ((flags & 1) && text->data[0] != '/') {
            ...
            if (prefix) {
                ...
                p = (((u_char *) memcpy(data, r->uri.data, prefix)) + (prefix));
            }
        }
    ...
    if (ngx_array_init(&lengths, r->pool, 8, sizeof(size_t *)) != 0) {
        return -1;
    }

    if (ngx_array_init(&values, r->pool, 8, sizeof(u_char *)) != 0) {
        return -1;
    }
    ...
    while (i < text->len) {
        ...
        if (text->data[i] == '$') {
            ...
            if (bracket) {
                if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "the closing bracket in \"%V\" " "variable is missing", &var)
    ...
    p = (((u_char *) memcpy(p, r->uri.data, prefix)) + (prefix));

    for (i = 0; i < values.nelts; i++) {
        p = (((u_char *) memcpy(p, value[i], size[i])) + (size[i]));
    }
...
invalid_variable:
    ...
    if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "invalid variable name in \"%V\"", text)
                                                          ;
...
ngx_http_ssi_regex_match(ngx_http_request_t *r, ngx_str_t *pattern,
    ngx_str_t *str)
{
# 1976 "src/http/modules/ngx_http_ssi_filter_module.c"
    if ((r->connection->log)->log_level >= 2) ngx_log_error_core(2, r->connection->log, 0, "the using of the regex \"%V\" in SSI requires PCRE library", pattern)
    ...
    ngx_str_t **params)
{
    ...
    if (uri && file) {
        if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "inclusion may be either virtual=\"%V\" or file=\"%V\"", uri, file)
    ...
    if (uri == 0 && file == 0) {
        if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "no parameter in \"include\" SSI command")
                                                                ;
        return 1;
    }

    if (set && stub) {
        if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "\"set\" and \"stub\" cannot be used together " "in \"include\" SSI command")
    ...
    if (wait) {
        if (uri == 0) {
            if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "\"wait\" cannot be used with file=\"%V\"", file)
                                                                           ;
            return 1;
        }
        ...
        {
            if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "invalid value \"%V\" in the \"wait\" parameter", wait)
    ...
    if (stub) {
        if (mctx->blocks) {
            ...
            for (i = 0; i < mctx->blocks->nelts; i++) {
                if (stub->len == bl[i].name.len
                    && strncmp((const char *) stub->data, (const char *) bl[i].name.data, stub->len) == 0)
                {
                    goto found;
                }
            }
        ...
        if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "\"stub\"=\"%V\" for \"include\" not found", stub)
                                                                        ;
        return 1;
    ...
    found:
        ...
        if (bl[i].count++) {
            ...
            for (tl = bl[i].bufs; tl; tl = tl->next) {
                ...
                (void) memcpy(b, tl->buf, sizeof(ngx_buf_t));
    ...
    if (ngx_http_subrequest(r, uri, &args, &sr, psr, flags) != 0) {
        return 1;
    }
    ...
    if (ctx->wait == 0) {
        ...
        if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "can only wait for one subrequest at a time")
                                                                   ;
    }
...
ngx_http_ssi_stub_output(ngx_http_request_t *r, void *data, ngx_int_t rc)
{
    ...
    if (rc == -1 || r->connection->error || r->request_output) {
        return rc;
    }
    ...
    ngx_str_t **params)
{
    ...
    if (enc) {
        if (enc->len == 4 && strncmp((const char *) enc->data, (const char *) "none", 4) == 0) {

            ctx->encoding = 0;

        } else if (enc->len == 3 && strncmp((const char *) enc->data, (const char *) "url", 3) == 0) {

            ctx->encoding = 1;

        } else if (enc->len == 6 && strncmp((const char *) enc->data, (const char *) "entity", 6) == 0) {

            ctx->encoding = 2;

        } else {
            if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "unknown encoding \"%V\" in the \"echo\" command", enc)
    ...
    case 1:
        len = 2 * ngx_escape_uri(0, value->data, value->len,
                                 3);
        ...
        if (len) {
            ...
            (void) ngx_escape_uri(p, value->data, value->len, 3);
        }
    ...
    case 2:
        len = ngx_escape_html(0, value->data, value->len);
    ...
    ngx_str_t **params)
{
    ...
    if (ctx->command.len == 2) {
        if (ctx->conditional) {
            if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "the \"if\" command inside the \"if\" command")
                                                                         ;
            return 1;
        }
    }
    ...
    if (noregex) {
        if (left.len != right.len) {
            ...
            rc = strncmp((const char *) left.data, (const char *) right.data, right.len);
        }
...
invalid_expression:
    ...
    if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "invalid expression in \"%V\"", expr)
                                                       ;
...
ngx_http_ssi_preconfiguration(ngx_conf_t *cf)
{
    ...
    smcf = ((ngx_http_conf_ctx_t *) cf->ctx)->main_conf[ngx_http_ssi_filter_module.ctx_index];
...
ngx_http_ssi_create_main_conf(ngx_conf_t *cf)
{
    ...
    if (ngx_hash_keys_array_init(&smcf->commands, 1) != 0) {
        return 0;
    }
...
# 2884 "src/http/modules/ngx_http_ssi_filter_module.c"
    slcf->enable = -1;
    slcf->silent_errors = -1;
    slcf->ignore_recycled_buffers = -1;
    slcf->last_modified = -1;
...
ngx_http_ssi_merge_loc_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    if (conf->enable == -1) { conf->enable = (prev->enable == -1) ? 0 : prev->enable; };
    if (conf->silent_errors == -1) { conf->silent_errors = (prev->silent_errors == -1) ? 0 : prev->silent_errors; };
    if (conf->ignore_recycled_buffers == -1) { conf->ignore_recycled_buffers = (prev->ignore_recycled_buffers == -1) ? 0 : prev->ignore_recycled_buffers; }
                                                          ;
    if (conf->last_modified == -1) { conf->last_modified = (prev->last_modified == -1) ? 0 : prev->last_modified; };

    if (conf->min_file_chunk == (size_t) -1) { conf->min_file_chunk = (prev->min_file_chunk == (size_t) -1) ? 1024 : prev->min_file_chunk; };
    if (conf->value_len == (size_t) -1) { conf->value_len = (prev->value_len == (size_t) -1) ? 255 : prev->value_len; };
