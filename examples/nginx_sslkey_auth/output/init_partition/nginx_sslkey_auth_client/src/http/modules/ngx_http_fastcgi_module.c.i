...
# 9 "src/http/modules/ngx_http_fastcgi_module.c" 2
...
# 10 "src/http/modules/ngx_http_fastcgi_module.c" 2
...
# 11 "src/http/modules/ngx_http_fastcgi_module.c" 2
...
# 112 "src/http/modules/ngx_http_fastcgi_module.c"
typedef struct {
    u_char version;
    u_char type;
...
static ngx_command_t ngx_http_fastcgi_commands[] = {
    ...
    { { sizeof("fastcgi_pass") - 1, (u_char *) "fastcgi_pass" },
      0x08000000|0x40000000|0x00000002,
      ngx_http_fastcgi_pass,
      
# 229 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 229 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      0,
      0 },

    { { sizeof("fastcgi_index") - 1, (u_char *) "fastcgi_index" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_str_slot,
      
# 236 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 236 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 237 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 237 "src/http/modules/ngx_http_fastcgi_module.c"
                                                 ,
      0 },

    { { sizeof("fastcgi_split_path_info") - 1, (u_char *) "fastcgi_split_path_info" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_http_fastcgi_split_path_info,
      
# 243 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 243 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      0,
      0 },

    { { sizeof("fastcgi_store") - 1, (u_char *) "fastcgi_store" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_http_fastcgi_store,
      
# 250 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 250 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      0,
      0 },

    { { sizeof("fastcgi_store_access") - 1, (u_char *) "fastcgi_store_access" },
      0x02000000|0x04000000|0x08000000|(0x00000002|0x00000004|0x00000008),
      ngx_conf_set_access_slot,
      
# 257 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 257 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 258 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 258 "src/http/modules/ngx_http_fastcgi_module.c"
                                                                 ,
      0 },

    { { sizeof("fastcgi_buffering") - 1, (u_char *) "fastcgi_buffering" },
      0x02000000|0x04000000|0x08000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 264 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 264 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 265 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 265 "src/http/modules/ngx_http_fastcgi_module.c"
                                                              ,
      0 },

    { { sizeof("fastcgi_request_buffering") - 1, (u_char *) "fastcgi_request_buffering" },
      0x02000000|0x04000000|0x08000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 271 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 271 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 272 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 272 "src/http/modules/ngx_http_fastcgi_module.c"
                                                                      ,
      0 },

    { { sizeof("fastcgi_ignore_client_abort") - 1, (u_char *) "fastcgi_ignore_client_abort" },
      0x02000000|0x04000000|0x08000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 278 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 278 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 279 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 279 "src/http/modules/ngx_http_fastcgi_module.c"
                                                                        ,
      0 },

    { { sizeof("fastcgi_bind") - 1, (u_char *) "fastcgi_bind" },
      0x02000000|0x04000000|0x08000000|(0x00000002|0x00000004),
      ngx_http_upstream_bind_set_slot,
      
# 285 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 285 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 286 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 286 "src/http/modules/ngx_http_fastcgi_module.c"
                                                          ,
      0 },

    { { sizeof("fastcgi_connect_timeout") - 1, (u_char *) "fastcgi_connect_timeout" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_msec_slot,
      
# 292 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 292 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 293 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 293 "src/http/modules/ngx_http_fastcgi_module.c"
                                                                    ,
      0 },

    { { sizeof("fastcgi_send_timeout") - 1, (u_char *) "fastcgi_send_timeout" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_msec_slot,
      
# 299 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 299 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 300 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 300 "src/http/modules/ngx_http_fastcgi_module.c"
                                                                 ,
      0 },

    { { sizeof("fastcgi_send_lowat") - 1, (u_char *) "fastcgi_send_lowat" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_size_slot,
      
# 306 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 306 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 307 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 307 "src/http/modules/ngx_http_fastcgi_module.c"
                                                               ,
      &ngx_http_fastcgi_lowat_post },

    { { sizeof("fastcgi_buffer_size") - 1, (u_char *) "fastcgi_buffer_size" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_size_slot,
      
# 313 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 313 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 314 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 314 "src/http/modules/ngx_http_fastcgi_module.c"
                                                                ,
      0 },

    { { sizeof("fastcgi_pass_request_headers") - 1, (u_char *) "fastcgi_pass_request_headers" },
      0x02000000|0x04000000|0x08000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 320 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 320 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 321 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 321 "src/http/modules/ngx_http_fastcgi_module.c"
                                                                         ,
      0 },

    { { sizeof("fastcgi_pass_request_body") - 1, (u_char *) "fastcgi_pass_request_body" },
      0x02000000|0x04000000|0x08000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 327 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 327 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 328 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 328 "src/http/modules/ngx_http_fastcgi_module.c"
                                                                      ,
      0 },

    { { sizeof("fastcgi_intercept_errors") - 1, (u_char *) "fastcgi_intercept_errors" },
      0x02000000|0x04000000|0x08000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 334 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 334 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 335 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 335 "src/http/modules/ngx_http_fastcgi_module.c"
                                                                     ,
      0 },

    { { sizeof("fastcgi_read_timeout") - 1, (u_char *) "fastcgi_read_timeout" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_msec_slot,
      
# 341 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 341 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 342 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 342 "src/http/modules/ngx_http_fastcgi_module.c"
                                                                 ,
      0 },

    { { sizeof("fastcgi_buffers") - 1, (u_char *) "fastcgi_buffers" },
      0x02000000|0x04000000|0x08000000|0x00000004,
      ngx_conf_set_bufs_slot,
      
# 348 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 348 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 349 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 349 "src/http/modules/ngx_http_fastcgi_module.c"
                                                         ,
      0 },

    { { sizeof("fastcgi_busy_buffers_size") - 1, (u_char *) "fastcgi_busy_buffers_size" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_size_slot,
      
# 355 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 355 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 356 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 356 "src/http/modules/ngx_http_fastcgi_module.c"
                                                                           ,
      0 },

    { { sizeof("fastcgi_force_ranges") - 1, (u_char *) "fastcgi_force_ranges" },
      0x02000000|0x04000000|0x08000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 362 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 362 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 363 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 363 "src/http/modules/ngx_http_fastcgi_module.c"
                                                                 ,
      0 },

    { { sizeof("fastcgi_limit_rate") - 1, (u_char *) "fastcgi_limit_rate" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_size_slot,
      
# 369 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 369 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 370 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 370 "src/http/modules/ngx_http_fastcgi_module.c"
                                                               ,
      0 },



    { { sizeof("fastcgi_cache") - 1, (u_char *) "fastcgi_cache" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_http_fastcgi_cache,
      
# 378 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 378 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      0,
      0 },

    { { sizeof("fastcgi_cache_key") - 1, (u_char *) "fastcgi_cache_key" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_http_fastcgi_cache_key,
      
# 385 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 385 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      0,
      0 },

    { { sizeof("fastcgi_cache_path") - 1, (u_char *) "fastcgi_cache_path" },
      0x02000000|0x00001000,
      ngx_http_file_cache_set_slot,
      
# 392 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 392 "src/http/modules/ngx_http_fastcgi_module.c"
                              ,
      
# 393 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 393 "src/http/modules/ngx_http_fastcgi_module.c"
                                                   ,
      &ngx_http_fastcgi_module },

    { { sizeof("fastcgi_cache_bypass") - 1, (u_char *) "fastcgi_cache_bypass" },
      0x02000000|0x04000000|0x08000000|0x00000800,
      ngx_http_set_predicate_slot,
      
# 399 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 399 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 400 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 400 "src/http/modules/ngx_http_fastcgi_module.c"
                                                                 ,
      0 },

    { { sizeof("fastcgi_no_cache") - 1, (u_char *) "fastcgi_no_cache" },
      0x02000000|0x04000000|0x08000000|0x00000800,
      ngx_http_set_predicate_slot,
      
# 406 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 406 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 407 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 407 "src/http/modules/ngx_http_fastcgi_module.c"
                                                             ,
      0 },

    { { sizeof("fastcgi_cache_valid") - 1, (u_char *) "fastcgi_cache_valid" },
      0x02000000|0x04000000|0x08000000|0x00000800,
      ngx_http_file_cache_valid_set_slot,
      
# 413 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 413 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 414 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 414 "src/http/modules/ngx_http_fastcgi_module.c"
                                                                ,
      0 },

    { { sizeof("fastcgi_cache_min_uses") - 1, (u_char *) "fastcgi_cache_min_uses" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_num_slot,
      
# 420 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 420 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 421 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 421 "src/http/modules/ngx_http_fastcgi_module.c"
                                                                   ,
      0 },

    { { sizeof("fastcgi_cache_max_range_offset") - 1, (u_char *) "fastcgi_cache_max_range_offset" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_off_slot,
      
# 427 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 427 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 428 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 428 "src/http/modules/ngx_http_fastcgi_module.c"
                                                                           ,
      0 },

    { { sizeof("fastcgi_cache_use_stale") - 1, (u_char *) "fastcgi_cache_use_stale" },
      0x02000000|0x04000000|0x08000000|0x00000800,
      ngx_conf_set_bitmask_slot,
      
# 434 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 434 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 435 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 435 "src/http/modules/ngx_http_fastcgi_module.c"
                                                                    ,
      &ngx_http_fastcgi_next_upstream_masks },

    { { sizeof("fastcgi_cache_methods") - 1, (u_char *) "fastcgi_cache_methods" },
      0x02000000|0x04000000|0x08000000|0x00000800,
      ngx_conf_set_bitmask_slot,
      
# 441 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 441 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 442 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 442 "src/http/modules/ngx_http_fastcgi_module.c"
                                                                  ,
      &ngx_http_upstream_cache_method_mask },

    { { sizeof("fastcgi_cache_lock") - 1, (u_char *) "fastcgi_cache_lock" },
      0x02000000|0x04000000|0x08000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 448 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 448 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 449 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 449 "src/http/modules/ngx_http_fastcgi_module.c"
                                                               ,
      0 },

    { { sizeof("fastcgi_cache_lock_timeout") - 1, (u_char *) "fastcgi_cache_lock_timeout" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_msec_slot,
      
# 455 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 455 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 456 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 456 "src/http/modules/ngx_http_fastcgi_module.c"
                                                                       ,
      0 },

    { { sizeof("fastcgi_cache_lock_age") - 1, (u_char *) "fastcgi_cache_lock_age" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_msec_slot,
      
# 462 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 462 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 463 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 463 "src/http/modules/ngx_http_fastcgi_module.c"
                                                                   ,
      0 },

    { { sizeof("fastcgi_cache_revalidate") - 1, (u_char *) "fastcgi_cache_revalidate" },
      0x02000000|0x04000000|0x08000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 469 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 469 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 470 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 470 "src/http/modules/ngx_http_fastcgi_module.c"
                                                                     ,
      0 },

    { { sizeof("fastcgi_cache_background_update") - 1, (u_char *) "fastcgi_cache_background_update" },
      0x02000000|0x04000000|0x08000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 476 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 476 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 477 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 477 "src/http/modules/ngx_http_fastcgi_module.c"
                                                                            ,
      0 },



    { { sizeof("fastcgi_temp_path") - 1, (u_char *) "fastcgi_temp_path" },
      0x02000000|0x04000000|0x08000000|(0x00000002|0x00000004|0x00000008 |0x00000010),
      ngx_conf_set_path_slot,
      
# 485 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 485 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 486 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 486 "src/http/modules/ngx_http_fastcgi_module.c"
                                                              ,
      0 },

    { { sizeof("fastcgi_max_temp_file_size") - 1, (u_char *) "fastcgi_max_temp_file_size" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_size_slot,
      
# 492 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 492 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 493 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 493 "src/http/modules/ngx_http_fastcgi_module.c"
                                                                            ,
      0 },

    { { sizeof("fastcgi_temp_file_write_size") - 1, (u_char *) "fastcgi_temp_file_write_size" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_size_slot,
      
# 499 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 499 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 500 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 500 "src/http/modules/ngx_http_fastcgi_module.c"
                                                                              ,
      0 },

    { { sizeof("fastcgi_next_upstream") - 1, (u_char *) "fastcgi_next_upstream" },
      0x02000000|0x04000000|0x08000000|0x00000800,
      ngx_conf_set_bitmask_slot,
      
# 506 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 506 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 507 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 507 "src/http/modules/ngx_http_fastcgi_module.c"
                                                                  ,
      &ngx_http_fastcgi_next_upstream_masks },

    { { sizeof("fastcgi_next_upstream_tries") - 1, (u_char *) "fastcgi_next_upstream_tries" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_num_slot,
      
# 513 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 513 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 514 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 514 "src/http/modules/ngx_http_fastcgi_module.c"
                                                                        ,
      0 },

    { { sizeof("fastcgi_next_upstream_timeout") - 1, (u_char *) "fastcgi_next_upstream_timeout" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_msec_slot,
      
# 520 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 520 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 521 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 521 "src/http/modules/ngx_http_fastcgi_module.c"
                                                                          ,
      0 },

    { { sizeof("fastcgi_param") - 1, (u_char *) "fastcgi_param" },
      0x02000000|0x04000000|0x08000000|(0x00000004|0x00000008),
      ngx_http_upstream_param_set_slot,
      
# 527 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 527 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 528 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 528 "src/http/modules/ngx_http_fastcgi_module.c"
                                                         ,
      0 },

    { { sizeof("fastcgi_pass_header") - 1, (u_char *) "fastcgi_pass_header" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_str_array_slot,
      
# 534 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 534 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 535 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 535 "src/http/modules/ngx_http_fastcgi_module.c"
                                                                 ,
      0 },

    { { sizeof("fastcgi_hide_header") - 1, (u_char *) "fastcgi_hide_header" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_str_array_slot,
      
# 541 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 541 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 542 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 542 "src/http/modules/ngx_http_fastcgi_module.c"
                                                                 ,
      0 },

    { { sizeof("fastcgi_ignore_headers") - 1, (u_char *) "fastcgi_ignore_headers" },
      0x02000000|0x04000000|0x08000000|0x00000800,
      ngx_conf_set_bitmask_slot,
      
# 548 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 548 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 549 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 549 "src/http/modules/ngx_http_fastcgi_module.c"
                                                                   ,
      &ngx_http_upstream_ignore_headers_masks },

    { { sizeof("fastcgi_catch_stderr") - 1, (u_char *) "fastcgi_catch_stderr" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_str_array_slot,
      
# 555 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 555 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 556 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 556 "src/http/modules/ngx_http_fastcgi_module.c"
                                                        ,
      0 },

    { { sizeof("fastcgi_keep_conn") - 1, (u_char *) "fastcgi_keep_conn" },
      0x02000000|0x04000000|0x08000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 562 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 562 "src/http/modules/ngx_http_fastcgi_module.c"
                             ,
      
# 563 "src/http/modules/ngx_http_fastcgi_module.c" 3 4
     0
# 563 "src/http/modules/ngx_http_fastcgi_module.c"
                                                     ,
      0 },
...
static ngx_http_variable_t ngx_http_fastcgi_vars[] = {
    ...
    { { sizeof("fastcgi_script_name") - 1, (u_char *) "fastcgi_script_name" }, 0,
      ngx_http_fastcgi_script_name_variable, 0,
      2|8, 0 },

    { { sizeof("fastcgi_path_info") - 1, (u_char *) "fastcgi_path_info" }, 0,
...
static ngx_keyval_t ngx_http_fastcgi_cache_headers[] = {
    { { sizeof("HTTP_IF_MODIFIED_SINCE") - 1, (u_char *) "HTTP_IF_MODIFIED_SINCE" },
      { sizeof("$upstream_cache_last_modified") - 1, (u_char *) "$upstream_cache_last_modified" } },
    { { sizeof("HTTP_IF_UNMODIFIED_SINCE") - 1, (u_char *) "HTTP_IF_UNMODIFIED_SINCE" }, { sizeof("") - 1, (u_char *) "" } },
    { { sizeof("HTTP_IF_NONE_MATCH") - 1, (u_char *) "HTTP_IF_NONE_MATCH" }, { sizeof("$upstream_cache_etag") - 1, (u_char *) "$upstream_cache_etag" } },
    { { sizeof("HTTP_IF_MATCH") - 1, (u_char *) "HTTP_IF_MATCH" }, { sizeof("") - 1, (u_char *) "" } },
    { { sizeof("HTTP_RANGE") - 1, (u_char *) "HTTP_RANGE" }, { sizeof("") - 1, (u_char *) "" } },
    { { sizeof("HTTP_IF_RANGE") - 1, (u_char *) "HTTP_IF_RANGE" }, { sizeof("") - 1, (u_char *) "" } },
    { { 0, 0 }, { 0, 0 } }
};
...
static ngx_path_init_t ngx_http_fastcgi_temp_path = {
    { sizeof("fastcgi_temp") - 1, (u_char *) "fastcgi_temp" }, { 1, 2, 0 }
};
...
ngx_http_fastcgi_handler(ngx_http_request_t *r)
{
    ...
    r->ctx[ngx_http_fastcgi_module.ctx_index] = f;;

    flcf = (r)->loc_conf[ngx_http_fastcgi_module.ctx_index];

    if (flcf->fastcgi_lengths) {
        if (ngx_http_fastcgi_eval(r, flcf) != 0) {
            return 500;
        }
    }
    ...
    (&u->schema)->len = sizeof("fastcgi://") - 1; (&u->schema)->data = (u_char *) "fastcgi://";
    u->output.tag = (ngx_buf_tag_t) &ngx_http_fastcgi_module;

    u->conf = &flcf->upstream;


    fmcf = (r)->main_conf[ngx_http_fastcgi_module.ctx_index];
...
ngx_http_fastcgi_create_key(ngx_http_request_t *r)
{
    ...
    if (ngx_http_complex_value(r, &flcf->cache_key, key) != 0) {
        return -1;
    }
...
ngx_http_fastcgi_create_request(ngx_http_request_t *r)
{
    ...
    if (len > 65535) {
        if ((r->connection->log)->log_level >= 2) ngx_log_error_core(2, r->connection->log, 0, "fastcgi request record is too big: %uz", len)
                                                                    ;
        return -1;
    }
    ...
    (void) memcpy(b->pos, &ngx_http_fastcgi_request_start, sizeof(ngx_http_fastcgi_request_start_t))
                                                        ;
    ...
    if (flcf->upstream.pass_request_headers) {
        ...
        for (i = 0; ; i++) {
            ...
            b->last = (((u_char *) memcpy(b->last, "HTTP_", sizeof("HTTP_") - 1)) + (sizeof("HTTP_") - 1));
            ...
            b->last = (((u_char *) memcpy(b->last, header[i].value.data, val_len)) + (val_len));
    ...
    if (r->request_body_no_buffering) {
        ...
        while (body) {
            ...
            if (((body->buf->flush || body->buf->last_buf || body->buf->sync) && !(body->buf->temporary || body->buf->memory || body->buf->mmap) && !body->buf->in_file)) {
                body = body->next;
                continue;
            }
...
ngx_http_fastcgi_reinit_request(ngx_http_request_t *r)
{
    ...
    f = (r)->ctx[ngx_http_fastcgi_module.ctx_index];
...
ngx_http_fastcgi_body_output_filter(void *data, ngx_chain_t *in)
{
    ...
    *ll = cl;
    ...
    while (in) {
        ...
        if (((in->buf->flush || in->buf->last_buf || in->buf->sync) && !(in->buf->temporary || in->buf->memory || in->buf->mmap) && !in->buf->in_file)) {
            in = in->next;
            continue;
        }
        ...
        do {
            ...
            (void) memcpy(b, in->buf, sizeof(ngx_buf_t));
...
out:
# 1603 "src/http/modules/ngx_http_fastcgi_module.c"
    ...
    for ( ;; ) {
        ...
        if (f->state < ngx_http_fastcgi_st_data) {
            ...
            if (f->type != 6
                && f->type != 7)
            {
                if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "upstream sent unexpected FastCGI record: %ui", f->type)
            ...
            if (f->type == 6 && f->length == 0) {
                if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "upstream prematurely closed FastCGI stdout")
                                                                           ;
        ...
        if (f->type == 7) {
            ...
            if (f->length) {
                ...
                if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "FastCGI sent in stderr: \"%*s\"", p - msg, msg)
                                                                              ;
...
# 1808 "src/http/modules/ngx_http_fastcgi_module.c"
            if (len >= 0) {
        ...
        for ( ;; ) {
            ...
            if (rc == 0) {
                ...
                if (f->split_parts && f->split_parts->nelts) {
                    ...
                    for (i = 0; i < f->split_parts->nelts; i++) {
                        p = (((u_char *) memcpy(p, part[i].start, part[i].end - part[i].start)) + (part[i].end - part[i].start))
                                                                   ;
                    }

                    p = (((u_char *) memcpy(p, part_start, u->buffer.pos - part_start)) + (u->buffer.pos - part_start));
                    ...
                    if (rc != 0) {
                        if ((r->connection->log)->log_level >= 2) ngx_log_error_core(2, r->connection->log, 0, "invalid header after joining " "FastCGI records")
            ...
            if (rc == 1) {
                ...
                if (u->headers_in.status) {
                    ...
                    if (status == -1) {
                        if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "upstream sent invalid status \"%V\"", status_line)
                    ...
                    (&u->headers_in.status_line)->len = sizeof("302 Moved Temporarily") - 1; (&u->headers_in.status_line)->data = (u_char *) "302 Moved Temporarily"
                                                        ;

                } else {
                    u->headers_in.status_n = 200;
                    (&u->headers_in.status_line)->len = sizeof("200 OK") - 1; (&u->headers_in.status_line)->data = (u_char *) "200 OK";
                }
    ...
    for ( ;; ) {
        ...
        if (f->type == 7) {
            ...
            if (f->length) {
                ...
                if ((p->log)->log_level >= 4) ngx_log_error_core(4, p->log, 0, "FastCGI sent in stderr: \"%*s\"", m + 1 - msg, msg)
    ...
    for ( ;; ) {
        ...
        if (f->type == 7) {
            ...
            if (f->length) {
                ...
                if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "FastCGI sent in stderr: \"%*s\"", m + 1 - msg, msg)
    ...
    ngx_http_fastcgi_ctx_t *f)
{
    ...
    for (p = f->pos; p < f->last; p++) {
        ...
        case ngx_http_fastcgi_st_version:
            if (ch != 1) {
                if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "upstream sent unsupported FastCGI " "protocol version: %d", ch)
        ...
        case ngx_http_fastcgi_st_type:
            ...
            case 3:
                ...
                break;
            default:
                if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "upstream sent invalid FastCGI " "record type: %d", ch)
        ...
        case ngx_http_fastcgi_st_request_id_hi:
            if (ch != 0) {
                if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "upstream sent unexpected FastCGI " "request id high byte: %d", ch)
        ...
        case ngx_http_fastcgi_st_request_id_lo:
            if (ch != 1) {
                if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "upstream sent unexpected FastCGI " "request id low byte: %d", ch)
...
# 2715 "src/http/modules/ngx_http_fastcgi_module.c"
    ...
    conf->catch_stderr = (void *) -1;

    conf->keep_conn = -1;

    (&conf->upstream.module)->len = sizeof("fastcgi") - 1; (&conf->upstream.module)->data = (u_char *) "fastcgi";
...
ngx_http_fastcgi_merge_loc_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    if (conf->upstream.local == (void *) -1) { conf->upstream.local = (prev->upstream.local == (void *) -1) ? 0 : prev->upstream.local; }
                                                         ;
    ...
    if (conf->upstream.cache_zone && conf->upstream.cache_zone->data == 0) {
        ngx_shm_zone_t *shm_zone;
    ...
    if (conf->upstream.cache_bypass == (void *) -1) { conf->upstream.cache_bypass = (prev->upstream.cache_bypass == (void *) -1) ? 0 : prev->upstream.cache_bypass; }
                                                               ;

    if (conf->upstream.no_cache == (void *) -1) { conf->upstream.no_cache = (prev->upstream.no_cache == (void *) -1) ? 0 : prev->upstream.no_cache; }
                                                           ;

    if (conf->upstream.cache_valid == (void *) -1) { conf->upstream.cache_valid = (prev->upstream.cache_valid == (void *) -1) ? 0 : prev->upstream.cache_valid; }
                                                              ;

    if (conf->cache_key.value.data == 0) {
        conf->cache_key = prev->cache_key;
    }

    if (conf->upstream.cache && conf->cache_key.value.data == 0) {
    ...
    if (conf->catch_stderr == (void *) -1) { conf->catch_stderr = (prev->catch_stderr == (void *) -1) ? 0 : prev->catch_stderr; };

    if (conf->keep_conn == -1) { conf->keep_conn = (prev->keep_conn == -1) ? 0 : prev->keep_conn; };


    if (conf->index.data == 0) { if (prev->index.data) { conf->index.len = prev->index.len; conf->index.data = prev->index.data; } else { conf->index.len = sizeof("") - 1; conf->index.data = (u_char *) ""; } };
    ...
    if (clcf->noname
        && conf->upstream.upstream == 0 && conf->fastcgi_lengths == 0)
    {
    ...
    if (clcf->lmt_excpt && clcf->handler == 0
        && (conf->upstream.upstream || conf->fastcgi_lengths))
    {
        clcf->handler = ngx_http_fastcgi_handler;
    }
# 3099 "src/http/modules/ngx_http_fastcgi_module.c"
    if (conf->params_source == 0) {
    ...
    rc = ngx_http_fastcgi_init_params(cf, conf, &conf->params, 0);
    if (rc != 0) {
        return (void *) -1;
    }
...
# 3129 "src/http/modules/ngx_http_fastcgi_module.c"
    if (prev->params.hash.buckets == 0
        && conf->params_source == prev->params_source)
    {
    ...
    ngx_http_fastcgi_params_t *params, ngx_keyval_t *default_params)
{
    ...
    if (conf->params_source == 0 && default_params == 0) {
    ...
    for (i = 0; i < nsrc; i++) {
        ...
        if (src[i].key.len > sizeof("HTTP_") - 1
            && strncmp((const char *) src[i].key.data, (const char *) "HTTP_", sizeof("HTTP_") - 1) == 0)
        {
    ...
    ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    p = (((u_char *) memcpy(v->data, f->script_name.data, f->script_name.len)) + (f->script_name.len));
    (void) memcpy(p, flcf->index.data, flcf->index.len);
...
{
    ngx_http_fastcgi_ctx_t *f;
# 3466 "src/http/modules/ngx_http_fastcgi_module.c"
    f = (r)->ctx[ngx_http_fastcgi_module.ctx_index];
...
{
# 3585 "src/http/modules/ngx_http_fastcgi_module.c"
    ngx_conf_log_error(1, cf, 0,
...
ngx_http_fastcgi_cache(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (cv.lengths != 0) {
        ...
        if (flcf->upstream.cache_value == 0) {
            return (void *) -1;
        }
...
{
# 3752 "src/http/modules/ngx_http_fastcgi_module.c"
    ssize_t *np = data;
