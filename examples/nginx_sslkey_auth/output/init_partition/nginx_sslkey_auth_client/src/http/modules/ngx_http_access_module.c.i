# 1 "src/http/modules/ngx_http_access_module.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 9 "src/http/modules/ngx_http_access_module.c" 2
...
# 10 "src/http/modules/ngx_http_access_module.c" 2
...
# 11 "src/http/modules/ngx_http_access_module.c" 2
...
static ngx_command_t ngx_http_access_commands[] = {
    ...
    { { sizeof("allow") - 1, (u_char *) "allow" },
      0x02000000|0x04000000|0x08000000|0x80000000
                        |0x00000002,
      ngx_http_access_rule,
      
# 74 "src/http/modules/ngx_http_access_module.c" 3 4
     0
# 74 "src/http/modules/ngx_http_access_module.c"
                             ,
      0,
      0 },

    { { sizeof("deny") - 1, (u_char *) "deny" },
      0x02000000|0x04000000|0x08000000|0x80000000
                        |0x00000002,
      ngx_http_access_rule,
      
# 82 "src/http/modules/ngx_http_access_module.c" 3 4
     0
# 82 "src/http/modules/ngx_http_access_module.c"
                             ,
      0,
      0 },
...
ngx_http_access_handler(ngx_http_request_t *r)
{
    ...
    alcf = (r)->loc_conf[ngx_http_access_module.ctx_index];
...
# 234 "src/http/modules/ngx_http_access_module.c"
        for (n = 0; n < 16; n++) {
...
ngx_http_access_rule(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    all = 0;
    (void) memset(&cidr, 0, sizeof(ngx_cidr_t));

    value = cf->args->elts;

    if (value[1].len == 3 && strcmp((const char *) value[1].data, (const char *) "all") == 0) {
        all = 1;


    } else if (value[1].len == 5 && strcmp((const char *) value[1].data, (const char *) "unix:") == 0) {
        cidr.family = AF_UNIX;
