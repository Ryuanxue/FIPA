# 1 "src/http/modules/ngx_http_rewrite_module.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 9 "src/http/modules/ngx_http_rewrite_module.c" 2
...
# 10 "src/http/modules/ngx_http_rewrite_module.c" 2
...
# 11 "src/http/modules/ngx_http_rewrite_module.c" 2
# 1 "src/core/ngx_regex.h" 1
# 15 "src/core/ngx_regex.h"
# 1 "/usr/include/pcre.h" 1 3 4
# 90 "/usr/include/pcre.h" 3 4
# 1 "/home/raoxue/Desktop/IF-driver-partition/FIPA/scripts/fake_libc_include/stdlib.h" 1 3 4
# 1 "/home/raoxue/Desktop/IF-driver-partition/FIPA/scripts/fake_libc_include/_fake_defines.h" 1 3 4
# 2 "/home/raoxue/Desktop/IF-driver-partition/FIPA/scripts/fake_libc_include/stdlib.h" 2 3 4
# 1 "/home/raoxue/Desktop/IF-driver-partition/FIPA/scripts/fake_libc_include/_fake_typedefs.h" 1 3 4
# 307 "/home/raoxue/Desktop/IF-driver-partition/FIPA/scripts/fake_libc_include/_fake_typedefs.h" 3 4
...
# 12 "src/http/modules/ngx_http_rewrite_module.c" 2
...
static ngx_command_t ngx_http_rewrite_commands[] = {
    ...
    { { sizeof("rewrite") - 1, (u_char *) "rewrite" },
      0x04000000|0x20000000|0x08000000|0x40000000
                       |(0x00000004|0x00000008),
      ngx_http_rewrite,
      
# 50 "src/http/modules/ngx_http_rewrite_module.c" 3 4
     0
# 50 "src/http/modules/ngx_http_rewrite_module.c"
                             ,
      0,
      0 },

    { { sizeof("return") - 1, (u_char *) "return" },
      0x04000000|0x20000000|0x08000000|0x40000000
                       |(0x00000002|0x00000004),
      ngx_http_rewrite_return,
      
# 58 "src/http/modules/ngx_http_rewrite_module.c" 3 4
     0
# 58 "src/http/modules/ngx_http_rewrite_module.c"
                             ,
      0,
      0 },

    { { sizeof("break") - 1, (u_char *) "break" },
      0x04000000|0x20000000|0x08000000|0x40000000
                       |0x00000001,
      ngx_http_rewrite_break,
      
# 66 "src/http/modules/ngx_http_rewrite_module.c" 3 4
     0
# 66 "src/http/modules/ngx_http_rewrite_module.c"
                             ,
      0,
      0 },

    { { sizeof("if") - 1, (u_char *) "if" },
      0x04000000|0x08000000|0x00000100|0x00000800,
      ngx_http_rewrite_if,
      
# 73 "src/http/modules/ngx_http_rewrite_module.c" 3 4
     0
# 73 "src/http/modules/ngx_http_rewrite_module.c"
                             ,
      0,
      0 },

    { { sizeof("set") - 1, (u_char *) "set" },
      0x04000000|0x20000000|0x08000000|0x40000000
                       |0x00000004,
      ngx_http_rewrite_set,
      
# 81 "src/http/modules/ngx_http_rewrite_module.c" 3 4
     0
# 81 "src/http/modules/ngx_http_rewrite_module.c"
                             ,
      0,
      0 },

    { { sizeof("rewrite_log") - 1, (u_char *) "rewrite_log" },
      0x02000000|0x04000000|0x20000000|0x08000000
                        |0x40000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 89 "src/http/modules/ngx_http_rewrite_module.c" 3 4
     0
# 89 "src/http/modules/ngx_http_rewrite_module.c"
                             ,
      
# 90 "src/http/modules/ngx_http_rewrite_module.c" 3 4
     0
# 90 "src/http/modules/ngx_http_rewrite_module.c"
                                               ,
      0 },

    { { sizeof("uninitialized_variable_warn") - 1, (u_char *) "uninitialized_variable_warn" },
      0x02000000|0x04000000|0x20000000|0x08000000
                        |0x40000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 97 "src/http/modules/ngx_http_rewrite_module.c" 3 4
     0
# 97 "src/http/modules/ngx_http_rewrite_module.c"
                             ,
      
# 98 "src/http/modules/ngx_http_rewrite_module.c" 3 4
     0
# 98 "src/http/modules/ngx_http_rewrite_module.c"
                                                                       ,
      0 },
    ...
    uintptr_t data)
{
    ...
    if ((r->connection->log)->log_level >= 5) ngx_log_error_core(5, r->connection->log, 0, "using uninitialized \"%V\" variable", &var[data].name)
                                                                         ;
...
ngx_http_rewrite_create_loc_conf(ngx_conf_t *cf)
{
    ...
    conf->log = -1;
    conf->uninitialized_variable_warn = -1;
...
ngx_http_rewrite_merge_loc_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    if (conf->log == -1) { conf->log = (prev->log == -1) ? 0 : prev->log; };
    if (conf->uninitialized_variable_warn == -1) { conf->uninitialized_variable_warn = (prev->uninitialized_variable_warn == -1) ? 1 : prev->uninitialized_variable_warn; }
                                                              ;
    if (conf->stack_size == (ngx_uint_t) -1) { conf->stack_size = (prev->stack_size == (ngx_uint_t) -1) ? 10 : prev->stack_size; };
...
ngx_http_rewrite(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    (void) memset(regex, 0, sizeof(ngx_http_script_regex_code_t));
    ...
    if (strncmp((const char *) value[2].data, (const char *) "http://", sizeof("http://") - 1) == 0
        || strncmp((const char *) value[2].data, (const char *) "https://", sizeof("https://") - 1) == 0
        || strncmp((const char *) value[2].data, (const char *) "$scheme", sizeof("$scheme") - 1) == 0)
    {
        regex->status = 302;
        regex->redirect = 1;
        last = 1;
    ...
    if (cf->args->nelts == 4) {
        if (strcmp((const char *) value[3].data, (const char *) "last") == 0) {
            last = 1;

        } else if (strcmp((const char *) value[3].data, (const char *) "break") == 0) {
            regex->break_cycle = 1;
            last = 1;

        } else if (strcmp((const char *) value[3].data, (const char *) "redirect") == 0) {
            regex->status = 302;
            regex->redirect = 1;
            last = 1;

        } else if (strcmp((const char *) value[3].data, (const char *) "permanent") == 0) {
            regex->status = 301;
            regex->redirect = 1;
            last = 1;
...
ngx_http_rewrite_return(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    (void) memset(ret, 0, sizeof(ngx_http_script_return_code_t));
    ...
    if (ret->status == (uintptr_t) -1) {

        if (cf->args->nelts == 2
            && (strncmp((const char *) p, (const char *) "http://", sizeof("http://") - 1) == 0
                || strncmp((const char *) p, (const char *) "https://", sizeof("https://") - 1) == 0
                || strncmp((const char *) p, (const char *) "$scheme", sizeof("$scheme") - 1) == 0))
        {
            ret->status = 302;
            v = &value[1];
...
ngx_http_rewrite_if(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (ngx_http_rewrite_if_condition(cf, lcf) != 0) {
        return (void *) -1;
    }
...
ngx_http_rewrite_if_condition(ngx_conf_t *cf, ngx_http_rewrite_loc_conf_t *lcf)
{
    ...
    if (len > 1 && p[0] == '$') {
        ...
        if (ngx_http_rewrite_variable(cf, lcf, &value[cur]) != 0) {
            return (void *) -1;
        }
        ...
        if (len == 1 && p[0] == '=') {
            ...
            if (ngx_http_rewrite_value(cf, lcf, &value[last]) != 0) {
                return (void *) -1;
            }
            ...
            || (len == 3 && p[0] == '!' && p[1] == '~' && p[2] == '*'))
        {
            ...
            rc.options = (p[len - 1] == '*') ? 
# 759 "src/http/modules/ngx_http_rewrite_module.c" 3 4
                                              0x00000001 
# 759 "src/http/modules/ngx_http_rewrite_module.c"
                                                                 : 0;
            rc.err.len = 1024;
            rc.err.data = errstr;
...
ngx_http_rewrite_set(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (ngx_http_rewrite_value(cf, lcf, &value[2]) != 0) {
        return (void *) -1;
    }
