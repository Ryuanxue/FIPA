# 1 "src/http/modules/ngx_http_memcached_module.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 9 "src/http/modules/ngx_http_memcached_module.c" 2
...
# 10 "src/http/modules/ngx_http_memcached_module.c" 2
...
# 11 "src/http/modules/ngx_http_memcached_module.c" 2
...
static ngx_conf_bitmask_t ngx_http_memcached_next_upstream_masks[] = {
    ...
    { { sizeof("invalid_response") - 1, (u_char *) "invalid_response" }, 0x00000008 },
    { { sizeof("not_found") - 1, (u_char *) "not_found" }, 0x00000200 },
...
static ngx_command_t ngx_http_memcached_commands[] = {
    ...
    { { sizeof("memcached_pass") - 1, (u_char *) "memcached_pass" },
      0x08000000|0x40000000|0x00000002,
      ngx_http_memcached_pass,
      
# 59 "src/http/modules/ngx_http_memcached_module.c" 3 4
     0
# 59 "src/http/modules/ngx_http_memcached_module.c"
                             ,
      0,
      0 },

    { { sizeof("memcached_bind") - 1, (u_char *) "memcached_bind" },
      0x02000000|0x04000000|0x08000000|(0x00000002|0x00000004),
      ngx_http_upstream_bind_set_slot,
      
# 66 "src/http/modules/ngx_http_memcached_module.c" 3 4
     0
# 66 "src/http/modules/ngx_http_memcached_module.c"
                             ,
      
# 67 "src/http/modules/ngx_http_memcached_module.c" 3 4
     0
# 67 "src/http/modules/ngx_http_memcached_module.c"
                                                            ,
      0 },

    { { sizeof("memcached_connect_timeout") - 1, (u_char *) "memcached_connect_timeout" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_msec_slot,
      
# 73 "src/http/modules/ngx_http_memcached_module.c" 3 4
     0
# 73 "src/http/modules/ngx_http_memcached_module.c"
                             ,
      
# 74 "src/http/modules/ngx_http_memcached_module.c" 3 4
     0
# 74 "src/http/modules/ngx_http_memcached_module.c"
                                                                      ,
      0 },

    { { sizeof("memcached_send_timeout") - 1, (u_char *) "memcached_send_timeout" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_msec_slot,
      
# 80 "src/http/modules/ngx_http_memcached_module.c" 3 4
     0
# 80 "src/http/modules/ngx_http_memcached_module.c"
                             ,
      
# 81 "src/http/modules/ngx_http_memcached_module.c" 3 4
     0
# 81 "src/http/modules/ngx_http_memcached_module.c"
                                                                   ,
      0 },

    { { sizeof("memcached_buffer_size") - 1, (u_char *) "memcached_buffer_size" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_size_slot,
      
# 87 "src/http/modules/ngx_http_memcached_module.c" 3 4
     0
# 87 "src/http/modules/ngx_http_memcached_module.c"
                             ,
      
# 88 "src/http/modules/ngx_http_memcached_module.c" 3 4
     0
# 88 "src/http/modules/ngx_http_memcached_module.c"
                                                                  ,
      0 },

    { { sizeof("memcached_read_timeout") - 1, (u_char *) "memcached_read_timeout" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_msec_slot,
      
# 94 "src/http/modules/ngx_http_memcached_module.c" 3 4
     0
# 94 "src/http/modules/ngx_http_memcached_module.c"
                             ,
      
# 95 "src/http/modules/ngx_http_memcached_module.c" 3 4
     0
# 95 "src/http/modules/ngx_http_memcached_module.c"
                                                                   ,
      0 },

    { { sizeof("memcached_next_upstream") - 1, (u_char *) "memcached_next_upstream" },
      0x02000000|0x04000000|0x08000000|0x00000800,
      ngx_conf_set_bitmask_slot,
      
# 101 "src/http/modules/ngx_http_memcached_module.c" 3 4
     0
# 101 "src/http/modules/ngx_http_memcached_module.c"
                             ,
      
# 102 "src/http/modules/ngx_http_memcached_module.c" 3 4
     0
# 102 "src/http/modules/ngx_http_memcached_module.c"
                                                                    ,
      &ngx_http_memcached_next_upstream_masks },

    { { sizeof("memcached_next_upstream_tries") - 1, (u_char *) "memcached_next_upstream_tries" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_num_slot,
      
# 108 "src/http/modules/ngx_http_memcached_module.c" 3 4
     0
# 108 "src/http/modules/ngx_http_memcached_module.c"
                             ,
      
# 109 "src/http/modules/ngx_http_memcached_module.c" 3 4
     0
# 109 "src/http/modules/ngx_http_memcached_module.c"
                                                                          ,
      0 },

    { { sizeof("memcached_next_upstream_timeout") - 1, (u_char *) "memcached_next_upstream_timeout" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_msec_slot,
      
# 115 "src/http/modules/ngx_http_memcached_module.c" 3 4
     0
# 115 "src/http/modules/ngx_http_memcached_module.c"
                             ,
      
# 116 "src/http/modules/ngx_http_memcached_module.c" 3 4
     0
# 116 "src/http/modules/ngx_http_memcached_module.c"
                                                                            ,
      0 },

    { { sizeof("memcached_gzip_flag") - 1, (u_char *) "memcached_gzip_flag" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_num_slot,
      
# 122 "src/http/modules/ngx_http_memcached_module.c" 3 4
     0
# 122 "src/http/modules/ngx_http_memcached_module.c"
                             ,
      
# 123 "src/http/modules/ngx_http_memcached_module.c" 3 4
     0
# 123 "src/http/modules/ngx_http_memcached_module.c"
                                                       ,
      0 },
...
static ngx_str_t ngx_http_memcached_key = { sizeof("memcached_key") - 1, (u_char *) "memcached_key" };
...
ngx_http_memcached_handler(ngx_http_request_t *r)
{
    ...
    (&u->schema)->len = sizeof("memcached://") - 1; (&u->schema)->data = (u_char *) "memcached://";
    u->output.tag = (ngx_buf_tag_t) &ngx_http_memcached_module;

    mlcf = (r)->loc_conf[ngx_http_memcached_module.ctx_index];
    ...
    r->ctx[ngx_http_memcached_module.ctx_index] = ctx;;
...
ngx_http_memcached_create_request(ngx_http_request_t *r)
{
    ...
    if (vv == 0 || vv->not_found || vv->len == 0) {
        if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "the \"$memcached_key\" variable is not set")
                                                                   ;
        return -1;
    }

    escape = 2 * ngx_escape_uri(0, vv->data, vv->len, 5);
    ...
    *b->last++ = 'g'; *b->last++ = 'e'; *b->last++ = 't'; *b->last++ = ' ';
    ...
    ctx = (r)->ctx[ngx_http_memcached_module.ctx_index];

    ctx->key.data = b->last;

    if (escape == 0) {
        b->last = (((u_char *) memcpy(b->last, vv->data, vv->len)) + (vv->len));
...
found:
    ...
    *p = '\0';
    ...
    if (strncmp((const char *) p, (const char *) "VALUE ", sizeof("VALUE ") - 1) == 0) {

        p += sizeof("VALUE ") - 1;

        if (strncmp((const char *) p, (const char *) ctx->key.data, ctx->key.len) != 0) {
            if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "memcached sent invalid key in response \"%V\" " "for key \"%V\"", &line, &ctx->key)
    ...
    flags:
        ...
        if (flags == (ngx_uint_t) -1) {
            if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "memcached sent invalid flags in response \"%V\" " "for key \"%V\"", &line, &ctx->key)
        ...
        if (flags & mlcf->gzip_flag) {
            ...
            h->hash = 1;
            (&h->key)->len = sizeof("Content-Encoding") - 1; (&h->key)->data = (u_char *) "Content-Encoding";
            (&h->value)->len = sizeof("gzip") - 1; (&h->value)->data = (u_char *) "gzip";
    ...
    length:
        ...
        if (u->headers_in.content_length_n == -1) {
            if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "memcached sent invalid length in response \"%V\" " "for key \"%V\"", &line, &ctx->key)
    ...
    if (strcmp((const char *) p, (const char *) "END\x0d") == 0) {
        if ((r->connection->log)->log_level >= 7) ngx_log_error_core(7, r->connection->log, 0, "key: \"%V\" was not found by memcached", &ctx->key)
                                                                          ;
...
no_valid:
    ...
    if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "memcached sent invalid response: \"%V\"", &line)
                                                                   ;
...
ngx_http_memcached_filter(void *data, ssize_t bytes)
{
    ...
    if (u->length == (ssize_t) ctx->rest) {
        ...
        if (strncmp((const char *) b->last, (const char *) ngx_http_memcached_end + (sizeof(ngx_http_memcached_end) - 1) - ctx->rest, bytes)


            != 0)
        {
            if ((ctx->request->connection->log)->log_level >= 4) ngx_log_error_core(4, ctx->request->connection->log, 0, "memcached sent invalid trailer")
                                                           ;
    ...
    *ll = cl;
    ...
    if (strncmp((const char *) last, (const char *) ngx_http_memcached_end, b->last - last) != 0) {
        if ((ctx->request->connection->log)->log_level >= 4) ngx_log_error_core(4, ctx->request->connection->log, 0, "memcached sent invalid trailer")
                                                       ;
...
# 597 "src/http/modules/ngx_http_memcached_module.c"
...
ngx_http_memcached_merge_loc_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    if (conf->gzip_flag == (ngx_uint_t) -1) { conf->gzip_flag = (prev->gzip_flag == (ngx_uint_t) -1) ? 0 : prev->gzip_flag; };
