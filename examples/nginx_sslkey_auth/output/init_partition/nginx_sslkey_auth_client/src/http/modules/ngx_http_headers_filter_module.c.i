# 1 "src/http/modules/ngx_http_headers_filter_module.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 9 "src/http/modules/ngx_http_headers_filter_module.c" 2
...
# 10 "src/http/modules/ngx_http_headers_filter_module.c" 2
...
# 11 "src/http/modules/ngx_http_headers_filter_module.c" 2
...
# 81 "src/http/modules/ngx_http_headers_filter_module.c" 3 4
                0
# 81 "src/http/modules/ngx_http_headers_filter_module.c"
                                                               ,
                 ngx_http_add_multi_header_lines },

    { { sizeof("Link") - 1, (u_char *) "Link" },
                 
# 85 "src/http/modules/ngx_http_headers_filter_module.c" 3 4
                0
# 85 "src/http/modules/ngx_http_headers_filter_module.c"
                                                      ,
                 ngx_http_add_multi_header_lines },

    { { sizeof("Last-Modified") - 1, (u_char *) "Last-Modified" },
                 
# 89 "src/http/modules/ngx_http_headers_filter_module.c" 3 4
                0
# 89 "src/http/modules/ngx_http_headers_filter_module.c"
                                                               ,
                 ngx_http_set_last_modified },

    { { sizeof("ETag") - 1, (u_char *) "ETag" },
                 
# 93 "src/http/modules/ngx_http_headers_filter_module.c" 3 4
                0
# 93 "src/http/modules/ngx_http_headers_filter_module.c"
                                                      ,
...
# 106 "src/http/modules/ngx_http_headers_filter_module.c" 3 4
     0
# 106 "src/http/modules/ngx_http_headers_filter_module.c"
                             ,
      0,
      0 },

    { { sizeof("add_header") - 1, (u_char *) "add_header" },
      0x02000000|0x04000000|0x08000000|0x40000000
                        |(0x00000004|0x00000008),
      ngx_http_headers_add,
      
# 114 "src/http/modules/ngx_http_headers_filter_module.c" 3 4
     0
# 114 "src/http/modules/ngx_http_headers_filter_module.c"
                             ,
      
# 115 "src/http/modules/ngx_http_headers_filter_module.c" 3 4
     0
# 115 "src/http/modules/ngx_http_headers_filter_module.c"
                                               ,
      0 },

    { { sizeof("add_trailer") - 1, (u_char *) "add_trailer" },
      0x02000000|0x04000000|0x08000000|0x40000000
                        |(0x00000004|0x00000008),
      ngx_http_headers_add,
      
# 122 "src/http/modules/ngx_http_headers_filter_module.c" 3 4
     0
# 122 "src/http/modules/ngx_http_headers_filter_module.c"
                             ,
      
# 123 "src/http/modules/ngx_http_headers_filter_module.c" 3 4
     0
# 123 "src/http/modules/ngx_http_headers_filter_module.c"
                                                ,
      0 },
...
ngx_http_set_expires(ngx_http_request_t *r, ngx_http_headers_conf_t *conf)
{
    ...
    if (conf->expires_value != 0) {

        if (ngx_http_complex_value(r, conf->expires_value, &value) != 0) {
            return -1;
        }
    ...
    if (e == 0) {
        ...
        e->hash = 1;
        (&e->key)->len = sizeof("Expires") - 1; (&e->key)->data = (u_char *) "Expires";
    }
    ...
    if (ccp == 0) {
        ...
        cc->hash = 1;
        (&cc->key)->len = sizeof("Cache-Control") - 1; (&cc->key)->data = (u_char *) "Cache-Control";
    ...
    if (expires == NGX_HTTP_EXPIRES_EPOCH) {
        ...
        (&cc->value)->len = sizeof("no-cache") - 1; (&cc->value)->data = (u_char *) "no-cache";
        return 0;
    }
    ...
    if (expires == NGX_HTTP_EXPIRES_MAX) {
        ...
        (&cc->value)->len = sizeof("max-age=315360000") - 1; (&cc->value)->data = (u_char *) "max-age=315360000";
        return 0;
    }
    ...
    if (expires_time == 0 && expires != NGX_HTTP_EXPIRES_DAILY) {
        (void) memcpy(e->value.data, ngx_cached_http_time.data, ngx_cached_http_time.len + 1)
                                                ;
        (&cc->value)->len = sizeof("max-age=0") - 1; (&cc->value)->data = (u_char *) "max-age=0";
        return 0;
    }
    ...
    cc->value.data = ngx_pnalloc(r->pool,
                                 sizeof("max-age=") + (sizeof("-9223372036854775808") - 1) + 1);
    if (cc->value.data == 0) {
        return -1;
    }
    ...
    time_t *expires_time, char **err)
{
    ...
    if (*expires != NGX_HTTP_EXPIRES_MODIFIED) {
        ...
        if (value->len == 5 && strncmp((const char *) value->data, (const char *) "epoch", 5) == 0) {
            *expires = NGX_HTTP_EXPIRES_EPOCH;
            return 0;
        }

        if (value->len == 3 && strncmp((const char *) value->data, (const char *) "max", 3) == 0) {
            *expires = NGX_HTTP_EXPIRES_MAX;
            return 0;
        }

        if (value->len == 3 && strncmp((const char *) value->data, (const char *) "off", 3) == 0) {
...
ngx_http_set_last_modified(ngx_http_request_t *r, ngx_http_header_val_t *hv,
    ngx_str_t *value)
{
    if (ngx_http_set_response_header(r, hv, value) != 0) {
        return -1;
    }
...
# 674 "src/http/modules/ngx_http_headers_filter_module.c"
...
ngx_http_headers_expires(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (cf->args->nelts == 2) {
        ...
        if (strcmp((const char *) value[1].data, (const char *) "modified") != 0) {
...
ngx_http_headers_add(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (value[2].len == 0) {
        (void) memset(&hv->value, 0, sizeof(ngx_http_complex_value_t));
    ...
    if (strcmp((const char *) value[3].data, (const char *) "always") != 0) {
