# 1 "src/http/ngx_http_write_filter_module.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 9 "src/http/ngx_http_write_filter_module.c" 2
...
# 10 "src/http/ngx_http_write_filter_module.c" 2
...
# 11 "src/http/ngx_http_write_filter_module.c" 2
...
ngx_http_write_filter(ngx_http_request_t *r, ngx_chain_t *in)
{
    ...
    for (cl = r->out; cl; cl = cl->next) {
        ...
        if (((cl->buf->temporary || cl->buf->memory || cl->buf->mmap) ? (off_t) (cl->buf->last - cl->buf->pos): (cl->buf->file_last - cl->buf->file_pos)) == 0 && !((cl->buf->flush || cl->buf->last_buf || cl->buf->sync) && !(cl->buf->temporary || cl->buf->memory || cl->buf->mmap) && !cl->buf->in_file)) {
            if ((c->log)->log_level >= 2) ngx_log_error_core(2, c->log, 0, "zero size buf in writer " "t:%d r:%d f:%d %p %p-%p %p %O-%O", cl->buf->temporary, cl->buf->recycled, cl->buf->in_file, cl->buf->start, cl->buf->pos, cl->buf->last, cl->buf->file, cl->buf->file_pos, cl->buf->file_last)
# 96 "src/http/ngx_http_write_filter_module.c"
                                             ;
    ...
    for (ln = in; ln; ln = ln->next) {
        ...
        *ll = cl;
        ...
        if (((cl->buf->temporary || cl->buf->memory || cl->buf->mmap) ? (off_t) (cl->buf->last - cl->buf->pos): (cl->buf->file_last - cl->buf->file_pos)) == 0 && !((cl->buf->flush || cl->buf->last_buf || cl->buf->sync) && !(cl->buf->temporary || cl->buf->memory || cl->buf->mmap) && !cl->buf->in_file)) {
            if ((c->log)->log_level >= 2) ngx_log_error_core(2, c->log, 0, "zero size buf in writer " "t:%d r:%d f:%d %p %p-%p %p %O-%O", cl->buf->temporary, cl->buf->recycled, cl->buf->in_file, cl->buf->start, cl->buf->pos, cl->buf->last, cl->buf->file, cl->buf->file_pos, cl->buf->file_last)
# 152 "src/http/ngx_http_write_filter_module.c"
                                             ;
    ...
    *ll = 0;
        ...
        && !(last && c->need_last_buf))
    {
        ...
        if ((c->log)->log_level >= 2) ngx_log_error_core(2, c->log, 0, "the http output chain is empty")
                                                       ;
    ...
    if (r->limit_rate) {
        ...
        limit = (off_t) r->limit_rate * (ngx_cached_time->sec - r->start_sec + 1)
