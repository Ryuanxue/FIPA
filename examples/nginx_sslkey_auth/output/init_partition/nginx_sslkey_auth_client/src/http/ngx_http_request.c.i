...
ngx_http_header_t ngx_http_headers_in[] = {
    { { sizeof("Host") - 1, (u_char *) "Host" }, 
# 84 "src/http/ngx_http_request.c" 3 4
                         0
...
# 87 "src/http/ngx_http_request.c" 3 4
                               0
# 87 "src/http/ngx_http_request.c"
                                                                          ,
                 ngx_http_process_connection },

    { { sizeof("If-Modified-Since") - 1, (u_char *) "If-Modified-Since" },
                 
# 91 "src/http/ngx_http_request.c" 3 4
                0
# 91 "src/http/ngx_http_request.c"
                                                                  ,
                 ngx_http_process_unique_header_line },

    { { sizeof("If-Unmodified-Since") - 1, (u_char *) "If-Unmodified-Since" },
                 
# 95 "src/http/ngx_http_request.c" 3 4
                0
# 95 "src/http/ngx_http_request.c"
                                                                    ,
                 ngx_http_process_unique_header_line },

    { { sizeof("If-Match") - 1, (u_char *) "If-Match" },
                 
# 99 "src/http/ngx_http_request.c" 3 4
                0
# 99 "src/http/ngx_http_request.c"
                                                         ,
                 ngx_http_process_unique_header_line },

    { { sizeof("If-None-Match") - 1, (u_char *) "If-None-Match" },
                 
# 103 "src/http/ngx_http_request.c" 3 4
                0
# 103 "src/http/ngx_http_request.c"
                                                              ,
                 ngx_http_process_unique_header_line },

    { { sizeof("User-Agent") - 1, (u_char *) "User-Agent" }, 
# 106 "src/http/ngx_http_request.c" 3 4
                               0
# 106 "src/http/ngx_http_request.c"
                                                                          ,
                 ngx_http_process_user_agent },

    { { sizeof("Referer") - 1, (u_char *) "Referer" }, 
# 109 "src/http/ngx_http_request.c" 3 4
                            0
# 109 "src/http/ngx_http_request.c"
                                                                    ,
                 ngx_http_process_header_line },

    { { sizeof("Content-Length") - 1, (u_char *) "Content-Length" },
                 
# 113 "src/http/ngx_http_request.c" 3 4
                0
# 113 "src/http/ngx_http_request.c"
                                                               ,
                 ngx_http_process_unique_header_line },

    { { sizeof("Content-Range") - 1, (u_char *) "Content-Range" },
                 
# 117 "src/http/ngx_http_request.c" 3 4
                0
# 117 "src/http/ngx_http_request.c"
                                                              ,
                 ngx_http_process_unique_header_line },

    { { sizeof("Content-Type") - 1, (u_char *) "Content-Type" },
                 
# 121 "src/http/ngx_http_request.c" 3 4
                0
# 121 "src/http/ngx_http_request.c"
                                                             ,
                 ngx_http_process_header_line },

    { { sizeof("Range") - 1, (u_char *) "Range" }, 
# 124 "src/http/ngx_http_request.c" 3 4
                          0
# 124 "src/http/ngx_http_request.c"
                                                                ,
                 ngx_http_process_header_line },

    { { sizeof("If-Range") - 1, (u_char *) "If-Range" },
                 
# 128 "src/http/ngx_http_request.c" 3 4
                0
# 128 "src/http/ngx_http_request.c"
                                                         ,
                 ngx_http_process_unique_header_line },

    { { sizeof("Transfer-Encoding") - 1, (u_char *) "Transfer-Encoding" },
                 
# 132 "src/http/ngx_http_request.c" 3 4
                0
# 132 "src/http/ngx_http_request.c"
                                                                  ,
                 ngx_http_process_header_line },

    { { sizeof("TE") - 1, (u_char *) "TE" },
                 
# 136 "src/http/ngx_http_request.c" 3 4
                0
# 136 "src/http/ngx_http_request.c"
                                                   ,
                 ngx_http_process_header_line },

    { { sizeof("Expect") - 1, (u_char *) "Expect" },
                 
# 140 "src/http/ngx_http_request.c" 3 4
                0
# 140 "src/http/ngx_http_request.c"
                                                       ,
                 ngx_http_process_unique_header_line },

    { { sizeof("Upgrade") - 1, (u_char *) "Upgrade" },
                 
# 144 "src/http/ngx_http_request.c" 3 4
                0
# 144 "src/http/ngx_http_request.c"
                                                        ,
                 ngx_http_process_header_line },
# 156 "src/http/ngx_http_request.c"
    { { sizeof("Authorization") - 1, (u_char *) "Authorization" },
                 
# 157 "src/http/ngx_http_request.c" 3 4
                0
# 157 "src/http/ngx_http_request.c"
                                                              ,
                 ngx_http_process_unique_header_line },

    { { sizeof("Keep-Alive") - 1, (u_char *) "Keep-Alive" }, 
# 160 "src/http/ngx_http_request.c" 3 4
                               0
# 160 "src/http/ngx_http_request.c"
                                                                          ,
                 ngx_http_process_header_line },
# 198 "src/http/ngx_http_request.c"
    { { sizeof("Cookie") - 1, (u_char *) "Cookie" }, 
# 198 "src/http/ngx_http_request.c" 3 4
                           0
# 198 "src/http/ngx_http_request.c"
                                                                   ,
    ...
    if (port->naddrs > 1) {
        ...
        case AF_INET6:
            ...
            for (i = 0; i < port->naddrs - 1; i++) {
                if (memcmp((const char *) &addr6[i].addr6, (const char *) &sin6->sin6_addr, 16) == 0) {
                    break;
                }
            }
...
# 346 "src/http/ngx_http_request.c"
    ...
    if (rev->ready) {
        ...
        if (ngx_use_accept_mutex) {
            if (!(rev)->posted) { (rev)->posted = 1; (&(rev)->queue)->prev = (&ngx_posted_events)->prev; (&(rev)->queue)->prev->next = &(rev)->queue; (&(rev)->queue)->next = &ngx_posted_events; (&ngx_posted_events)->prev = &(rev)->queue; ; } else { ; };
            return;
        }
...
ngx_http_wait_request_handler(ngx_event_t *rev)
{
    ...
    if (rev->timedout) {
        if ((c->log)->log_level >= 7) ngx_log_error_core(7, c->log, ETIMEDOUT, "client timed out");
        ngx_http_close_connection(c);
        return;
    }
    ...
    hc = c->data;
    cscf = (hc->conf_ctx)->srv_conf[ngx_http_core_module.ctx_index];
    ...
    if (n == 0) {
        if ((c->log)->log_level >= 7) ngx_log_error_core(7, c->log, 0, "client closed connection")
                                                 ;
        ngx_http_close_connection(c);
        return;
    }
...
# 936 "src/http/ngx_http_request.c"
static void
ngx_http_process_request_line(ngx_event_t *rev)
{
    ...
    for ( ;; ) {
        ...
        if (rc == 0) {
            ...
            if (ngx_http_process_request_uri(r) != 0) {
                break;
            }
            ...
            if (r->host_end) {
                ...
                if (ngx_http_set_virtual_server(r, &host) == -1) {
                    break;
                }
        ...
        if (rc != -2) {
            ...
            if (rc == 12) {
                ngx_http_finalize_request(r, 505);
...
ngx_http_process_request_uri(ngx_http_request_t *r)
{
    ...
    if (r->complex_uri || r->quoted_uri) {
        ...
        if (ngx_http_parse_complex_uri(r, cscf->merge_slashes) != 0) {
            r->uri.len = 0;

            if ((r->connection->log)->log_level >= 7) ngx_log_error_core(7, r->connection->log, 0, "client sent invalid request")
                                                        ;
            ngx_http_finalize_request(r, 400);
            return -1;
        }
...
# 1203 "src/http/ngx_http_request.c"
...
ngx_http_process_request_headers(ngx_event_t *rev)
{
    ...
    for ( ;; ) {
        ...
        if ((c->log)->log_level >= 7) ngx_log_error_core(7, c->log, 0, "client sent invalid header line")
                                                        ;
    ...
    if (msie && msie + 7 < user_agent + h->value.len) {
        ...
        if (msie[6] == '.') {
            ...
            case '5':
                ...
                break;
            case '6':
                if (ngx_strstrn(msie + 8, "SV1", 3 - 1) == 0) {
                    r->headers_in.msie6 = 1;
                }
                break;
            }
...
ngx_http_process_request_header(ngx_http_request_t *r)
{
    ...
    if (r->headers_in.host == 0 && r->http_version > 1000) {
    ...
    if (r->headers_in.transfer_encoding) {
                               ...
                               (u_char *) "chunked", 7) == 0)
        {
            ...
            || ngx_strncasecmp(r->headers_in.transfer_encoding->value.data,
                               (u_char *) "identity", 8) != 0)
        {
            if ((r->connection->log)->log_level >= 7) ngx_log_error_core(7, r->connection->log, 0, "client sent unknown \"Transfer-Encoding\": \"%V\"", &r->headers_in.transfer_encoding->value)

                                                                  ;
            ngx_http_finalize_request(r, 501);
            return -1;
        }
    }
...
ngx_http_process_request(ngx_http_request_t *r)
{
    ...
    c = r->connection;
# 1939 "src/http/ngx_http_request.c"
    if (c->read->timer_set) {
        ngx_event_del_timer(c->read);
    }
# 1950 "src/http/ngx_http_request.c"
...
ngx_http_set_virtual_server(ngx_http_request_t *r, ngx_str_t *host)
{
    ...
    hc = r->http_connection;
# 2085 "src/http/ngx_http_request.c"
...
# 2117 "src/http/ngx_http_request.c"
    if (rc == -5) {
        return 0;
    }
...
# 2214 "src/http/ngx_http_request.c"
    return -5;
}
...
ngx_http_finalize_request(ngx_http_request_t *r, ngx_int_t rc)
{
    ...
    if (r != r->main) {
        ...
        if (ngx_http_post_request(pr, 0) != 0) {
            r->main->count++;
            ngx_http_terminate_request(r, 0);
            return;
        }
...
{
    ngx_http_core_loc_conf_t *clcf;
# 2589 "src/http/ngx_http_request.c"
    clcf = (r)->loc_conf[ngx_http_core_module.ctx_index];
...
ngx_http_block_reading(ngx_http_request_t *r)
{
    ...
    {
        if (ngx_event_actions.del(r->connection->read, (EPOLLIN|EPOLLRDHUP), 0) != 0) {
            ngx_http_close_request(r, 0);
        }
    }
}
...
ngx_http_test_reading(ngx_http_request_t *r)
{
    ...
    ;
# 2817 "src/http/ngx_http_request.c"
    ...
    if ((ngx_event_flags & 0x00000001) && rev->active) {
        ...
        if (ngx_event_actions.del(rev, (EPOLLIN|EPOLLRDHUP), 0) != 0) {
            ngx_http_close_request(r, 0);
        }
    }
...
closed:
    ...
    ngx_http_finalize_request(r, 499);
}
...
ngx_http_set_keepalive(ngx_http_request_t *r)
{
    ...
    if (b->pos < b->last) {
        ...
        if (b != c->buffer) {
# 2934 "src/http/ngx_http_request.c"
            for (cl = hc->busy; cl; ) {
                ln = cl;
                cl = cl->next;

                if (ln->buf == b) {
                    ln->next = c->pool->chain; c->pool->chain = ln;
                    continue;
                }
...
# 3015 "src/http/ngx_http_request.c"
    b = c->buffer;
    ...
    if (c->tcp_nopush == NGX_TCP_NOPUSH_SET) {
        if (ngx_tcp_push(c->fd) == -1) {
            ngx_connection_error(c, errno, "setsockopt(!TCP_CORK)" " failed");
            ngx_http_close_connection(c);
            return;
        }
    ...
    if (tcp_nodelay && clcf->tcp_nodelay && ngx_tcp_nodelay(c) != 0) {
        ngx_http_close_connection(c);
        return;
    }
...
# 3149 "src/http/ngx_http_request.c"
    b = c->buffer;
    size = b->end - b->start;
    ...
    if (n == 0) {
        if ((c->log)->log_level >= 7) ngx_log_error_core(7, c->log, errno, "client %V closed keepalive connection", &c->addr_text)
                                                                             ;
        ngx_http_close_connection(c);
        return;
    }
...
ngx_http_post_action(ngx_http_request_t *r)
{
    ...
    if (clcf->post_action.data[0] == '/') {
        ngx_http_internal_redirect(r, &clcf->post_action, 0);
...
# 3465 "src/http/ngx_http_request.c"
...
# 3512 "src/http/ngx_http_request.c"
    ...
    if (r->connection->timedout) {
        ...
        if (clcf->reset_timedout_connection) {
            ...
            {
                if ((log)->log_level >= 2) ngx_log_error_core(2, log, errno, "setsockopt(SO_LINGER) failed")
                                                             ;
            }
        }
    }
...
ngx_http_close_connection(ngx_connection_t *c)
{
    ngx_pool_t *pool;
                                                      ...
                                                      ;
# 3599 "src/http/ngx_http_request.c"
    c->destroyed = 1;
    ...
    u_char *buf, size_t len)
{
    ...
    if (r->request_line.data == 0 && r->request_start) {
