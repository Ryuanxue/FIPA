# 1 "src/os/unix/ngx_writev_chain.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 9 "src/os/unix/ngx_writev_chain.c" 2
...
# 10 "src/os/unix/ngx_writev_chain.c" 2
...
# 11 "src/os/unix/ngx_writev_chain.c" 2
...
# 42 "src/os/unix/ngx_writev_chain.c"
    ...
    for ( ;; ) {
        ...
        if (cl && cl->buf->in_file) {
            if ((c->log)->log_level >= 2) ngx_log_error_core(2, c->log, 0, "file buf in writev " "t:%d r:%d f:%d %p %p-%p %p %O-%O", cl->buf->temporary, cl->buf->recycled, cl->buf->in_file, cl->buf->start, cl->buf->pos, cl->buf->last, cl->buf->file, cl->buf->file_pos, cl->buf->file_last)
# 74 "src/os/unix/ngx_writev_chain.c"
                                             ;
