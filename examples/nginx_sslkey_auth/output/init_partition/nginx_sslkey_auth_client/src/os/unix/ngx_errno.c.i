...
# 10 "src/os/unix/ngx_errno.c" 2
# 28 "src/os/unix/ngx_errno.c"
static ngx_str_t *ngx_sys_errlist;
static ngx_str_t ngx_unknown_error = { sizeof("Unknown error") - 1, (u_char *) "Unknown error" };
...
ngx_strerror(ngx_err_t err, u_char *errstr, size_t size)
{
    ...
    msg = ((ngx_uint_t) err < 135) ? &ngx_sys_errlist[err]:
                                              &ngx_unknown_error;
