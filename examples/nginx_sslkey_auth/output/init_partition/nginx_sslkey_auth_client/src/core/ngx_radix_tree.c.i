...
# 10 "src/core/ngx_radix_tree.c" 2
...
# 62 "src/core/ngx_radix_tree.c"
    ...
    while (preallocate--) {
        ...
        do {
            if (ngx_radix32tree_insert(tree, key, mask, (uintptr_t) -1)
                != 0)
            {
                return 0;
            }
