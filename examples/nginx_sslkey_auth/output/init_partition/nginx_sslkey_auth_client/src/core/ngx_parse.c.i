...
ngx_parse_size(ngx_str_t *line)
{
    ...
    case 'k':
        len--;
        max = 9223372036854775807LL / 1024;
        scale = 1024;
        break;
    ...
    case 'm':
        len--;
        max = 9223372036854775807LL / (1024 * 1024);
        scale = 1024 * 1024;
        break;
...
ngx_parse_offset(ngx_str_t *line)
{
    ...
    case 'g':
        len--;
        max = 9223372036854775807LL / (1024 * 1024 * 1024);
...
ngx_parse_time(ngx_str_t *line, ngx_uint_t is_sec)
{
    ...
    while (p < last) {
        ...
        case 'y':
            ...
            step = st_year;
            max = 9223372036854775807 / (60 * 60 * 24 * 365);
            scale = 60 * 60 * 24 * 365;
            break;
        ...
        case 'M':
            ...
            step = st_month;
            max = 9223372036854775807 / (60 * 60 * 24 * 30);
            scale = 60 * 60 * 24 * 30;
            break;
        ...
        case 'w':
            ...
            step = st_week;
            max = 9223372036854775807 / (60 * 60 * 24 * 7);
            scale = 60 * 60 * 24 * 7;
            break;
        ...
        case 'd':
            ...
            step = st_day;
            max = 9223372036854775807 / (60 * 60 * 24);
            scale = 60 * 60 * 24;
            break;
    ...
    if (!is_sec) {
        if (value > 9223372036854775807 / 1000) {
            return -1;
        }
