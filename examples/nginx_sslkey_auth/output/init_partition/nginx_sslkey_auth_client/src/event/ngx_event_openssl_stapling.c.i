# 1 "src/event/ngx_event_openssl_stapling.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 9 "src/event/ngx_event_openssl_stapling.c" 2
...
# 10 "src/event/ngx_event_openssl_stapling.c" 2
...
# 11 "src/event/ngx_event_openssl_stapling.c" 2
...
# 12 "src/event/ngx_event_openssl_stapling.c" 2
# 1873 "src/event/ngx_event_openssl_stapling.c"
ngx_int_t
ngx_ssl_stapling(ngx_conf_t *cf, ngx_ssl_t *ssl, ngx_str_t *file,
    ngx_str_t *responder, ngx_uint_t verify)
{
    if ((ssl->log)->log_level >= 5) ngx_log_error_core(5, ssl->log, 0, "\"ssl_stapling\" ignored, not supported")
                                                            ;
