# 1 "src/os/unix/ngx_linux_sendfile_chain.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 9 "src/os/unix/ngx_linux_sendfile_chain.c" 2
...
# 10 "src/os/unix/ngx_linux_sendfile_chain.c" 2
...
# 11 "src/os/unix/ngx_linux_sendfile_chain.c" 2


static ssize_t ngx_linux_sendfile(ngx_connection_t *c, ngx_buf_t *file,
    size_t size);
# 46 "src/os/unix/ngx_linux_sendfile_chain.c"
ngx_chain_t *
...
# 218 "src/os/unix/ngx_linux_sendfile_chain.c"
            send = prev_send + sent;
            continue;
        }
...
ngx_linux_sendfile(ngx_connection_t *c, ngx_buf_t *file, size_t size)
{
    ...
    ssize_t n;
    ngx_err_t err;
# 249 "src/os/unix/ngx_linux_sendfile_chain.c"
...
eintr:
    ...
    if (n == 0) {
        ...
        if ((c->log)->log_level >= 2) ngx_log_error_core(2, c->log, 0, "sendfile() reported that \"%s\" was truncated at %O", file->file->name.data, file->file_pos)
