...
void ngx_master_process_cycle_sense_1(ngx_uint_t *n, ngx_uint_t *sigio, sigset_t set, struct itimerval itv, ngx_uint_t *live, ngx_msec_t *delay, ngx_listening_t *ls, ngx_core_conf_t *ccf, ngx_cycle_t *cycle)
{
  for (;;)
  {
    if (*delay)
