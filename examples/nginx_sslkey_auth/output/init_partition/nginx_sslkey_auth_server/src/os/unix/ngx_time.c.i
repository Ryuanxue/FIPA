...
# 10 "src/os/unix/ngx_time.c" 2
# 24 "src/os/unix/ngx_time.c"
void
ngx_timezone_update(void)
{
# 42 "src/os/unix/ngx_time.c"
    time_t s;
    struct tm *t;
    char buf[4];
