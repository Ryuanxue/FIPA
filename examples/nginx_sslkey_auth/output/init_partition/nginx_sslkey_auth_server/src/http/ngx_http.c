...
char *ngx_http_block_sense_1(int *ngx_http_block_sense_1_ret, char *rv, ngx_uint_t *m, ngx_uint_t *s, ngx_conf_t pcf, ngx_http_module_t *module, ngx_http_conf_ctx_t *ctx, ngx_http_core_loc_conf_t *clcf, ngx_http_core_srv_conf_t **cscfp, ngx_http_core_main_conf_t *cmcf, ngx_conf_t *cf)
{
...
char *ngx_http_merge_servers_sense_1(int *ngx_http_merge_servers_sense_1_ret, char *rv, ngx_uint_t *s, ngx_http_conf_ctx_t *ctx, ngx_http_conf_ctx_t saved, ngx_http_core_loc_conf_t *clcf, ngx_http_core_srv_conf_t **cscfp, ngx_conf_t *cf, ngx_http_core_main_conf_t *cmcf, ngx_http_module_t *module, ngx_uint_t ctx_index)
{
  for (*s = 0; (*s) < cmcf->servers.nelts; (*s)++)
  {
  ...
  *ctx = saved;
  ...
  {
    *ngx_http_merge_servers_sense_1_ret = 1;
    return rv;
  }
}
