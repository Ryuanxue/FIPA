# 1 "src/http/ngx_http_variables.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 9 "src/http/ngx_http_variables.c" 2
...
# 10 "src/http/ngx_http_variables.c" 2
...
# 11 "src/http/ngx_http_variables.c" 2
...
static ngx_int_t ngx_http_variable_time_local(ngx_http_request_t *r,
    ngx_http_variable_value_t *v, uintptr_t data);
# 162 "src/http/ngx_http_variables.c"
static ngx_http_variable_t ngx_http_core_variables[] = {

    { { sizeof("http_host") - 1, (u_char *) "http_host" }, 0, ngx_http_variable_header,
      
# 165 "src/http/ngx_http_variables.c" 3 4
     0
# 165 "src/http/ngx_http_variables.c"
                                                  , 0, 0 },

    { { sizeof("http_user_agent") - 1, (u_char *) "http_user_agent" }, 0, ngx_http_variable_header,
      
# 168 "src/http/ngx_http_variables.c" 3 4
     0
# 168 "src/http/ngx_http_variables.c"
                                                        , 0, 0 },

    { { sizeof("http_referer") - 1, (u_char *) "http_referer" }, 0, ngx_http_variable_header,
      
# 171 "src/http/ngx_http_variables.c" 3 4
     0
# 171 "src/http/ngx_http_variables.c"
                                                     , 0, 0 },
# 183 "src/http/ngx_http_variables.c"
    { { sizeof("http_cookie") - 1, (u_char *) "http_cookie" }, 0, ngx_http_variable_cookies,
      
# 184 "src/http/ngx_http_variables.c" 3 4
     0
# 184 "src/http/ngx_http_variables.c"
                                                     , 0, 0 },

    { { sizeof("content_length") - 1, (u_char *) "content_length" }, 0, ngx_http_variable_content_length,
      0, 0, 0 },

    { { sizeof("content_type") - 1, (u_char *) "content_type" }, 0, ngx_http_variable_header,
      
# 190 "src/http/ngx_http_variables.c" 3 4
     0
# 190 "src/http/ngx_http_variables.c"
                                                          , 0, 0 },

    { { sizeof("host") - 1, (u_char *) "host" }, 0, ngx_http_variable_host, 0, 0, 0 },

    { { sizeof("binary_remote_addr") - 1, (u_char *) "binary_remote_addr" }, 0,
      ngx_http_variable_binary_remote_addr, 0, 0, 0 },

    { { sizeof("remote_addr") - 1, (u_char *) "remote_addr" }, 0, ngx_http_variable_remote_addr, 0, 0, 0 },

    { { sizeof("remote_port") - 1, (u_char *) "remote_port" }, 0, ngx_http_variable_remote_port, 0, 0, 0 },

    { { sizeof("proxy_protocol_addr") - 1, (u_char *) "proxy_protocol_addr" }, 0,
      ngx_http_variable_proxy_protocol_addr, 0, 0, 0 },

    { { sizeof("proxy_protocol_port") - 1, (u_char *) "proxy_protocol_port" }, 0,
      ngx_http_variable_proxy_protocol_port, 0, 0, 0 },

    { { sizeof("server_addr") - 1, (u_char *) "server_addr" }, 0, ngx_http_variable_server_addr, 0, 0, 0 },

    { { sizeof("server_port") - 1, (u_char *) "server_port" }, 0, ngx_http_variable_server_port, 0, 0, 0 },

    { { sizeof("server_protocol") - 1, (u_char *) "server_protocol" }, 0, ngx_http_variable_request,
      
# 212 "src/http/ngx_http_variables.c" 3 4
     0
# 212 "src/http/ngx_http_variables.c"
                                                , 0, 0 },

    { { sizeof("scheme") - 1, (u_char *) "scheme" }, 0, ngx_http_variable_scheme, 0, 0, 0 },

    { { sizeof("https") - 1, (u_char *) "https" }, 0, ngx_http_variable_https, 0, 0, 0 },

    { { sizeof("request_uri") - 1, (u_char *) "request_uri" }, 0, ngx_http_variable_request,
      
# 219 "src/http/ngx_http_variables.c" 3 4
     0
# 219 "src/http/ngx_http_variables.c"
                                               , 0, 0 },

    { { sizeof("uri") - 1, (u_char *) "uri" }, 0, ngx_http_variable_request,
      
# 222 "src/http/ngx_http_variables.c" 3 4
     0
# 222 "src/http/ngx_http_variables.c"
                                      ,
      2, 0 },

    { { sizeof("document_uri") - 1, (u_char *) "document_uri" }, 0, ngx_http_variable_request,
      
# 226 "src/http/ngx_http_variables.c" 3 4
     0
# 226 "src/http/ngx_http_variables.c"
                                      ,
      2, 0 },

    { { sizeof("request") - 1, (u_char *) "request" }, 0, ngx_http_variable_request_line, 0, 0, 0 },

    { { sizeof("document_root") - 1, (u_char *) "document_root" }, 0,
      ngx_http_variable_document_root, 0, 2, 0 },

    { { sizeof("realpath_root") - 1, (u_char *) "realpath_root" }, 0,
      ngx_http_variable_realpath_root, 0, 2, 0 },

    { { sizeof("query_string") - 1, (u_char *) "query_string" }, 0, ngx_http_variable_request,
      
# 238 "src/http/ngx_http_variables.c" 3 4
     0
# 238 "src/http/ngx_http_variables.c"
                                       ,
      2, 0 },

    { { sizeof("args") - 1, (u_char *) "args" },
      ngx_http_variable_set_args,
      ngx_http_variable_request,
      
# 244 "src/http/ngx_http_variables.c" 3 4
     0
# 244 "src/http/ngx_http_variables.c"
                                       ,
      1|2, 0 },

    { { sizeof("is_args") - 1, (u_char *) "is_args" }, 0, ngx_http_variable_is_args,
      0, 2, 0 },

    { { sizeof("request_filename") - 1, (u_char *) "request_filename" }, 0,
      ngx_http_variable_request_filename, 0,
      2, 0 },

    { { sizeof("server_name") - 1, (u_char *) "server_name" }, 0, ngx_http_variable_server_name, 0, 0, 0 },

    { { sizeof("request_method") - 1, (u_char *) "request_method" }, 0,
      ngx_http_variable_request_method, 0,
      2, 0 },

    { { sizeof("remote_user") - 1, (u_char *) "remote_user" }, 0, ngx_http_variable_remote_user, 0, 0, 0 },

    { { sizeof("bytes_sent") - 1, (u_char *) "bytes_sent" }, 0, ngx_http_variable_bytes_sent,
      0, 0, 0 },

    { { sizeof("body_bytes_sent") - 1, (u_char *) "body_bytes_sent" }, 0, ngx_http_variable_body_bytes_sent,
      0, 0, 0 },

    { { sizeof("pipe") - 1, (u_char *) "pipe" }, 0, ngx_http_variable_pipe,
      0, 0, 0 },

    { { sizeof("request_completion") - 1, (u_char *) "request_completion" }, 0,
      ngx_http_variable_request_completion,
      0, 0, 0 },

    { { sizeof("request_body") - 1, (u_char *) "request_body" }, 0,
      ngx_http_variable_request_body,
      0, 0, 0 },

    { { sizeof("request_body_file") - 1, (u_char *) "request_body_file" }, 0,
      ngx_http_variable_request_body_file,
      0, 0, 0 },

    { { sizeof("request_length") - 1, (u_char *) "request_length" }, 0, ngx_http_variable_request_length,
      0, 2, 0 },

    { { sizeof("request_time") - 1, (u_char *) "request_time" }, 0, ngx_http_variable_request_time,
      0, 2, 0 },

    { { sizeof("request_id") - 1, (u_char *) "request_id" }, 0,
      ngx_http_variable_request_id,
      0, 0, 0 },

    { { sizeof("status") - 1, (u_char *) "status" }, 0,
      ngx_http_variable_status, 0,
      2, 0 },

    { { sizeof("sent_http_content_type") - 1, (u_char *) "sent_http_content_type" }, 0,
      ngx_http_variable_sent_content_type, 0, 0, 0 },

    { { sizeof("sent_http_content_length") - 1, (u_char *) "sent_http_content_length" }, 0,
      ngx_http_variable_sent_content_length, 0, 0, 0 },

    { { sizeof("sent_http_location") - 1, (u_char *) "sent_http_location" }, 0,
      ngx_http_variable_sent_location, 0, 0, 0 },

    { { sizeof("sent_http_last_modified") - 1, (u_char *) "sent_http_last_modified" }, 0,
      ngx_http_variable_sent_last_modified, 0, 0, 0 },

    { { sizeof("sent_http_connection") - 1, (u_char *) "sent_http_connection" }, 0,
      ngx_http_variable_sent_connection, 0, 0, 0 },

    { { sizeof("sent_http_keep_alive") - 1, (u_char *) "sent_http_keep_alive" }, 0,
      ngx_http_variable_sent_keep_alive, 0, 0, 0 },

    { { sizeof("sent_http_transfer_encoding") - 1, (u_char *) "sent_http_transfer_encoding" }, 0,
      ngx_http_variable_sent_transfer_encoding, 0, 0, 0 },

    { { sizeof("sent_http_cache_control") - 1, (u_char *) "sent_http_cache_control" }, 0, ngx_http_variable_headers,
      
# 319 "src/http/ngx_http_variables.c" 3 4
     0
# 319 "src/http/ngx_http_variables.c"
                                                            , 0, 0 },

    { { sizeof("sent_http_link") - 1, (u_char *) "sent_http_link" }, 0, ngx_http_variable_headers,
      
# 322 "src/http/ngx_http_variables.c" 3 4
     0
# 322 "src/http/ngx_http_variables.c"
                                                   , 0, 0 },

    { { sizeof("limit_rate") - 1, (u_char *) "limit_rate" }, ngx_http_variable_request_set_size,
      ngx_http_variable_request_get_size,
      
# 326 "src/http/ngx_http_variables.c" 3 4
     0
# 326 "src/http/ngx_http_variables.c"
                                             ,
      1|2, 0 },

    { { sizeof("connection") - 1, (u_char *) "connection" }, 0,
      ngx_http_variable_connection, 0, 0, 0 },

    { { sizeof("connection_requests") - 1, (u_char *) "connection_requests" }, 0,
      ngx_http_variable_connection_requests, 0, 0, 0 },

    { { sizeof("nginx_version") - 1, (u_char *) "nginx_version" }, 0, ngx_http_variable_nginx_version,
      0, 0, 0 },

    { { sizeof("hostname") - 1, (u_char *) "hostname" }, 0, ngx_http_variable_hostname,
      0, 0, 0 },

    { { sizeof("pid") - 1, (u_char *) "pid" }, 0, ngx_http_variable_pid,
      0, 0, 0 },

    { { sizeof("msec") - 1, (u_char *) "msec" }, 0, ngx_http_variable_msec,
      0, 2, 0 },

    { { sizeof("time_iso8601") - 1, (u_char *) "time_iso8601" }, 0, ngx_http_variable_time_iso8601,
      0, 2, 0 },

    { { sizeof("time_local") - 1, (u_char *) "time_local" }, 0, ngx_http_variable_time_local,
      0, 2, 0 },


    { { sizeof("tcpinfo_rtt") - 1, (u_char *) "tcpinfo_rtt" }, 0, ngx_http_variable_tcpinfo,
      0, 2, 0 },

    { { sizeof("tcpinfo_rttvar") - 1, (u_char *) "tcpinfo_rttvar" }, 0, ngx_http_variable_tcpinfo,
      1, 2, 0 },

    { { sizeof("tcpinfo_snd_cwnd") - 1, (u_char *) "tcpinfo_snd_cwnd" }, 0, ngx_http_variable_tcpinfo,
      2, 2, 0 },

    { { sizeof("tcpinfo_rcv_space") - 1, (u_char *) "tcpinfo_rcv_space" }, 0, ngx_http_variable_tcpinfo,
      3, 2, 0 },


    { { sizeof("http_") - 1, (u_char *) "http_" }, 0, ngx_http_variable_unknown_header_in,
      0, 32, 0 },

    { { sizeof("sent_http_") - 1, (u_char *) "sent_http_" }, 0, ngx_http_variable_unknown_header_out,
      0, 32, 0 },

    { { sizeof("sent_trailer_") - 1, (u_char *) "sent_trailer_" }, 0, ngx_http_variable_unknown_trailer_out,
      0, 32, 0 },

    { { sizeof("cookie_") - 1, (u_char *) "cookie_" }, 0, ngx_http_variable_cookie,
      0, 32, 0 },

    { { sizeof("arg_") - 1, (u_char *) "arg_" }, 0, ngx_http_variable_argument,
      0, 2|32, 0 },
...
ngx_http_get_indexed_variable(ngx_http_request_t *r, ngx_uint_t index)
{
    ...
    if (cmcf->variables.nelts <= index) {
        if ((r->connection->log)->log_level >= 2) ngx_log_error_core(2, r->connection->log, 0, "unknown variable index: %ui", index)
                                                           ;
        return 0;
    }
    ...
    if (ngx_http_variable_depth == 0) {
        if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "cycle while evaluating variable \"%V\"", &v[index].name)
...
ngx_http_get_variable(ngx_http_request_t *r, ngx_str_t *name, ngx_uint_t key)
{
    ...
    if (v) {
        ...
        if (ngx_http_variable_depth == 0) {
            if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "cycle while evaluating variable \"%V\"", name)
                                                                         ;
            return 0;
        }
        ...
        if (vv && v->get_handler(r, vv, v->data) == 0) {
            ngx_http_variable_depth++;
            return vv;
        }
    ...
    for (i = 0; i < cmcf->prefix_variables.nelts; i++) {
        if (name->len >= v[i].name.len && name->len > len
            && strncmp((const char *) name->data, (const char *) v[i].name.data, v[i].name.len) == 0)
        {
            len = v[i].name.len;
            n = i;
        }
    ...
    if (n != cmcf->prefix_variables.nelts) {
        if (v[n].get_handler(r, vv, (uintptr_t) name) == 0) {
            return vv;
        }
...
# 769 "src/http/ngx_http_variables.c"
static ngx_int_t
    ...
    ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    if (s == -1) {
        if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "invalid size \"%V\"", &val)
                                                  ;
        return;
    }
    ...
    uintptr_t data)
{
    ...
    if (ngx_http_arg(r, arg, len, &value) != 0) {
        v->not_found = 1;
        return 0;
    }
    ...
    uintptr_t data)
{
    ...
    v->data = ngx_pnalloc(r->pool, (sizeof("-2147483648") - 1));
    if (v->data == 0) {
        return -1;
    }
    ...
    ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    if (r->headers_in.content_length) {
        ...
        p = ngx_pnalloc(r->pool, (sizeof("-9223372036854775808") - 1));
        if (p == 0) {
            return -1;
        }
...
{
    ngx_str_t s;
    u_char addr[(sizeof("unix:") - 1 + sizeof(struct sockaddr_un) - 
# 1363 "src/http/ngx_http_variables.c" 3 4
                   0
# 1363 "src/http/ngx_http_variables.c"
                   )];

    s.len = (sizeof("unix:") - 1 + sizeof(struct sockaddr_un) - 
# 1365 "src/http/ngx_http_variables.c" 3 4
           0
# 1365 "src/http/ngx_http_variables.c"
           );
    s.data = addr;

    if (ngx_connection_local_sockaddr(r->connection, &s, 0) != 0) {
        return -1;
    }
    ...
    ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    if (ngx_connection_local_sockaddr(r->connection, 0, 0) != 0) {
        return -1;
    }
...
ngx_http_variable_scheme(ngx_http_request_t *r,
    ngx_http_variable_value_t *v, uintptr_t data)
{
# 1437 "src/http/ngx_http_variables.c"
    v->len = sizeof("http") - 1;
    v->valid = 1;
    v->no_cacheable = 0;
    v->not_found = 0;
...
ngx_http_variable_https(ngx_http_request_t *r,
    ngx_http_variable_value_t *v, uintptr_t data)
{
# 1465 "src/http/ngx_http_variables.c"
    ...
    ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    real = (u_char *) realpath((char *) path.data, (char *) real);

    if (real == 0) {
        if ((r->connection->log)->log_level >= 3) ngx_log_error_core(3, r->connection->log, errno, "realpath()" " \"%s\" failed", path.data)
                                                                 ;
        return -1;
    }

    len = strlen((const char *) real);
    ...
    ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    (&name)->len = sizeof("sent_http_location") - 1; (&name)->data = (u_char *) "sent_http_location";
    ...
    ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    if (r->keepalive) {
        ...
        if (clcf->keepalive_header) {
            ...
            p = ngx_pnalloc(r->pool, sizeof("timeout=") - 1 + (sizeof("-9223372036854775808") - 1));
            if (p == 0) {
                return -1;
            }
...
ngx_http_variable_request_body_file(ngx_http_request_t *r,
    ngx_http_variable_value_t *v, uintptr_t data)
{
    if (r->request_body == 0 || r->request_body->temp_file == 0) {
        v->not_found = 1;
    ...
    ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    p = ngx_pnalloc(r->pool, (sizeof("-9223372036854775808") - 1) + 4);
    if (p == 0) {
        return -1;
    }
    ...
    ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    v->len = 32;
    v->data = id;
# 2180 "src/http/ngx_http_variables.c"
...
ngx_http_variable_nginx_version(ngx_http_request_t *r,
    ngx_http_variable_value_t *v, uintptr_t data)
{
    v->len = sizeof("1.15.5") - 1;
    v->valid = 1;
    v->no_cacheable = 0;
    v->not_found = 0;
    v->data = (u_char *) "1.15.5";
    ...
    ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    (void) memcpy(p, ngx_cached_http_log_iso8601.data, ngx_cached_http_log_iso8601.len)
                                               ;
    ...
    ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    (void) memcpy(p, ngx_cached_http_log_time.data, ngx_cached_http_log_time.len);
...
# 2406 "src/http/ngx_http_variables.c"
    return 0;
}
# 2564 "src/http/ngx_http_variables.c"
ngx_int_t
ngx_http_variables_add_core_vars(ngx_conf_t *cf)
{
    ...
    if (ngx_hash_keys_array_init(cmcf->variables_keys, 1)
        != 0)
    {
        return -1;
    }
    ...
    for (i = 0; i < cmcf->variables.nelts; i++) {
        ...
        for (n = 0; n < cmcf->variables_keys->keys.nelts; n++) {
            ...
            if (v[i].name.len == key[n].key.len
                && strncmp((const char *) v[i].name.data, (const char *) key[n].key.data, v[i].name.len)
                   == 0)
            {
        ...
        for (n = 0; n < cmcf->prefix_variables.nelts; n++) {
            if (v[i].name.len >= pv[n].name.len && v[i].name.len > len
                && strncmp((const char *) v[i].name.data, (const char *) pv[n].name.data, pv[n].name.len)
                   == 0)
            {
                av = &pv[n];
                len = pv[n].name.len;
        ...
        if (v[i].get_handler == 0) {
            if ((cf->log)->log_level >= 1) ngx_log_error_core(1, cf->log, 0, "unknown \"%V\" variable", &v[i].name)
                                                                ;
