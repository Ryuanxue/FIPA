...
# 10 "src/http/ngx_http_parse.c" 2
...
# 11 "src/http/ngx_http_parse.c" 2
...
ngx_http_parse_request_line(ngx_http_request_t *r, ngx_buf_t *b)
{
    ...
    if (r->http_version == 9 && r->method != 0x0002) {
        return 13;
    }
    ...
    for (p = b->pos; p < b->last; p++) {
        ...
        case sw_name:
            ...
            if (ch == '/'
                ...
                && strncmp((const char *) r->header_name_start, (const char *) "HTTP", 4) == 0)
            {
...
ngx_http_parse_complex_uri(ngx_http_request_t *r, ngx_uint_t merge_slashes)
{
    ...
    while (p <= r->uri_end) {
        ...
        case sw_usual:
            ...
            switch (ch) {
# 1334 "src/http/ngx_http_parse.c"
            case '/':
...
unsafe:
    ...
    if (*flags & 1) {
        if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "unsafe URI \"%V\" was detected", uri)
                                                            ;
    }
    ...
    ngx_http_chunked_t *ctx)
{
    ...
    for (pos = b->pos; pos < b->last; pos++) {
        ...
        case sw_chunk_size:
            if (ctx->size > 9223372036854775807LL / 16) {
                goto invalid;
            }
...
data:
    ...
    if (ctx->size > 9223372036854775807LL - 5) {
        goto invalid;
    }
