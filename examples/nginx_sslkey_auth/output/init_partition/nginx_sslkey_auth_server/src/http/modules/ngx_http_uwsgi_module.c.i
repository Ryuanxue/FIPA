# 1 "src/http/modules/ngx_http_uwsgi_module.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "src/http/modules/ngx_http_uwsgi_module.c"
# 10 "src/http/modules/ngx_http_uwsgi_module.c"
...
# 11 "src/http/modules/ngx_http_uwsgi_module.c" 2
...
# 12 "src/http/modules/ngx_http_uwsgi_module.c" 2
...
# 13 "src/http/modules/ngx_http_uwsgi_module.c" 2
...
# 61 "src/http/modules/ngx_http_uwsgi_module.c"
...
static char *ngx_http_uwsgi_cache_key(ngx_conf_t *cf, ngx_command_t *cmd,
    void *conf);
# 103 "src/http/modules/ngx_http_uwsgi_module.c"
...
# 139 "src/http/modules/ngx_http_uwsgi_module.c"
ngx_module_t ngx_http_uwsgi_module;


static ngx_command_t ngx_http_uwsgi_commands[] = {

    { { sizeof("uwsgi_pass") - 1, (u_char *) "uwsgi_pass" },
      0x08000000|0x40000000|0x00000002,
      ngx_http_uwsgi_pass,
      
# 147 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 147 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      0,
      0 },

    { { sizeof("uwsgi_modifier1") - 1, (u_char *) "uwsgi_modifier1" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_num_slot,
      
# 154 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 154 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 155 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 155 "src/http/modules/ngx_http_uwsgi_module.c"
                                                   ,
      &ngx_http_uwsgi_modifier_bounds },

    { { sizeof("uwsgi_modifier2") - 1, (u_char *) "uwsgi_modifier2" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_num_slot,
      
# 161 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 161 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 162 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 162 "src/http/modules/ngx_http_uwsgi_module.c"
                                                   ,
      &ngx_http_uwsgi_modifier_bounds },

    { { sizeof("uwsgi_store") - 1, (u_char *) "uwsgi_store" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_http_uwsgi_store,
      
# 168 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 168 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      0,
      0 },

    { { sizeof("uwsgi_store_access") - 1, (u_char *) "uwsgi_store_access" },
      0x02000000|0x04000000|0x08000000|(0x00000002|0x00000004|0x00000008),
      ngx_conf_set_access_slot,
      
# 175 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 175 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 176 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 176 "src/http/modules/ngx_http_uwsgi_module.c"
                                                               ,
      0 },

    { { sizeof("uwsgi_buffering") - 1, (u_char *) "uwsgi_buffering" },
      0x02000000|0x04000000|0x08000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 182 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 182 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 183 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 183 "src/http/modules/ngx_http_uwsgi_module.c"
                                                            ,
      0 },

    { { sizeof("uwsgi_request_buffering") - 1, (u_char *) "uwsgi_request_buffering" },
      0x02000000|0x04000000|0x08000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 189 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 189 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 190 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 190 "src/http/modules/ngx_http_uwsgi_module.c"
                                                                    ,
      0 },

    { { sizeof("uwsgi_ignore_client_abort") - 1, (u_char *) "uwsgi_ignore_client_abort" },
      0x02000000|0x04000000|0x08000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 196 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 196 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 197 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 197 "src/http/modules/ngx_http_uwsgi_module.c"
                                                                      ,
      0 },

    { { sizeof("uwsgi_bind") - 1, (u_char *) "uwsgi_bind" },
      0x02000000|0x04000000|0x08000000|(0x00000002|0x00000004),
      ngx_http_upstream_bind_set_slot,
      
# 203 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 203 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 204 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 204 "src/http/modules/ngx_http_uwsgi_module.c"
                                                        ,
      0 },

    { { sizeof("uwsgi_connect_timeout") - 1, (u_char *) "uwsgi_connect_timeout" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_msec_slot,
      
# 210 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 210 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 211 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 211 "src/http/modules/ngx_http_uwsgi_module.c"
                                                                  ,
      0 },

    { { sizeof("uwsgi_send_timeout") - 1, (u_char *) "uwsgi_send_timeout" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_msec_slot,
      
# 217 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 217 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 218 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 218 "src/http/modules/ngx_http_uwsgi_module.c"
                                                               ,
      0 },

    { { sizeof("uwsgi_buffer_size") - 1, (u_char *) "uwsgi_buffer_size" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_size_slot,
      
# 224 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 224 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 225 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 225 "src/http/modules/ngx_http_uwsgi_module.c"
                                                              ,
      0 },

    { { sizeof("uwsgi_pass_request_headers") - 1, (u_char *) "uwsgi_pass_request_headers" },
      0x02000000|0x04000000|0x08000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 231 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 231 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 232 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 232 "src/http/modules/ngx_http_uwsgi_module.c"
                                                                       ,
      0 },

    { { sizeof("uwsgi_pass_request_body") - 1, (u_char *) "uwsgi_pass_request_body" },
      0x02000000|0x04000000|0x08000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 238 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 238 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 239 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 239 "src/http/modules/ngx_http_uwsgi_module.c"
                                                                    ,
      0 },

    { { sizeof("uwsgi_intercept_errors") - 1, (u_char *) "uwsgi_intercept_errors" },
      0x02000000|0x04000000|0x08000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 245 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 245 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 246 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 246 "src/http/modules/ngx_http_uwsgi_module.c"
                                                                   ,
      0 },

    { { sizeof("uwsgi_read_timeout") - 1, (u_char *) "uwsgi_read_timeout" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_msec_slot,
      
# 252 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 252 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 253 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 253 "src/http/modules/ngx_http_uwsgi_module.c"
                                                               ,
      0 },

    { { sizeof("uwsgi_buffers") - 1, (u_char *) "uwsgi_buffers" },
      0x02000000|0x04000000|0x08000000|0x00000004,
      ngx_conf_set_bufs_slot,
      
# 259 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 259 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 260 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 260 "src/http/modules/ngx_http_uwsgi_module.c"
                                                       ,
      0 },

    { { sizeof("uwsgi_busy_buffers_size") - 1, (u_char *) "uwsgi_busy_buffers_size" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_size_slot,
      
# 266 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 266 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 267 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 267 "src/http/modules/ngx_http_uwsgi_module.c"
                                                                         ,
      0 },

    { { sizeof("uwsgi_force_ranges") - 1, (u_char *) "uwsgi_force_ranges" },
      0x02000000|0x04000000|0x08000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 273 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 273 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 274 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 274 "src/http/modules/ngx_http_uwsgi_module.c"
                                                               ,
      0 },

    { { sizeof("uwsgi_limit_rate") - 1, (u_char *) "uwsgi_limit_rate" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_size_slot,
      
# 280 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 280 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 281 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 281 "src/http/modules/ngx_http_uwsgi_module.c"
                                                             ,
      0 },



    { { sizeof("uwsgi_cache") - 1, (u_char *) "uwsgi_cache" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_http_uwsgi_cache,
      
# 289 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 289 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      0,
      0 },

    { { sizeof("uwsgi_cache_key") - 1, (u_char *) "uwsgi_cache_key" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_http_uwsgi_cache_key,
      
# 296 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 296 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      0,
      0 },

    { { sizeof("uwsgi_cache_path") - 1, (u_char *) "uwsgi_cache_path" },
      0x02000000|0x00001000,
      ngx_http_file_cache_set_slot,
      
# 303 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 303 "src/http/modules/ngx_http_uwsgi_module.c"
                              ,
      
# 304 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 304 "src/http/modules/ngx_http_uwsgi_module.c"
                                                 ,
      &ngx_http_uwsgi_module },

    { { sizeof("uwsgi_cache_bypass") - 1, (u_char *) "uwsgi_cache_bypass" },
      0x02000000|0x04000000|0x08000000|0x00000800,
      ngx_http_set_predicate_slot,
      
# 310 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 310 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 311 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 311 "src/http/modules/ngx_http_uwsgi_module.c"
                                                               ,
      0 },

    { { sizeof("uwsgi_no_cache") - 1, (u_char *) "uwsgi_no_cache" },
      0x02000000|0x04000000|0x08000000|0x00000800,
      ngx_http_set_predicate_slot,
      
# 317 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 317 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 318 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 318 "src/http/modules/ngx_http_uwsgi_module.c"
                                                           ,
      0 },

    { { sizeof("uwsgi_cache_valid") - 1, (u_char *) "uwsgi_cache_valid" },
      0x02000000|0x04000000|0x08000000|0x00000800,
      ngx_http_file_cache_valid_set_slot,
      
# 324 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 324 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 325 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 325 "src/http/modules/ngx_http_uwsgi_module.c"
                                                              ,
      0 },

    { { sizeof("uwsgi_cache_min_uses") - 1, (u_char *) "uwsgi_cache_min_uses" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_num_slot,
      
# 331 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 331 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 332 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 332 "src/http/modules/ngx_http_uwsgi_module.c"
                                                                 ,
      0 },

    { { sizeof("uwsgi_cache_max_range_offset") - 1, (u_char *) "uwsgi_cache_max_range_offset" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_off_slot,
      
# 338 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 338 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 339 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 339 "src/http/modules/ngx_http_uwsgi_module.c"
                                                                         ,
      0 },

    { { sizeof("uwsgi_cache_use_stale") - 1, (u_char *) "uwsgi_cache_use_stale" },
      0x02000000|0x04000000|0x08000000|0x00000800,
      ngx_conf_set_bitmask_slot,
      
# 345 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 345 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 346 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 346 "src/http/modules/ngx_http_uwsgi_module.c"
                                                                  ,
      &ngx_http_uwsgi_next_upstream_masks },

    { { sizeof("uwsgi_cache_methods") - 1, (u_char *) "uwsgi_cache_methods" },
      0x02000000|0x04000000|0x08000000|0x00000800,
      ngx_conf_set_bitmask_slot,
      
# 352 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 352 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 353 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 353 "src/http/modules/ngx_http_uwsgi_module.c"
                                                                ,
      &ngx_http_upstream_cache_method_mask },

    { { sizeof("uwsgi_cache_lock") - 1, (u_char *) "uwsgi_cache_lock" },
      0x02000000|0x04000000|0x08000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 359 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 359 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 360 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 360 "src/http/modules/ngx_http_uwsgi_module.c"
                                                             ,
      0 },

    { { sizeof("uwsgi_cache_lock_timeout") - 1, (u_char *) "uwsgi_cache_lock_timeout" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_msec_slot,
      
# 366 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 366 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 367 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 367 "src/http/modules/ngx_http_uwsgi_module.c"
                                                                     ,
      0 },

    { { sizeof("uwsgi_cache_lock_age") - 1, (u_char *) "uwsgi_cache_lock_age" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_msec_slot,
      
# 373 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 373 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 374 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 374 "src/http/modules/ngx_http_uwsgi_module.c"
                                                                 ,
      0 },

    { { sizeof("uwsgi_cache_revalidate") - 1, (u_char *) "uwsgi_cache_revalidate" },
      0x02000000|0x04000000|0x08000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 380 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 380 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 381 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 381 "src/http/modules/ngx_http_uwsgi_module.c"
                                                                   ,
      0 },

    { { sizeof("uwsgi_cache_background_update") - 1, (u_char *) "uwsgi_cache_background_update" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_flag_slot,
      
# 387 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 387 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 388 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 388 "src/http/modules/ngx_http_uwsgi_module.c"
                                                                          ,
      0 },



    { { sizeof("uwsgi_temp_path") - 1, (u_char *) "uwsgi_temp_path" },
      0x02000000|0x04000000|0x08000000|(0x00000002|0x00000004|0x00000008 |0x00000010),
      ngx_conf_set_path_slot,
      
# 396 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 396 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 397 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 397 "src/http/modules/ngx_http_uwsgi_module.c"
                                                            ,
      0 },

    { { sizeof("uwsgi_max_temp_file_size") - 1, (u_char *) "uwsgi_max_temp_file_size" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_size_slot,
      
# 403 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 403 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 404 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 404 "src/http/modules/ngx_http_uwsgi_module.c"
                                                                          ,
      0 },

    { { sizeof("uwsgi_temp_file_write_size") - 1, (u_char *) "uwsgi_temp_file_write_size" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_size_slot,
      
# 410 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 410 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 411 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 411 "src/http/modules/ngx_http_uwsgi_module.c"
                                                                            ,
      0 },

    { { sizeof("uwsgi_next_upstream") - 1, (u_char *) "uwsgi_next_upstream" },
      0x02000000|0x04000000|0x08000000|0x00000800,
      ngx_conf_set_bitmask_slot,
      
# 417 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 417 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 418 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 418 "src/http/modules/ngx_http_uwsgi_module.c"
                                                                ,
      &ngx_http_uwsgi_next_upstream_masks },

    { { sizeof("uwsgi_next_upstream_tries") - 1, (u_char *) "uwsgi_next_upstream_tries" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_num_slot,
      
# 424 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 424 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 425 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 425 "src/http/modules/ngx_http_uwsgi_module.c"
                                                                      ,
      0 },

    { { sizeof("uwsgi_next_upstream_timeout") - 1, (u_char *) "uwsgi_next_upstream_timeout" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_msec_slot,
      
# 431 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 431 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 432 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 432 "src/http/modules/ngx_http_uwsgi_module.c"
                                                                        ,
      0 },

    { { sizeof("uwsgi_param") - 1, (u_char *) "uwsgi_param" },
      0x02000000|0x04000000|0x08000000|(0x00000004|0x00000008),
      ngx_http_upstream_param_set_slot,
      
# 438 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 438 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 439 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 439 "src/http/modules/ngx_http_uwsgi_module.c"
                                                       ,
      0 },

    { { sizeof("uwsgi_string") - 1, (u_char *) "uwsgi_string" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_str_slot,
      
# 445 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 445 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 446 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 446 "src/http/modules/ngx_http_uwsgi_module.c"
                                                      ,
      0 },

    { { sizeof("uwsgi_pass_header") - 1, (u_char *) "uwsgi_pass_header" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_str_array_slot,
      
# 452 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 452 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 453 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 453 "src/http/modules/ngx_http_uwsgi_module.c"
                                                               ,
      0 },

    { { sizeof("uwsgi_hide_header") - 1, (u_char *) "uwsgi_hide_header" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_str_array_slot,
      
# 459 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 459 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 460 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 460 "src/http/modules/ngx_http_uwsgi_module.c"
                                                               ,
      0 },

    { { sizeof("uwsgi_ignore_headers") - 1, (u_char *) "uwsgi_ignore_headers" },
      0x02000000|0x04000000|0x08000000|0x00000800,
      ngx_conf_set_bitmask_slot,
      
# 466 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 466 "src/http/modules/ngx_http_uwsgi_module.c"
                             ,
      
# 467 "src/http/modules/ngx_http_uwsgi_module.c" 3 4
     0
# 467 "src/http/modules/ngx_http_uwsgi_module.c"
                                                                 ,
      &ngx_http_upstream_ignore_headers_masks },
# 558 "src/http/modules/ngx_http_uwsgi_module.c"
      { { 0, 0 }, 0, 0, 0, 0, 0 }
};
...
static ngx_path_init_t ngx_http_uwsgi_temp_path = {
    { sizeof("uwsgi_temp") - 1, (u_char *) "uwsgi_temp" }, { 1, 2, 0 }
};
...
ngx_http_uwsgi_handler(ngx_http_request_t *r)
{
    ...
    r->ctx[ngx_http_uwsgi_module.ctx_index] = status;;

    uwcf = (r)->loc_conf[ngx_http_uwsgi_module.ctx_index];

    u = r->upstream;

    if (uwcf->uwsgi_lengths == 0) {
# 662 "src/http/modules/ngx_http_uwsgi_module.c"
        (&u->schema)->len = sizeof("uwsgi://") - 1; (&u->schema)->data = (u_char *) "uwsgi://";


    } else {
        if (ngx_http_uwsgi_eval(r, uwcf) != 0) {
            return 500;
        }
    }
    ...
    uwmcf = (r)->main_conf[ngx_http_uwsgi_module.ctx_index];
...
ngx_http_uwsgi_eval(ngx_http_request_t *r, ngx_http_uwsgi_loc_conf_t * uwcf)
{
               ...
               && ngx_strncasecmp(url.url.data, (u_char *) "suwsgi://", 9) == 0)
    {
        ...
        if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "suwsgi protocol requires SSL support")
                                                             ;
        return -1;
...
ngx_http_uwsgi_create_key(ngx_http_request_t *r)
{
    ...
    if (ngx_http_complex_value(r, &uwcf->cache_key, key) != 0) {
        return -1;
    }
...
# 963 "src/http/modules/ngx_http_uwsgi_module.c"
    if (len > 65535) {
        if ((r->connection->log)->log_level >= 2) ngx_log_error_core(2, r->connection->log, 0, "uwsgi request is too big: %uz", len)
                                                           ;
        return -1;
    }
    ...
    *b->last++ = (u_char) uwcf->modifier2;
    ...
    b->last = (((u_char *) memcpy(b->last, uwcf->uwsgi_string.data, uwcf->uwsgi_string.len)) + (uwcf->uwsgi_string.len))
                                              ;
...
ngx_http_uwsgi_reinit_request(ngx_http_request_t *r)
{
    ...
    status = (r)->ctx[ngx_http_uwsgi_module.ctx_index];
...
ngx_http_uwsgi_process_status_line(ngx_http_request_t *r)
{
    ...
    if (u->headers_in.status_line.data == 0) {
        return -1;
    }

    (void) memcpy(u->headers_in.status_line.data, status->start, len);
...
# 1461 "src/http/modules/ngx_http_uwsgi_module.c"
    conf->upstream.cyclic_temp_file = 0;

    conf->upstream.change_buffering = 1;

    (&conf->upstream.module)->len = sizeof("uwsgi") - 1; (&conf->upstream.module)->data = (u_char *) "uwsgi";
...
ngx_http_uwsgi_merge_loc_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    if (conf->upstream.intercept_errors == -1) { conf->upstream.intercept_errors = (prev->upstream.intercept_errors == -1) ? 0 : prev->upstream.intercept_errors; }
                                                            ;
# 1791 "src/http/modules/ngx_http_uwsgi_module.c"
    if (conf->uwsgi_string.data == 0) { if (prev->uwsgi_string.data) { conf->uwsgi_string.len = prev->uwsgi_string.len; conf->uwsgi_string.data = prev->uwsgi_string.data; } else { conf->uwsgi_string.len = sizeof("") - 1; conf->uwsgi_string.data = (u_char *) ""; } };
    ...
    if (clcf->noname
        && conf->upstream.upstream == 0 && conf->uwsgi_lengths == 0)
    {
    ...
    if (conf->modifier1 == (ngx_uint_t) -1) { conf->modifier1 = (prev->modifier1 == (ngx_uint_t) -1) ? 0 : prev->modifier1; };
    if (conf->modifier2 == (ngx_uint_t) -1) { conf->modifier2 = (prev->modifier2 == (ngx_uint_t) -1) ? 0 : prev->modifier2; };
    ...
    rc = ngx_http_uwsgi_init_params(cf, conf, &conf->params, 0);
    if (rc != 0) {
        return (void *) -1;
    }
...
# 1858 "src/http/modules/ngx_http_uwsgi_module.c"
...
ngx_http_uwsgi_cache(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (cv.lengths != 0) {
        ...
        if (uwcf->upstream.cache_value == 0) {
            return (void *) -1;
        }
