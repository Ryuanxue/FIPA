...
ngx_int_t ngx_http_auth_basic_init_sense_1(int *ngx_http_auth_basic_init_sense_1_ret, ngx_conf_t *cf)
{
  ...
  {
    {
      *ngx_http_auth_basic_init_sense_1_ret = 1;
      return -1;
    }
  }
