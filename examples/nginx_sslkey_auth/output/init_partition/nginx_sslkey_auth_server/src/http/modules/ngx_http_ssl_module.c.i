# 1 "src/http/modules/ngx_http_ssl_module.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 9 "src/http/modules/ngx_http_ssl_module.c" 2
...
# 10 "src/http/modules/ngx_http_ssl_module.c" 2
...
# 11 "src/http/modules/ngx_http_ssl_module.c" 2
# 1 "src/http/modules/ngx_http_ssl_module.h" 1
# 17 "src/http/modules/ngx_http_ssl_module.h"
typedef struct {
    ngx_flag_t enable;
...
# 12 "src/http/modules/ngx_http_ssl_module.c" 2

typedef ngx_int_t (*ngx_ssl_variable_handler_pt)(ngx_connection_t *c,
    ngx_pool_t *pool, ngx_str_t *s);
# 34 "src/http/modules/ngx_http_ssl_module.c"
...
static ngx_conf_bitmask_t ngx_http_ssl_protocols[] = {
    { { sizeof("SSLv2") - 1, (u_char *) "SSLv2" }, NGX_SSL_SSLv2 },
    { { sizeof("SSLv3") - 1, (u_char *) "SSLv3" }, NGX_SSL_SSLv3 },
    { { sizeof("TLSv1") - 1, (u_char *) "TLSv1" }, NGX_SSL_TLSv1 },
    { { sizeof("TLSv1.1") - 1, (u_char *) "TLSv1.1" }, NGX_SSL_TLSv1_1 },
    { { sizeof("TLSv1.2") - 1, (u_char *) "TLSv1.2" }, NGX_SSL_TLSv1_2 },
    { { sizeof("TLSv1.3") - 1, (u_char *) "TLSv1.3" }, NGX_SSL_TLSv1_3 },
    { { 0, 0 }, 0 }
};
...
static ngx_conf_enum_t ngx_http_ssl_verify[] = {
    ...
    { { sizeof("optional") - 1, (u_char *) "optional" }, 2 },
    { { sizeof("optional_no_ca") - 1, (u_char *) "optional_no_ca" }, 3 },
    { { 0, 0 }, 0 }
};
...
static ngx_command_t ngx_http_ssl_commands[] = {
    ...
    { { sizeof("ssl") - 1, (u_char *) "ssl" },
      0x02000000|0x04000000|0x00000200,
      ngx_http_ssl_enable,
      
# 84 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 84 "src/http/modules/ngx_http_ssl_module.c"
                             ,
      
# 85 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 85 "src/http/modules/ngx_http_ssl_module.c"
                                              ,
      &ngx_http_ssl_deprecated },

    { { sizeof("ssl_certificate") - 1, (u_char *) "ssl_certificate" },
      0x02000000|0x04000000|0x00000002,
      ngx_conf_set_str_array_slot,
      
# 91 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 91 "src/http/modules/ngx_http_ssl_module.c"
                             ,
      
# 92 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 92 "src/http/modules/ngx_http_ssl_module.c"
                                                    ,
      0 },

    { { sizeof("ssl_certificate_key") - 1, (u_char *) "ssl_certificate_key" },
      0x02000000|0x04000000|0x00000002,
      ngx_conf_set_str_array_slot,
      
# 98 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 98 "src/http/modules/ngx_http_ssl_module.c"
                             ,
      
# 99 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 99 "src/http/modules/ngx_http_ssl_module.c"
                                                        ,
      0 },

    { { sizeof("ssl_password_file") - 1, (u_char *) "ssl_password_file" },
      0x02000000|0x04000000|0x00000002,
      ngx_http_ssl_password_file,
      
# 105 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 105 "src/http/modules/ngx_http_ssl_module.c"
                             ,
      0,
      0 },

    { { sizeof("ssl_dhparam") - 1, (u_char *) "ssl_dhparam" },
      0x02000000|0x04000000|0x00000002,
      ngx_conf_set_str_slot,
      
# 112 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 112 "src/http/modules/ngx_http_ssl_module.c"
                             ,
      
# 113 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 113 "src/http/modules/ngx_http_ssl_module.c"
                                               ,
      0 },

    { { sizeof("ssl_ecdh_curve") - 1, (u_char *) "ssl_ecdh_curve" },
      0x02000000|0x04000000|0x00000002,
      ngx_conf_set_str_slot,
      
# 119 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 119 "src/http/modules/ngx_http_ssl_module.c"
                             ,
      
# 120 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 120 "src/http/modules/ngx_http_ssl_module.c"
                                                  ,
      0 },

    { { sizeof("ssl_protocols") - 1, (u_char *) "ssl_protocols" },
      0x02000000|0x04000000|0x00000800,
      ngx_conf_set_bitmask_slot,
      
# 126 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 126 "src/http/modules/ngx_http_ssl_module.c"
                             ,
      
# 127 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 127 "src/http/modules/ngx_http_ssl_module.c"
                                                 ,
      &ngx_http_ssl_protocols },

    { { sizeof("ssl_ciphers") - 1, (u_char *) "ssl_ciphers" },
      0x02000000|0x04000000|0x00000002,
      ngx_conf_set_str_slot,
      
# 133 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 133 "src/http/modules/ngx_http_ssl_module.c"
                             ,
      
# 134 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 134 "src/http/modules/ngx_http_ssl_module.c"
                                               ,
      0 },

    { { sizeof("ssl_buffer_size") - 1, (u_char *) "ssl_buffer_size" },
      0x02000000|0x04000000|0x00000002,
      ngx_conf_set_size_slot,
      
# 140 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 140 "src/http/modules/ngx_http_ssl_module.c"
                             ,
      
# 141 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 141 "src/http/modules/ngx_http_ssl_module.c"
                                                   ,
      0 },

    { { sizeof("ssl_verify_client") - 1, (u_char *) "ssl_verify_client" },
      0x02000000|0x04000000|0x00000002,
      ngx_conf_set_enum_slot,
      
# 147 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 147 "src/http/modules/ngx_http_ssl_module.c"
                             ,
      
# 148 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 148 "src/http/modules/ngx_http_ssl_module.c"
                                              ,
      &ngx_http_ssl_verify },

    { { sizeof("ssl_verify_depth") - 1, (u_char *) "ssl_verify_depth" },
      0x02000000|0x04000000|0x00000002,
      ngx_conf_set_num_slot,
      
# 154 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 154 "src/http/modules/ngx_http_ssl_module.c"
                             ,
      
# 155 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 155 "src/http/modules/ngx_http_ssl_module.c"
                                                    ,
      0 },

    { { sizeof("ssl_client_certificate") - 1, (u_char *) "ssl_client_certificate" },
      0x02000000|0x04000000|0x00000002,
      ngx_conf_set_str_slot,
      
# 161 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 161 "src/http/modules/ngx_http_ssl_module.c"
                             ,
      
# 162 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 162 "src/http/modules/ngx_http_ssl_module.c"
                                                          ,
      0 },

    { { sizeof("ssl_trusted_certificate") - 1, (u_char *) "ssl_trusted_certificate" },
      0x02000000|0x04000000|0x00000002,
      ngx_conf_set_str_slot,
      
# 168 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 168 "src/http/modules/ngx_http_ssl_module.c"
                             ,
      
# 169 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 169 "src/http/modules/ngx_http_ssl_module.c"
                                                           ,
      0 },

    { { sizeof("ssl_prefer_server_ciphers") - 1, (u_char *) "ssl_prefer_server_ciphers" },
      0x02000000|0x04000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 175 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 175 "src/http/modules/ngx_http_ssl_module.c"
                             ,
      
# 176 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 176 "src/http/modules/ngx_http_ssl_module.c"
                                                             ,
      0 },

    { { sizeof("ssl_session_cache") - 1, (u_char *) "ssl_session_cache" },
      0x02000000|0x04000000|(0x00000002|0x00000004),
      ngx_http_ssl_session_cache,
      
# 182 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 182 "src/http/modules/ngx_http_ssl_module.c"
                             ,
      0,
      0 },

    { { sizeof("ssl_session_tickets") - 1, (u_char *) "ssl_session_tickets" },
      0x02000000|0x04000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 189 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 189 "src/http/modules/ngx_http_ssl_module.c"
                             ,
      
# 190 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 190 "src/http/modules/ngx_http_ssl_module.c"
                                                       ,
      0 },

    { { sizeof("ssl_session_ticket_key") - 1, (u_char *) "ssl_session_ticket_key" },
      0x02000000|0x04000000|0x00000002,
      ngx_conf_set_str_array_slot,
      
# 196 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 196 "src/http/modules/ngx_http_ssl_module.c"
                             ,
      
# 197 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 197 "src/http/modules/ngx_http_ssl_module.c"
                                                           ,
      0 },

    { { sizeof("ssl_session_timeout") - 1, (u_char *) "ssl_session_timeout" },
      0x02000000|0x04000000|0x00000002,
      ngx_conf_set_sec_slot,
      
# 203 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 203 "src/http/modules/ngx_http_ssl_module.c"
                             ,
      
# 204 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 204 "src/http/modules/ngx_http_ssl_module.c"
                                                       ,
      0 },

    { { sizeof("ssl_crl") - 1, (u_char *) "ssl_crl" },
      0x02000000|0x04000000|0x00000002,
      ngx_conf_set_str_slot,
      
# 210 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 210 "src/http/modules/ngx_http_ssl_module.c"
                             ,
      
# 211 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 211 "src/http/modules/ngx_http_ssl_module.c"
                                           ,
      0 },

    { { sizeof("ssl_stapling") - 1, (u_char *) "ssl_stapling" },
      0x02000000|0x04000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 217 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 217 "src/http/modules/ngx_http_ssl_module.c"
                             ,
      
# 218 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 218 "src/http/modules/ngx_http_ssl_module.c"
                                                ,
      0 },

    { { sizeof("ssl_stapling_file") - 1, (u_char *) "ssl_stapling_file" },
      0x02000000|0x04000000|0x00000002,
      ngx_conf_set_str_slot,
      
# 224 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 224 "src/http/modules/ngx_http_ssl_module.c"
                             ,
      
# 225 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 225 "src/http/modules/ngx_http_ssl_module.c"
                                                     ,
      0 },

    { { sizeof("ssl_stapling_responder") - 1, (u_char *) "ssl_stapling_responder" },
      0x02000000|0x04000000|0x00000002,
      ngx_conf_set_str_slot,
      
# 231 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 231 "src/http/modules/ngx_http_ssl_module.c"
                             ,
      
# 232 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 232 "src/http/modules/ngx_http_ssl_module.c"
                                                          ,
      0 },

    { { sizeof("ssl_stapling_verify") - 1, (u_char *) "ssl_stapling_verify" },
      0x02000000|0x04000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 238 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 238 "src/http/modules/ngx_http_ssl_module.c"
                             ,
      
# 239 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 239 "src/http/modules/ngx_http_ssl_module.c"
                                                       ,
      0 },

    { { sizeof("ssl_early_data") - 1, (u_char *) "ssl_early_data" },
      0x02000000|0x04000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 245 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 245 "src/http/modules/ngx_http_ssl_module.c"
                             ,
      
# 246 "src/http/modules/ngx_http_ssl_module.c" 3 4
     0
# 246 "src/http/modules/ngx_http_ssl_module.c"
                                                  ,
      0 },
...
static ngx_http_variable_t ngx_http_ssl_vars[] = {
    ...
    { { sizeof("ssl_protocol") - 1, (u_char *) "ssl_protocol" }, 0, ngx_http_ssl_static_variable,
      (uintptr_t) ngx_ssl_get_protocol, 1, 0 },

    { { sizeof("ssl_cipher") - 1, (u_char *) "ssl_cipher" }, 0, ngx_http_ssl_static_variable,
      (uintptr_t) ngx_ssl_get_cipher_name, 1, 0 },

    { { sizeof("ssl_ciphers") - 1, (u_char *) "ssl_ciphers" }, 0, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_ciphers, 1, 0 },

    { { sizeof("ssl_curves") - 1, (u_char *) "ssl_curves" }, 0, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_curves, 1, 0 },

    { { sizeof("ssl_session_id") - 1, (u_char *) "ssl_session_id" }, 0, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_session_id, 1, 0 },

    { { sizeof("ssl_session_reused") - 1, (u_char *) "ssl_session_reused" }, 0, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_session_reused, 1, 0 },

    { { sizeof("ssl_early_data") - 1, (u_char *) "ssl_early_data" }, 0, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_early_data,
      1|2, 0 },

    { { sizeof("ssl_server_name") - 1, (u_char *) "ssl_server_name" }, 0, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_server_name, 1, 0 },

    { { sizeof("ssl_client_cert") - 1, (u_char *) "ssl_client_cert" }, 0, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_certificate, 1, 0 },

    { { sizeof("ssl_client_raw_cert") - 1, (u_char *) "ssl_client_raw_cert" }, 0, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_raw_certificate,
      1, 0 },

    { { sizeof("ssl_client_escaped_cert") - 1, (u_char *) "ssl_client_escaped_cert" }, 0, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_escaped_certificate,
      1, 0 },

    { { sizeof("ssl_client_s_dn") - 1, (u_char *) "ssl_client_s_dn" }, 0, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_subject_dn, 1, 0 },

    { { sizeof("ssl_client_i_dn") - 1, (u_char *) "ssl_client_i_dn" }, 0, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_issuer_dn, 1, 0 },

    { { sizeof("ssl_client_s_dn_legacy") - 1, (u_char *) "ssl_client_s_dn_legacy" }, 0, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_subject_dn_legacy, 1, 0 },

    { { sizeof("ssl_client_i_dn_legacy") - 1, (u_char *) "ssl_client_i_dn_legacy" }, 0, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_issuer_dn_legacy, 1, 0 },

    { { sizeof("ssl_client_serial") - 1, (u_char *) "ssl_client_serial" }, 0, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_serial_number, 1, 0 },

    { { sizeof("ssl_client_fingerprint") - 1, (u_char *) "ssl_client_fingerprint" }, 0, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_fingerprint, 1, 0 },

    { { sizeof("ssl_client_verify") - 1, (u_char *) "ssl_client_verify" }, 0, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_client_verify, 1, 0 },

    { { sizeof("ssl_client_v_start") - 1, (u_char *) "ssl_client_v_start" }, 0, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_client_v_start, 1, 0 },

    { { sizeof("ssl_client_v_end") - 1, (u_char *) "ssl_client_v_end" }, 0, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_client_v_end, 1, 0 },

    { { sizeof("ssl_client_v_remain") - 1, (u_char *) "ssl_client_v_remain" }, 0, ngx_http_ssl_variable,
      (uintptr_t) ngx_ssl_get_client_v_remain, 1, 0 },

      { { 0, 0 }, 0, 0, 0, 0, 0 }
};


static ngx_str_t ngx_http_ssl_sess_id_ctx = { sizeof("HTTP") - 1, (u_char *) "HTTP" };
# 457 "src/http/modules/ngx_http_ssl_module.c"
static ngx_int_t
    ...
    uintptr_t data)
{
    ...
    if (r->connection->ssl) {
        ...
        if (handler(r->connection, r->pool, &s) != 0) {
            return -1;
        }
...
# 564 "src/http/modules/ngx_http_ssl_module.c"
    sscf->enable = -1;
    sscf->prefer_server_ciphers = -1;
    sscf->early_data = -1;
    sscf->buffer_size = (size_t) -1;
    sscf->verify = (ngx_uint_t) -1;
    sscf->verify_depth = (ngx_uint_t) -1;
    sscf->certificates = (void *) -1;
    sscf->certificate_keys = (void *) -1;
    sscf->passwords = (void *) -1;
    sscf->builtin_session_cache = -1;
    sscf->session_timeout = -1;
    sscf->session_tickets = -1;
    sscf->session_ticket_keys = (void *) -1;
    sscf->stapling = -1;
    sscf->stapling_verify = -1;
...
ngx_http_ssl_merge_srv_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    if (conf->session_timeout == -1) { conf->session_timeout = (prev->session_timeout == -1) ? 300 : prev->session_timeout; }
                                                    ;

    if (conf->prefer_server_ciphers == -1) { conf->prefer_server_ciphers = (prev->prefer_server_ciphers == -1) ? 0 : prev->prefer_server_ciphers; }
                                                        ;

    if (conf->early_data == -1) { conf->early_data = (prev->early_data == -1) ? 0 : prev->early_data; };

    if (conf->protocols == 0) { conf->protocols = (prev->protocols == 0) ? (1|NGX_SSL_TLSv1 |NGX_SSL_TLSv1_1|NGX_SSL_TLSv1_2) : prev->protocols; }

                                                            ;

    if (conf->buffer_size == (size_t) -1) { conf->buffer_size = (prev->buffer_size == (size_t) -1) ? NGX_SSL_BUFSIZE : prev->buffer_size; }
                                         ;

    if (conf->verify == (ngx_uint_t) -1) { conf->verify = (prev->verify == (ngx_uint_t) -1) ? 0 : prev->verify; };
    if (conf->verify_depth == (ngx_uint_t) -1) { conf->verify_depth = (prev->verify_depth == (ngx_uint_t) -1) ? 1 : prev->verify_depth; };

    if (conf->certificates == (void *) -1) { conf->certificates = (prev->certificates == (void *) -1) ? 0 : prev->certificates; };
    if (conf->certificate_keys == (void *) -1) { conf->certificate_keys = (prev->certificate_keys == (void *) -1) ? 0 : prev->certificate_keys; }
                              ;

    if (conf->passwords == (void *) -1) { conf->passwords = (prev->passwords == (void *) -1) ? 0 : prev->passwords; };

    if (conf->dhparam.data == 0) { if (prev->dhparam.data) { conf->dhparam.len = prev->dhparam.len; conf->dhparam.data = prev->dhparam.data; } else { conf->dhparam.len = sizeof("") - 1; conf->dhparam.data = (u_char *) ""; } };

    if (conf->client_certificate.data == 0) { if (prev->client_certificate.data) { conf->client_certificate.len = prev->client_certificate.len; conf->client_certificate.data = prev->client_certificate.data; } else { conf->client_certificate.len = sizeof("") - 1; conf->client_certificate.data = (u_char *) ""; } }
                            ;
    if (conf->trusted_certificate.data == 0) { if (prev->trusted_certificate.data) { conf->trusted_certificate.len = prev->trusted_certificate.len; conf->trusted_certificate.data = prev->trusted_certificate.data; } else { conf->trusted_certificate.len = sizeof("") - 1; conf->trusted_certificate.data = (u_char *) ""; } }
                                                       ;
    if (conf->crl.data == 0) { if (prev->crl.data) { conf->crl.len = prev->crl.len; conf->crl.data = prev->crl.data; } else { conf->crl.len = sizeof("") - 1; conf->crl.data = (u_char *) ""; } };

    if (conf->ecdh_curve.data == 0) { if (prev->ecdh_curve.data) { conf->ecdh_curve.len = prev->ecdh_curve.len; conf->ecdh_curve.data = prev->ecdh_curve.data; } else { conf->ecdh_curve.len = sizeof("auto") - 1; conf->ecdh_curve.data = (u_char *) "auto"; } }
                                                ;

    if (conf->ciphers.data == 0) { if (prev->ciphers.data) { conf->ciphers.len = prev->ciphers.len; conf->ciphers.data = prev->ciphers.data; } else { conf->ciphers.len = sizeof("HIGH:!aNULL:!MD5") - 1; conf->ciphers.data = (u_char *) "HIGH:!aNULL:!MD5"; } };

    if (conf->stapling == -1) { conf->stapling = (prev->stapling == -1) ? 0 : prev->stapling; };
    if (conf->stapling_verify == -1) { conf->stapling_verify = (prev->stapling_verify == -1) ? 0 : prev->stapling_verify; };
    if (conf->stapling_file.data == 0) { if (prev->stapling_file.data) { conf->stapling_file.len = prev->stapling_file.len; conf->stapling_file.data = prev->stapling_file.data; } else { conf->stapling_file.len = sizeof("") - 1; conf->stapling_file.data = (u_char *) ""; } };
    if (conf->stapling_responder.data == 0) { if (prev->stapling_responder.data) { conf->stapling_responder.len = prev->stapling_responder.len; conf->stapling_responder.data = prev->stapling_responder.data; } else { conf->stapling_responder.len = sizeof("") - 1; conf->stapling_responder.data = (u_char *) ""; } }
                                                      ;
    ...
    if (conf->enable) {
        ...
        if (conf->certificates == 0) {
            if ((cf->log)->log_level >= 1) ngx_log_error_core(1, cf->log, 0, "no \"ssl_certificate\" is defined for " "the \"ssl\" directive in %s:%ui", conf->file, conf->line)
        ...
        if (conf->certificate_keys == 0) {
            if ((cf->log)->log_level >= 1) ngx_log_error_core(1, cf->log, 0, "no \"ssl_certificate_key\" is defined for " "the \"ssl\" directive in %s:%ui", conf->file, conf->line)
        ...
        if (conf->certificate_keys->nelts < conf->certificates->nelts) {
            if ((cf->log)->log_level >= 1) ngx_log_error_core(1, cf->log, 0, "no \"ssl_certificate_key\" is defined " "for certificate \"%V\" and " "the \"ssl\" directive in %s:%ui", ((ngx_str_t *) conf->certificates->elts) + conf->certificates->nelts - 1, conf->file, conf->line)
        ...
        {
            if ((cf->log)->log_level >= 1) ngx_log_error_core(1, cf->log, 0, "no \"ssl_certificate_key\" is defined " "for certificate \"%V\"", ((ngx_str_t *) conf->certificates->elts) + conf->certificates->nelts - 1)
...
# 722 "src/http/modules/ngx_http_ssl_module.c"
    ...
    if (conf->verify) {
        ...
        if (conf->client_certificate.len == 0 && conf->verify != 3) {
            if ((cf->log)->log_level >= 1) ngx_log_error_core(1, cf->log, 0, "no ssl_client_certificate for ssl_client_verify")
                                                                            ;
            return (void *) -1;
        }
    ...
    if (conf->builtin_session_cache == -1) { conf->builtin_session_cache = (prev->builtin_session_cache == -1) ? NGX_SSL_NONE_SCACHE : prev->builtin_session_cache; }
                                                                          ;
    ...
    if (conf->session_tickets == -1) { conf->session_tickets = (prev->session_tickets == -1) ? 1 : prev->session_tickets; };
    ...
    if (conf->session_ticket_keys == (void *) -1) { conf->session_ticket_keys = (prev->session_ticket_keys == (void *) -1) ? 0 : prev->session_ticket_keys; }
                                                         ;
...
ngx_http_ssl_session_cache(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    for (i = 1; i < cf->args->nelts; i++) {
        ...
        if (value[i].len > sizeof("builtin:") - 1
            && strncmp((const char *) value[i].data, (const char *) "builtin:", sizeof("builtin:") - 1)
               == 0)
        {
        ...
        if (value[i].len > sizeof("shared:") - 1
            && strncmp((const char *) value[i].data, (const char *) "shared:", sizeof("shared:") - 1)
               == 0)
        {
            len = 0;
    ...
    for (p = 0; p < cmcf->ports->nelts; p++) {
        ...
        for (a = 0; a < port[p].addrs.nelts; a++) {
            ...
            if (sscf->certificates == 0) {
                if ((cf->log)->log_level >= 1) ngx_log_error_core(1, cf->log, 0, "no \"ssl_certificate\" is defined for " "the \"listen ... ssl\" directive in %s:%ui", cscf->file_name, cscf->line)
