# 1 "src/http/modules/ngx_http_chunked_filter_module.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 9 "src/http/modules/ngx_http_chunked_filter_module.c" 2
...
# 10 "src/http/modules/ngx_http_chunked_filter_module.c" 2
...
# 11 "src/http/modules/ngx_http_chunked_filter_module.c" 2
...
ngx_http_chunked_body_filter(ngx_http_request_t *r, ngx_chain_t *in)
{
    ...
    if (in == 0 || !r->chunked || r->header_only) {
        return ngx_http_next_body_filter(r, in);
    }

    ctx = (r)->ctx[ngx_http_chunked_filter_module.ctx_index];
