...
ngx_int_t ngx_http_access_handler_sense_1(int *ngx_http_access_handler_sense_1_ret, ngx_http_request_t *r)
{
  ...
  switch (r->connection->sockaddr->sa_family)
  {
      ...
      if (alcf->rules)
    {
      ...
      {
        *ngx_http_access_handler_sense_1_ret = 1;
...
ngx_int_t ngx_http_access_init_sense_1(int *ngx_http_access_init_sense_1_ret, ngx_conf_t *cf)
{
  ...
  {
    {
      *ngx_http_access_init_sense_1_ret = 1;
      return -1;
    }
  }
