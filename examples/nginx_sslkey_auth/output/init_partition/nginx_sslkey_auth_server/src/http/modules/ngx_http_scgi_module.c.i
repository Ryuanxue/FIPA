# 1 "src/http/modules/ngx_http_scgi_module.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "src/http/modules/ngx_http_scgi_module.c"
# 9 "src/http/modules/ngx_http_scgi_module.c"
...
# 10 "src/http/modules/ngx_http_scgi_module.c" 2
...
# 11 "src/http/modules/ngx_http_scgi_module.c" 2
...
# 12 "src/http/modules/ngx_http_scgi_module.c" 2
...
static ngx_command_t ngx_http_scgi_commands[] = {
    ...
    { { sizeof("scgi_pass") - 1, (u_char *) "scgi_pass" },
      0x08000000|0x40000000|0x00000002,
      ngx_http_scgi_pass,
      
# 100 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 100 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      0,
      0 },

    { { sizeof("scgi_store") - 1, (u_char *) "scgi_store" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_http_scgi_store,
      
# 107 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 107 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      0,
      0 },

    { { sizeof("scgi_store_access") - 1, (u_char *) "scgi_store_access" },
      0x02000000|0x04000000|0x08000000|(0x00000002|0x00000004|0x00000008),
      ngx_conf_set_access_slot,
      
# 114 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 114 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      
# 115 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 115 "src/http/modules/ngx_http_scgi_module.c"
                                                              ,
      0 },

    { { sizeof("scgi_buffering") - 1, (u_char *) "scgi_buffering" },
      0x02000000|0x04000000|0x08000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 121 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 121 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      
# 122 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 122 "src/http/modules/ngx_http_scgi_module.c"
                                                           ,
      0 },

    { { sizeof("scgi_request_buffering") - 1, (u_char *) "scgi_request_buffering" },
      0x02000000|0x04000000|0x08000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 128 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 128 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      
# 129 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 129 "src/http/modules/ngx_http_scgi_module.c"
                                                                   ,
      0 },

    { { sizeof("scgi_ignore_client_abort") - 1, (u_char *) "scgi_ignore_client_abort" },
      0x02000000|0x04000000|0x08000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 135 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 135 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      
# 136 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 136 "src/http/modules/ngx_http_scgi_module.c"
                                                                     ,
      0 },

    { { sizeof("scgi_bind") - 1, (u_char *) "scgi_bind" },
      0x02000000|0x04000000|0x08000000|(0x00000002|0x00000004),
      ngx_http_upstream_bind_set_slot,
      
# 142 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 142 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      
# 143 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 143 "src/http/modules/ngx_http_scgi_module.c"
                                                       ,
      0 },

    { { sizeof("scgi_connect_timeout") - 1, (u_char *) "scgi_connect_timeout" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_msec_slot,
      
# 149 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 149 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      
# 150 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 150 "src/http/modules/ngx_http_scgi_module.c"
                                                                 ,
      0 },

    { { sizeof("scgi_send_timeout") - 1, (u_char *) "scgi_send_timeout" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_msec_slot,
      
# 156 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 156 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      
# 157 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 157 "src/http/modules/ngx_http_scgi_module.c"
                                                              ,
      0 },

    { { sizeof("scgi_buffer_size") - 1, (u_char *) "scgi_buffer_size" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_size_slot,
      
# 163 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 163 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      
# 164 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 164 "src/http/modules/ngx_http_scgi_module.c"
                                                             ,
      0 },

    { { sizeof("scgi_pass_request_headers") - 1, (u_char *) "scgi_pass_request_headers" },
      0x02000000|0x04000000|0x08000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 170 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 170 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      
# 171 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 171 "src/http/modules/ngx_http_scgi_module.c"
                                                                      ,
      0 },

    { { sizeof("scgi_pass_request_body") - 1, (u_char *) "scgi_pass_request_body" },
      0x02000000|0x04000000|0x08000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 177 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 177 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      
# 178 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 178 "src/http/modules/ngx_http_scgi_module.c"
                                                                   ,
      0 },

    { { sizeof("scgi_intercept_errors") - 1, (u_char *) "scgi_intercept_errors" },
      0x02000000|0x04000000|0x08000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 184 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 184 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      
# 185 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 185 "src/http/modules/ngx_http_scgi_module.c"
                                                                  ,
      0 },

    { { sizeof("scgi_read_timeout") - 1, (u_char *) "scgi_read_timeout" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_msec_slot,
      
# 191 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 191 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      
# 192 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 192 "src/http/modules/ngx_http_scgi_module.c"
                                                              ,
      0 },

    { { sizeof("scgi_buffers") - 1, (u_char *) "scgi_buffers" },
      0x02000000|0x04000000|0x08000000|0x00000004,
      ngx_conf_set_bufs_slot,
      
# 198 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 198 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      
# 199 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 199 "src/http/modules/ngx_http_scgi_module.c"
                                                      ,
      0 },

    { { sizeof("scgi_busy_buffers_size") - 1, (u_char *) "scgi_busy_buffers_size" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_size_slot,
      
# 205 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 205 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      
# 206 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 206 "src/http/modules/ngx_http_scgi_module.c"
                                                                        ,
      0 },

    { { sizeof("scgi_force_ranges") - 1, (u_char *) "scgi_force_ranges" },
      0x02000000|0x04000000|0x08000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 212 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 212 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      
# 213 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 213 "src/http/modules/ngx_http_scgi_module.c"
                                                              ,
      0 },

    { { sizeof("scgi_limit_rate") - 1, (u_char *) "scgi_limit_rate" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_size_slot,
      
# 219 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 219 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      
# 220 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 220 "src/http/modules/ngx_http_scgi_module.c"
                                                            ,
      0 },



    { { sizeof("scgi_cache") - 1, (u_char *) "scgi_cache" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_http_scgi_cache,
      
# 228 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 228 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      0,
      0 },

    { { sizeof("scgi_cache_key") - 1, (u_char *) "scgi_cache_key" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_http_scgi_cache_key,
      
# 235 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 235 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      0,
      0 },

    { { sizeof("scgi_cache_path") - 1, (u_char *) "scgi_cache_path" },
      0x02000000|0x00001000,
      ngx_http_file_cache_set_slot,
      
# 242 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 242 "src/http/modules/ngx_http_scgi_module.c"
                              ,
      
# 243 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 243 "src/http/modules/ngx_http_scgi_module.c"
                                                ,
      &ngx_http_scgi_module },

    { { sizeof("scgi_cache_bypass") - 1, (u_char *) "scgi_cache_bypass" },
      0x02000000|0x04000000|0x08000000|0x00000800,
      ngx_http_set_predicate_slot,
      
# 249 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 249 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      
# 250 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 250 "src/http/modules/ngx_http_scgi_module.c"
                                                              ,
      0 },

    { { sizeof("scgi_no_cache") - 1, (u_char *) "scgi_no_cache" },
      0x02000000|0x04000000|0x08000000|0x00000800,
      ngx_http_set_predicate_slot,
      
# 256 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 256 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      
# 257 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 257 "src/http/modules/ngx_http_scgi_module.c"
                                                          ,
      0 },

    { { sizeof("scgi_cache_valid") - 1, (u_char *) "scgi_cache_valid" },
      0x02000000|0x04000000|0x08000000|0x00000800,
      ngx_http_file_cache_valid_set_slot,
      
# 263 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 263 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      
# 264 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 264 "src/http/modules/ngx_http_scgi_module.c"
                                                             ,
      0 },

    { { sizeof("scgi_cache_min_uses") - 1, (u_char *) "scgi_cache_min_uses" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_num_slot,
      
# 270 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 270 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      
# 271 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 271 "src/http/modules/ngx_http_scgi_module.c"
                                                                ,
      0 },

    { { sizeof("scgi_cache_max_range_offset") - 1, (u_char *) "scgi_cache_max_range_offset" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_off_slot,
      
# 277 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 277 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      
# 278 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 278 "src/http/modules/ngx_http_scgi_module.c"
                                                                        ,
      0 },

    { { sizeof("scgi_cache_use_stale") - 1, (u_char *) "scgi_cache_use_stale" },
      0x02000000|0x04000000|0x08000000|0x00000800,
      ngx_conf_set_bitmask_slot,
      
# 284 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 284 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      
# 285 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 285 "src/http/modules/ngx_http_scgi_module.c"
                                                                 ,
      &ngx_http_scgi_next_upstream_masks },

    { { sizeof("scgi_cache_methods") - 1, (u_char *) "scgi_cache_methods" },
      0x02000000|0x04000000|0x08000000|0x00000800,
      ngx_conf_set_bitmask_slot,
      
# 291 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 291 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      
# 292 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 292 "src/http/modules/ngx_http_scgi_module.c"
                                                               ,
      &ngx_http_upstream_cache_method_mask },

    { { sizeof("scgi_cache_lock") - 1, (u_char *) "scgi_cache_lock" },
      0x02000000|0x04000000|0x08000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 298 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 298 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      
# 299 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 299 "src/http/modules/ngx_http_scgi_module.c"
                                                            ,
      0 },

    { { sizeof("scgi_cache_lock_timeout") - 1, (u_char *) "scgi_cache_lock_timeout" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_msec_slot,
      
# 305 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 305 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      
# 306 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 306 "src/http/modules/ngx_http_scgi_module.c"
                                                                    ,
      0 },

    { { sizeof("scgi_cache_lock_age") - 1, (u_char *) "scgi_cache_lock_age" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_msec_slot,
      
# 312 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 312 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      
# 313 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 313 "src/http/modules/ngx_http_scgi_module.c"
                                                                ,
      0 },

    { { sizeof("scgi_cache_revalidate") - 1, (u_char *) "scgi_cache_revalidate" },
      0x02000000|0x04000000|0x08000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 319 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 319 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      
# 320 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 320 "src/http/modules/ngx_http_scgi_module.c"
                                                                  ,
      0 },

    { { sizeof("scgi_cache_background_update") - 1, (u_char *) "scgi_cache_background_update" },
      0x02000000|0x04000000|0x08000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 326 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 326 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      
# 327 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 327 "src/http/modules/ngx_http_scgi_module.c"
                                                                         ,
      0 },



    { { sizeof("scgi_temp_path") - 1, (u_char *) "scgi_temp_path" },
      0x02000000|0x04000000|0x08000000|(0x00000002|0x00000004|0x00000008 |0x00000010),
      ngx_conf_set_path_slot,
      
# 335 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 335 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      
# 336 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 336 "src/http/modules/ngx_http_scgi_module.c"
                                                           ,
      0 },

    { { sizeof("scgi_max_temp_file_size") - 1, (u_char *) "scgi_max_temp_file_size" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_size_slot,
      
# 342 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 342 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      
# 343 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 343 "src/http/modules/ngx_http_scgi_module.c"
                                                                         ,
      0 },

    { { sizeof("scgi_temp_file_write_size") - 1, (u_char *) "scgi_temp_file_write_size" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_size_slot,
      
# 349 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 349 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      
# 350 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 350 "src/http/modules/ngx_http_scgi_module.c"
                                                                           ,
      0 },

    { { sizeof("scgi_next_upstream") - 1, (u_char *) "scgi_next_upstream" },
      0x02000000|0x04000000|0x08000000|0x00000800,
      ngx_conf_set_bitmask_slot,
      
# 356 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 356 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      
# 357 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 357 "src/http/modules/ngx_http_scgi_module.c"
                                                               ,
      &ngx_http_scgi_next_upstream_masks },

    { { sizeof("scgi_next_upstream_tries") - 1, (u_char *) "scgi_next_upstream_tries" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_num_slot,
      
# 363 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 363 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      
# 364 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 364 "src/http/modules/ngx_http_scgi_module.c"
                                                                     ,
      0 },

    { { sizeof("scgi_next_upstream_timeout") - 1, (u_char *) "scgi_next_upstream_timeout" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_msec_slot,
      
# 370 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 370 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      
# 371 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 371 "src/http/modules/ngx_http_scgi_module.c"
                                                                       ,
      0 },

    { { sizeof("scgi_param") - 1, (u_char *) "scgi_param" },
      0x02000000|0x04000000|0x08000000|(0x00000004|0x00000008),
      ngx_http_upstream_param_set_slot,
      
# 377 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 377 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      
# 378 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 378 "src/http/modules/ngx_http_scgi_module.c"
                                                      ,
      0 },

    { { sizeof("scgi_pass_header") - 1, (u_char *) "scgi_pass_header" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_str_array_slot,
      
# 384 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 384 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      
# 385 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 385 "src/http/modules/ngx_http_scgi_module.c"
                                                              ,
      0 },

    { { sizeof("scgi_hide_header") - 1, (u_char *) "scgi_hide_header" },
      0x02000000|0x04000000|0x08000000|0x00000002,
      ngx_conf_set_str_array_slot,
      
# 391 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 391 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      
# 392 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 392 "src/http/modules/ngx_http_scgi_module.c"
                                                              ,
      0 },

    { { sizeof("scgi_ignore_headers") - 1, (u_char *) "scgi_ignore_headers" },
      0x02000000|0x04000000|0x08000000|0x00000800,
      ngx_conf_set_bitmask_slot,
      
# 398 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 398 "src/http/modules/ngx_http_scgi_module.c"
                             ,
      
# 399 "src/http/modules/ngx_http_scgi_module.c" 3 4
     0
# 399 "src/http/modules/ngx_http_scgi_module.c"
                                                                ,
...
static ngx_path_init_t ngx_http_scgi_temp_path = {
    { sizeof("scgi_temp") - 1, (u_char *) "scgi_temp" }, { 1, 2, 0 }
};
...
ngx_http_scgi_handler(ngx_http_request_t *r)
{
    ...
    r->ctx[ngx_http_scgi_module.ctx_index] = status;;

    scf = (r)->loc_conf[ngx_http_scgi_module.ctx_index];

    if (scf->scgi_lengths) {
        if (ngx_http_scgi_eval(r, scf) != 0) {
            return 500;
        }
    }
    ...
    (&u->schema)->len = sizeof("scgi://") - 1; (&u->schema)->data = (u_char *) "scgi://";
    u->output.tag = (ngx_buf_tag_t) &ngx_http_scgi_module;

    u->conf = &scf->upstream;


    smcf = (r)->main_conf[ngx_http_scgi_module.ctx_index];
...
ngx_http_scgi_create_key(ngx_http_request_t *r)
{
    ...
    if (ngx_http_complex_value(r, &scf->cache_key, key) != 0) {
        return -1;
    }
...
ngx_http_scgi_create_request(ngx_http_request_t *r)
{
    ...
    u_char buffer[(sizeof("-9223372036854775808") - 1)];

    content_length_n = 0;
    body = r->upstream->request_bufs;

    while (body) {
        content_length_n += ((body->buf->temporary || body->buf->memory || body->buf->mmap) ? (off_t) (body->buf->last - body->buf->pos): (body->buf->file_last - body->buf->file_pos));
        body = body->next;
    }
    ...
    b = ngx_create_temp_buf(r->pool, (sizeof("-9223372036854775808") - 1) + 1 + len + 1);
    if (b == 0) {
        return -1;
    }
    ...
    if (scf->upstream.pass_request_headers) {
        ...
        for (i = 0; ; i++) {
            ...
            key = b->last;
            b->last = (((u_char *) memcpy(key, "HTTP_", sizeof("HTTP_") - 1)) + (sizeof("HTTP_") - 1));
            ...
            *b->last++ = (u_char) 0;
            ...
            val = b->last;
            b->last = (((u_char *) memcpy(val, header[i].value.data, header[i].value.len)) + (header[i].value.len));
            *b->last++ = (u_char) 0;
...
ngx_http_scgi_reinit_request(ngx_http_request_t *r)
{
    ...
    status = (r)->ctx[ngx_http_scgi_module.ctx_index];
...
ngx_http_scgi_create_loc_conf(ngx_conf_t *cf)
{
    ...
    (&conf->upstream.module)->len = sizeof("scgi") - 1; (&conf->upstream.module)->data = (u_char *) "scgi";
...
ngx_http_scgi_merge_loc_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    if (clcf->noname
        && conf->upstream.upstream == 0 && conf->scgi_lengths == 0)
    {
    ...
    rc = ngx_http_scgi_init_params(cf, conf, &conf->params, 0);
    if (rc != 0) {
        return (void *) -1;
    }
...
# 1589 "src/http/modules/ngx_http_scgi_module.c"
