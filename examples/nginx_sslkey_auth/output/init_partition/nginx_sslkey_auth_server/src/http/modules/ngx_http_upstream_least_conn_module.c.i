# 1 "src/http/modules/ngx_http_upstream_least_conn_module.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 9 "src/http/modules/ngx_http_upstream_least_conn_module.c" 2
...
# 10 "src/http/modules/ngx_http_upstream_least_conn_module.c" 2
...
# 11 "src/http/modules/ngx_http_upstream_least_conn_module.c" 2
...
static ngx_command_t ngx_http_upstream_least_conn_commands[] = {
    ...
    { { sizeof("least_conn") - 1, (u_char *) "least_conn" },
...
ngx_module_t ngx_http_upstream_least_conn_module = {
    ...
    &ngx_http_upstream_least_conn_module_ctx,
