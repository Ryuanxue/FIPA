...
ngx_int_t ngx_http_add_header_sense_1(int *ngx_http_add_header_sense_1_ret, ngx_http_request_t *r, ngx_http_header_val_t *hv, ngx_str_t *value)
{
  ngx_table_elt_t *h;
  if (value->len)
  {
    ...
    {
      {
        *ngx_http_add_header_sense_1_ret = 1;
        return -1;
      }
    }
    h->hash = 1;
