# 1 "src/http/modules/ngx_http_split_clients_module.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 9 "src/http/modules/ngx_http_split_clients_module.c" 2
...
# 10 "src/http/modules/ngx_http_split_clients_module.c" 2
...
# 11 "src/http/modules/ngx_http_split_clients_module.c" 2
...
static ngx_command_t ngx_http_split_clients_commands[] = {
    ...
    { { sizeof("split_clients") - 1, (u_char *) "split_clients" },
      0x02000000|0x00000100|0x00000004,
      ngx_conf_split_clients_block,
      
# 35 "src/http/modules/ngx_http_split_clients_module.c" 3 4
     0
# 35 "src/http/modules/ngx_http_split_clients_module.c"
                              ,
      0,
      0 },
    ...
    ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    *v = ngx_http_variable_null_value;
    ...
    if (ngx_http_complex_value(r, &ctx->value, &val) != 0) {
        return 0;
    }
