# 1 "src/http/modules/ngx_http_charset_filter_module.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 9 "src/http/modules/ngx_http_charset_filter_module.c" 2
...
# 10 "src/http/modules/ngx_http_charset_filter_module.c" 2
...
# 11 "src/http/modules/ngx_http_charset_filter_module.c" 2
# 23 "src/http/modules/ngx_http_charset_filter_module.c"
typedef struct {
    u_char **tables;
    ngx_str_t name;
...
static inline void ngx_http_set_charset(ngx_http_request_t *r,
    ngx_str_t *charset);
...
static ngx_str_t ngx_http_charset_default_types[] = {
    { sizeof("text/html") - 1, (u_char *) "text/html" },
    { sizeof("text/xml") - 1, (u_char *) "text/xml" },
    { sizeof("text/plain") - 1, (u_char *) "text/plain" },
    { sizeof("text/vnd.wap.wml") - 1, (u_char *) "text/vnd.wap.wml" },
    { sizeof("application/javascript") - 1, (u_char *) "application/javascript" },
    { sizeof("application/rss+xml") - 1, (u_char *) "application/rss+xml" },
    { 0, 0 }
};
...
static ngx_command_t ngx_http_charset_filter_commands[] = {
    ...
    { { sizeof("charset") - 1, (u_char *) "charset" },
      0x02000000|0x04000000|0x08000000
                        |0x40000000|0x00000002,
      ngx_http_set_charset_slot,
      
# 143 "src/http/modules/ngx_http_charset_filter_module.c" 3 4
     0
# 143 "src/http/modules/ngx_http_charset_filter_module.c"
                             ,
      
# 144 "src/http/modules/ngx_http_charset_filter_module.c" 3 4
     0
# 144 "src/http/modules/ngx_http_charset_filter_module.c"
                                                   ,
      0 },

    { { sizeof("source_charset") - 1, (u_char *) "source_charset" },
      0x02000000|0x04000000|0x08000000
                        |0x40000000|0x00000002,
      ngx_http_set_charset_slot,
      
# 151 "src/http/modules/ngx_http_charset_filter_module.c" 3 4
     0
# 151 "src/http/modules/ngx_http_charset_filter_module.c"
                             ,
      
# 152 "src/http/modules/ngx_http_charset_filter_module.c" 3 4
     0
# 152 "src/http/modules/ngx_http_charset_filter_module.c"
                                                          ,
      0 },

    { { sizeof("override_charset") - 1, (u_char *) "override_charset" },
      0x02000000|0x04000000|0x08000000
                        |0x40000000|0x00000200,
      ngx_conf_set_flag_slot,
      
# 159 "src/http/modules/ngx_http_charset_filter_module.c" 3 4
     0
# 159 "src/http/modules/ngx_http_charset_filter_module.c"
                             ,
      
# 160 "src/http/modules/ngx_http_charset_filter_module.c" 3 4
     0
# 160 "src/http/modules/ngx_http_charset_filter_module.c"
                                                            ,
      0 },

    { { sizeof("charset_types") - 1, (u_char *) "charset_types" },
      0x02000000|0x04000000|0x08000000|0x00000800,
      ngx_http_types_slot,
      
# 166 "src/http/modules/ngx_http_charset_filter_module.c" 3 4
     0
# 166 "src/http/modules/ngx_http_charset_filter_module.c"
                             ,
      
# 167 "src/http/modules/ngx_http_charset_filter_module.c" 3 4
     0
# 167 "src/http/modules/ngx_http_charset_filter_module.c"
                                                      ,
      &ngx_http_charset_default_types[0] },

    { { sizeof("charset_map") - 1, (u_char *) "charset_map" },
      0x02000000|0x00000100|0x00000004,
      ngx_http_charset_map_block,
      
# 173 "src/http/modules/ngx_http_charset_filter_module.c" 3 4
     0
# 173 "src/http/modules/ngx_http_charset_filter_module.c"
                              ,
      0,
      0 },
...
ngx_http_charset_header_filter(ngx_http_request_t *r)
{
    ...
    mcf = (r)->main_conf[ngx_http_charset_filter_module.ctx_index];
    charsets = mcf->charsets.elts;

    if (charsets[source_charset].tables == 0
        || charsets[source_charset].tables[charset] == 0)
    {
        goto no_charset_map;
    }
...
no_charset_map:
    ...
    if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "no \"charset_map\" between the charsets \"%V\" and \"%V\"", &src, &dst)
...
ngx_http_destination_charset(ngx_http_request_t *r, ngx_str_t *name)
{
        ...
        && r->headers_out.override_charset->len)
    {
        *name = *r->headers_out.override_charset;
        ...
        if ((r->connection->log)->log_level >= 4) ngx_log_error_core(4, r->connection->log, 0, "unknown charset \"%V\" to override", name)
                                                                 ;

        return -5;
    }

    mlcf = (r)->loc_conf[ngx_http_charset_filter_module.ctx_index];
    ...
    if (r->headers_out.charset.len) {
        ...
        if (ngx_http_test_content_type(r, &mlcf->types) == 0) {
            return -5;
        }
    }
    ...
    vv = ngx_http_get_indexed_variable(r, charset - 0x10000);
...
ngx_http_main_request_charset(ngx_http_request_t *r, ngx_str_t *src)
{
    ...
    ctx = (r->main)->ctx[ngx_http_charset_filter_module.ctx_index];
    ...
    r->main->ctx[ngx_http_charset_filter_module.ctx_index] = ctx;;
...
ngx_http_source_charset(ngx_http_request_t *r, ngx_str_t *name)
{
    ...
    lcf = (r)->loc_conf[ngx_http_charset_filter_module.ctx_index];
    ...
    ngx_int_t charset, ngx_int_t source_charset)
{
    ...
    r->ctx[ngx_http_charset_filter_module.ctx_index] = ctx;;
...
ngx_http_charset_body_filter(ngx_http_request_t *r, ngx_chain_t *in)
{
    ...
    ctx = (r)->ctx[ngx_http_charset_filter_module.ctx_index];

    if (ctx == 0 || ctx->table == 0) {
    ...
    ngx_http_charset_ctx_t *ctx)
{
        ...
        for ( ; src < buf->last; src++) {
            ...
            if (len > 512) {
                ...
                if (n == 0xfffffffe) {
                    ...
                    (void) memcpy(ctx->saved, src, size);
                    ctx->saved_len = size;
    ...
    if (n < 0x10000) {
        ...
        if (i < 4) {
            ...
            (void) memcpy(&ctx->saved[ctx->saved_len], src, i);
            ctx->saved_len += i;
...
recode:
    ...
    while (src < buf->last) {
        ...
        if ((size_t) (b->end - dst) < (sizeof("&#1114111;") - 1)) {
            b->last = dst;

            size = buf->last - src + (sizeof("&#1114111;") - 1);
...
ngx_http_charset_map_block(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (ngx_strcasecmp(value[2].data, (u_char *) "utf-8") == 0) {
        table->src2dst = ngx_pcalloc(cf->pool, 256 * 4);
        if (table->src2dst == 0) {
            return (void *) -1;
        }
...
ngx_http_charset_map(ngx_conf_t *cf, ngx_command_t *dummy, void *conf)
{
    ...
    if (cf->args->nelts != 2) {
        ngx_conf_log_error(1, cf, 0, "invalid parameters number");
        return (void *) -1;
    }
...
ngx_http_set_charset_slot(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (cmd->offset == 
# 1413 "src/http/modules/ngx_http_charset_filter_module.c" 3 4
                      0
        
# 1414 "src/http/modules/ngx_http_charset_filter_module.c"
       && strcmp((const char *) value[1].data, (const char *) "off") == 0)
    {
        *cp = -2;
        return 0;
    }
    ...
    mcf = ((ngx_http_conf_ctx_t *) cf->ctx)->main_conf[ngx_http_charset_filter_module.ctx_index]
                                                                            ;
...
# 1540 "src/http/modules/ngx_http_charset_filter_module.c"
    lcf->charset = -1;
    lcf->source_charset = -1;
    lcf->override_charset = -1;
...
ngx_http_charset_merge_loc_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    if (conf->override_charset == -1) { conf->override_charset = (prev->override_charset == -1) ? 0 : prev->override_charset; };
    if (conf->charset == -1) { conf->charset = (prev->charset == -1) ? -2 : prev->charset; };
    if (conf->source_charset == -1) { conf->source_charset = (prev->source_charset == -1) ? -2 : prev->source_charset; }
                                              ;

    if (conf->charset == -2
        || conf->source_charset == -2
        || conf->charset == conf->source_charset)
    {
        return 0;
    }

    if (conf->source_charset >= 0x10000
        || conf->charset >= 0x10000)
    {
        return 0;
    }
...
ngx_http_charset_postconfiguration(ngx_conf_t *cf)
{
    ...
    for (i = 0; i < mcf->recodes.nelts; i++) {
        ...
        if ((cf->log)->log_level >= 1) ngx_log_error_core(1, cf->log, 0, "no \"charset_map\" between the charsets \"%V\" and \"%V\"", &charset[c].name, &charset[recode[i].dst].name)
