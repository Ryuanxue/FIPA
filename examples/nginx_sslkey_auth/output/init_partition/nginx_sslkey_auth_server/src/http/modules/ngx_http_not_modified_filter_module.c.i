# 1 "src/http/modules/ngx_http_not_modified_filter_module.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 9 "src/http/modules/ngx_http_not_modified_filter_module.c" 2
...
# 10 "src/http/modules/ngx_http_not_modified_filter_module.c" 2
...
# 11 "src/http/modules/ngx_http_not_modified_filter_module.c" 2
...
ngx_http_not_modified_header_filter(ngx_http_request_t *r)
{
    ...
    {
        return ngx_http_filter_finalize_request(r, 0,
                                                412);
    }
    ...
    ngx_uint_t weak)
{
    ...
    while (start < end) {
        ...
        if (strncmp((const char *) start, (const char *) etag.data, etag.len) != 0) {
            goto skip;
        }
