#define NGX_CONFIGURE " --with-http_ssl_module --with-cc-opt='-O0 -g -Wno-implicit-fallthrough -Wno-error=unused-function -Wno-error=unused-but-set-variable -Wno-error=unused-variable -Wno-error=uninitialized -Wno-error=sign-compare -Wno-error=cast-function-type'"
