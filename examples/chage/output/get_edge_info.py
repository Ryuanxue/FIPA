...
if __name__ == "__main__":
    ...
    """
    /home/raoxue/Desktop/IF-driver-partition/partitioned_software/chage/1_sense-annotation-code/shadow-utils/src/chage.c + list_fields + IfStmt:306:313,/home/raoxue/Desktop/IF-driver-partition/partitioned_software/chage/1_sense-annotation-code/shadow-utils/src/chage.c + list_fields + CStyleCastExpr:319:319,1
    /home/raoxue/Desktop/IF-driver-partition/partitioned_software/chage/1_sense-annotation-code/shadow-utils/src/chage.c + print_date + DeclStmt:263:263,/home/raoxue/Desktop/IF-driver-partition/partitioned_software/chage/1_sense-annotation-code/shadow-utils/src/chage.c + print_date + DeclStmt:264:264,3
    /home/raoxue/Desktop/IF-driver-partition/partitioned_software/chage/1_sense-annotation-code/shadow-utils/src/chage.c + print_date + DeclStmt:264:264,/home/raoxue/Desktop/IF-driver-partition/partitioned_software/chage/1_sense-annotation-code/shadow-utils/src/chage.c + print_date + BinaryOperator:266:266,3
    /home/raoxue/Desktop/IF-driver-partition/partitioned_software/chage/1_sense-annotation-code/shadow-utils/src/chage.c + print_date + BinaryOperator:266:266,/home/raoxue/Desktop/IF-driver-partition/partitioned_software/chage/1_sense-annotation-code/shadow-utils/src/chage.c + print_date + IfStmt:267:272,3
    /home/raoxue/Desktop/IF-driver-partition/partitioned_software/chage/1_sense-annotation-code/shadow-utils/src/chage.c + print_date + IfStmt:267:272,/home/raoxue/Desktop/IF-driver-partition/partitioned_software/chage/1_sense-annotation-code/shadow-utils/src/chage.c + list_fields + IfStmt:306:313,1
    /home/raoxue/Desktop/IF-driver-partition/partitioned_software/chage/1_sense-annotation-code/shadow-utils/src/chage.c + print_date + IfStmt:267:272,/home/raoxue/Desktop/IF-driver-partition/partitioned_software/chage/1_sense-annotation-code/shadow-utils/src/chage.c + list_fields + IfStmt:320:329,1

    以上内容每一行以","分割，第一部分为caller，第二部分为callee，第三部分为调用次数
    帮我解析exec_count，将函数的执行次数更新到语句与语句之间的调用，fun_statement_dict[fun]记录了每个函数对应的顺序语句列表，比如exec_count["print_date"] = 3, fun_statement_dict["print_date"] = [stmt1, stmt2, stmt3]，则输出"stmt1,stmt2,3" ,"stmt2,stmt3,3",直接输出到文件edge_info_output.txt
    """
